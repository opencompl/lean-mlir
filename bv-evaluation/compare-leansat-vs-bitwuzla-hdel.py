...
# takes theorems in SSA/Projects/InstCombine/HackersDelight/
# replaces sorry by bv_compare'
# store results in bv-evaluation/results/HackersDelight/
...
def process(jobs: int):
    ...
    with concurrent.futures.ThreadPoolExecutor(max_workers=jobs) as executor:
        ...
        for file in os.listdir(BENCHMARK_DIR):
            replace_in_file(BENCHMARK_DIR + file, "sorry","bv_compare'")
