...
for file_result in file_data: 
    ...
    solved_df = pd.DataFrame({'solved_bitwuzla_times_average': file_solved_bitwuzla_times_average, 
                            ...
                            'solved_bv_decide_lratt_times_average': file_solved_bv_decide_lratt_times_average, 
                            'solved_bv_decide_lratc_times_average': file_solved_bv_decide_lratc_times_average})
