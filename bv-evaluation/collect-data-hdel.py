...
def compare_solvers_on_file (results : dict) : 
    ...
    for theorem_num, [output_bitwuzla, output_bv_decide] in enumerate(zip(file_result[1]['outputs_bitwuzla'], file_result[1]['outputs_bv_decide'])): 
        if output_bitwuzla == output.failed and output_bv_decide == output.failed: 
            ...
            print("bitwuzla failed and bv_decide proved theorem "+str()+ " in file "+file_result[0])
            failed_bitwuzla_only += 1
        elif output_bitwuzla == output.proved and output_bv_decide == output.failed:
            print("bitwuzla proved and bv_decide failed theorem "+str(theorem_num)+ " in file "+file_result[0])
            failed_bv_decide_only += 1
        elif output_bitwuzla == output.counterexample and output_bv_decide == output.counterexample:
            # only store these results if they're actually consistent between the two solvers
            print("bitwuzla and bv_decide provided a counterexample for theorem "+str(theorem_num)+ " in file "+file_result[0])
            file_counter_bitwuzla_times_average.append(np.mean(file_result[1]['counter_bitwuzla_times_average'][theorem_num]))
            file_counter_bv_decide_times_average.append(np.mean(file_result[1]['counter_bv_decide_times_average'][theorem_num]))
            file_counter_bv_decide_rw_times_average.append(np.mean(file_result[1]['counter_bv_decide_times_average'][theorem_num]))
            file_counter_bv_decide_sat_times_average.append(np.mean(file_result[1]['counter_bv_decide_times_average'][theorem_num]))
        elif output_bitwuzla == output.counterexample and output_bv_decide == output.proved:
            print("bitwuzla provided counterexample and bv_decide proved theorem "+str(theorem_num)+ " in file "+file_result[0])
        elif output_bitwuzla == output.proved and output_bv_decide == output.counterexample:
            print("bitwuzla proved and bv_decide provided counterexample for theorem "+str(theorem_num)+ " in file "+file_result[0])
        elif output_bitwuzla == output.proved and output_bv_decide == output.proved:
            # only store these results if they're actually consistent between the two solvers
            file_solved_bitwuzla_times_average.append(np.mean(file_result[1]['solved_bitwuzla_times_average'][theorem_num]))
            file_solved_bv_decide_times_average.append(np.mean(file_result[1]['solved_bv_decide_times_average'][theorem_num]))
            file_solved_bv_decide_rw_times_average.append(np.mean(file_result[1]['solved_bv_decide_rw_times_average'][theorem_num]))
            file_solved_bv_decide_bb_times_average.append(np.mean(file_result[1]['solved_bv_decide_bb_times_average'][theorem_num]))
            file_solved_bv_decide_sat_times_average.append(np.mean(file_result[1]['solved_bv_decide_sat_times_average'][theorem_num]))
            file_solved_bv_decide_lratt_times_average.append(np.mean(file_result[1]['solved_bv_decide_lratt_times_average'][theorem_num]))
            file_solved_bv_decide_lratc_times_average.append(np.mean(file_result[1]['solved_bv_decide_lratc_times_average'][theorem_num]))
        elif output_bitwuzla == output.failed and output_bv_decide == output.counterexample:
            print("bitwuzla failed and bv_decide provided counterexample for theorem "+str(theorem_num)+ " in file "+file_result[0])
        elif output_bitwuzla == output.failed and output_bv_decide == output.proved:
            print("bitwuzla failed and bv_decide proved theorem "+str(theorem_num)+ " in file "+file_result[0])
        elif output_bitwuzla == output.proved and output_bv_decide == output.failed:
            print("bitwuzla proved and bv_decide failed theorem "+str(theorem_num)+ " in file "+file_result[0])
        elif output_bitwuzla == output.counterexample and output_bv_decide == output.failed:
            print("bitwuzla provided counterexample and bv_decide failed theorem "+str(theorem_num)+ " in file "+file_result[0])
        else:   
            raise Exception("Unexpected output: "+str(output_bw.value)+" bv_decide output "+str(output_ls.value))
...
for file_result in file_data: 
    ...
    ceg_df = pd.DataFrame({'counter_bitwuzla_times_average': file_comparison['file_counter_bitwuzla_times_average'], 
                            'counter_bv_decide_times_average': file_comparison['file_counter_bv_decide_times_average'], 
                            'counter_bv_decide_rw_times_average': file_comparison['file_counter_bv_decide_rw_times_average'], 
                            'counter_bv_decide_sat_times_average': file_comparison['file_counter_bv_decide_sat_times_average']})

    solved_df = pd.DataFrame({'solved_bitwuzla_times_average': file_comparison['file_solved_bitwuzla_times_average'], 
                            'solved_bv_decide_times_average': file_comparison['file_solved_bv_decide_times_average'], 
                            'solved_bv_decide_rw_times_average': file_comparison['file_solved_bv_decide_rw_times_average'], 
                            'solved_bv_decide_bb_times_average': file_comparison['file_solved_bv_decide_bb_times_average'], 
                            'solved_bv_decide_sat_times_average': file_comparison['file_solved_bv_decide_sat_times_average'], 
