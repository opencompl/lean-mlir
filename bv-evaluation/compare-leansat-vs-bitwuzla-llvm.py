...
def run_file(file: str):
    ...
    subprocess.Popen('sed -i -E \'s,all_goals sorry,bv_compare\'\\\'\',g\' ' + file_path, cwd=ROOT_DIR, shell=True).wait()
    subprocess.Popen('sed -i -E \'s,try alive_auto,,g\' ' + file_path, cwd=ROOT_DIR, shell=True).wait()
    ...
    subprocess.Popen('sed -i -E \'s,bv_compare\'\\\'\',all_goals sorry,g\' ' + file_path, cwd=ROOT_DIR, shell=True).wait()
