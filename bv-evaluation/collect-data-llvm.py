    ...
    if "_proof" in file:  # currently discard broken chapter
                    ...
                    if "LeanSAT " in l:
                        if "failed" in l:
                            ...
                            if r == 0:
                                ...
                                counter_leanSAT_rw_times_average.append(
                                    [float(l.split(" SAT")[0].split("rewriting ")[1])]
                                )
                                counter_leanSAT_sat_times_average.append(
                                    [float(l.split("ms")[1].split("solving ")[1])]
                                )
                                leanSAT_tot_times_average.append([float(-1)])
                                leanSAT_rw_times_average.append([float(-1)])
                                leanSAT_bb_times_average.append([float(-1)])
                                ...
                                counter_leanSAT_rw_times_average[thm].append(
                                    float(l.split(" SAT")[0].split("rewriting ")[1])
                                )
                                counter_leanSAT_sat_times_average[thm].append(
                                    float(l.split("ms")[1].split("solving ")[1])
                                )
                                leanSAT_tot_times_average[thm].append(float(-1))
                                leanSAT_rw_times_average[thm].append(float(-1))
                            ...
                            if r == 0:
                                ...
                                leanSAT_rw_times_average.append(
                                    [float(l.split("ms")[1].split("g ")[1])]
                                )
                                leanSAT_bb_times_average.append(
                                    [float(l.split("ms")[2].split("g ")[1])]
                                )
                                leanSAT_sat_times_average.append(
                                    [float(l.split("ms")[3].split("g ")[1])]
                                )
                                leanSAT_lrat_t_times_average.append(
                                    [float(l.split("ms")[4].split("g ")[1])]
                                )
                                leanSAT_lrat_c_times_average.append(
                                    [float(l.split("ms")[5].split("g ")[1])]
                                )
                                counter_leanSAT_tot_times_average.append([float(-1)])
                                counter_leanSAT_rw_times_average.append([float(-1)])
                                counter_leanSAT_sat_times_average.append([float(-1)])
                                ...
                                leanSAT_rw_times_average[thm].append(
                                    float(l.split("ms")[1].split("g ")[1])
                                )
                                leanSAT_bb_times_average[thm].append(
                                    float(l.split("ms")[2].split("g ")[1])
                                )
                                leanSAT_sat_times_average[thm].append(
                                    float(l.split("ms")[3].split("g ")[1])
                                )
                                leanSAT_lrat_t_times_average[thm].append(
                                    float(l.split("ms")[4].split("g ")[1])
                                )
                                leanSAT_lrat_c_times_average[thm].append(
                                    float(l.split("ms")[5].split("g ")[1])
                                )
                                counter_leanSAT_tot_times_average[thm].append(float(-1))
                                counter_leanSAT_rw_times_average[thm].append(float(-1))
        ...
        for output_bw, output_ls in zip(outputs_bitwuzla, outputs_leanSAT):
            if output_bw == output.failed and output_ls == output.failed:
                ...
                print(
                    "bitwuzla failed and leanSAT proved theorem "
                    + str(thm)
                    + " in file "
                    + file
                )
                ...
                print(
                    "bitwuzla proved and leanSAT failed theorem "
                    + str(thm)
                    + " in file "
                    + file
                )
                ...
                output_bw == output.counterxample and output_ls == output.counterxample
            ):
                print(
                    "bitwuzla and leanSAT provided counterexample for theorem "
                    + str(thm)
                    + " in file "
                    + file
                )
                ...
                counter_leanSAT_rw.append(
                    np.mean(counter_leanSAT_rw_times_average[thm])
                )
                counter_leanSAT_sat.append(
                    np.mean(counter_leanSAT_sat_times_average[thm])
                )
                thm = thm + 1
            elif output_bw == output.counterxample and output_ls == output.proved:
                print(
                    "bitwuzla provided counterexample and leanSAT proved theorem "
                    + str(thm)
                    + " in file "
                    + file
                )
                ...
                print(
                    "bitwuzla proved and leanSAT provided counterexample for theorem "
                    + str(thm)
                    + " in file "
                    + file
                )
                ...
                print(
                    "bitwuzla failed and leanSAT provided counterexample for theorem "
                    + str(thm)
                    + " in file "
                    + file
                )
                ...
                print(
                    "bitwuzla provided counterexample and leanSAT failed theorem "
                    + str(thm)
                    + " in file "
                    + file
                )
                ...
                print(
                    "something is broken: bitwuzla output "
                    + str(output_bw.value)
                    + " leanSAT output "
                    + str(output_ls.value)
                )
...
run_shell_command_and_assert_output_eq_int(
    "results/InstCombine/", "rg 'LeanSAT failed' | wc -l", both_failed + ls_only_failed
)
run_shell_command_and_assert_output_eq_int(
    "results/InstCombine/",
...
run_shell_command_and_assert_output_eq_int(
    ...
    len(counter_bitwuzla),
)
run_shell_command_and_assert_output_eq_int(
    "results/InstCombine/", "rg 'LeanSAT proved' | wc -l", len(leanSAT) + bw_only_failed
)
run_shell_command_and_assert_output_eq_int(
    "results/InstCombine/",
    "rg 'Bitwuzla proved' | wc -l",
    len(bitwuzla) + ls_only_failed,
)
