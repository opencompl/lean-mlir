...
theorem equiv_fork_fst (streamInt : DCOp.ValueStream (BitVec 8)) :
  ...
  simp only [MLIR2DC.instDialectDenoteDC, EffectKind.toMonad_impure, Fin.zero_eta, Fin.isValue,
    Fin.mk_one, Fin.reduceFinMk, DCFork, get?.eq_1, Var.zero_eq_last, Valuation.ofHVector,
    Ctxt.ofList.eq_1, Com.denote_var, EffectKind.toMonad_pure, Com.denote_ret,
