...
def PR38984_2_combined := [llvmfunc|
  llvm.func @PR38984_2() -> vector<4xi1> {
    ...
    %2 = llvm.mlir.undef : i16
    %3 = llvm.mlir.undef : vector<4xi16>
    %4 = llvm.mlir.constant(0 : i32) : i32
    %5 = llvm.insertelement %2, %3[%4 : i32] : vector<4xi16>
    %6 = llvm.mlir.constant(1 : i32) : i32
    %7 = llvm.insertelement %2, %5[%6 : i32] : vector<4xi16>
    %8 = llvm.mlir.constant(2 : i32) : i32
    %9 = llvm.insertelement %2, %7[%8 : i32] : vector<4xi16>
    %10 = llvm.mlir.constant(3 : i32) : i32
    %11 = llvm.insertelement %1, %9[%10 : i32] : vector<4xi16>
    %12 = llvm.mlir.constant(3 : i64) : i64
    %13 = llvm.mlir.constant(0 : i16) : i16
    %14 = llvm.mlir.constant(1 : i16) : i16
...
theorem inst_combine_PR38984_2   : PR38984_2_before  ⊑  PR38984_2_combined := by
  ...
  sorry
    ...
    %22 = llvm.icmp "eq" %20, %21 : !llvm.vec<4 x ptr>
