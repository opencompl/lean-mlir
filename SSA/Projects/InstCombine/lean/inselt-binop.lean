...
def add_constant_combined := [llvmfunc|
  llvm.func @add_constant(%arg0: i8) -> vector<2xi8> {
    ...
    %8 = llvm.mlir.constant(42 : i8) : i8
    %9 = llvm.mlir.undef : vector<2xi8>
    %10 = llvm.mlir.constant(0 : i32) : i32
    %11 = llvm.insertelement %8, %9[%10 : i32] : vector<2xi8>
    %12 = llvm.mlir.constant(1 : i32) : i32
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.add %14, %13  : vector<2xi8>
...
def add_constant_not_undef_lane_combined := [llvmfunc|
  llvm.func @add_constant_not_undef_lane(%arg0: i8) -> vector<2xi8> {
    ...
    %6 = llvm.insertelement %0, %4[%5 : i32] : vector<2xi8>
    %7 = llvm.mlir.constant(0 : i64) : i64
    %8 = llvm.mlir.constant(dense<[42, -42]> : vector<2xi8>) : vector<2xi8>
    %9 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %10 = llvm.add %9, %8  : vector<2xi8>
    llvm.return %10 : vector<2xi8>
  }]
...
def sub_constant_op0_combined := [llvmfunc|
  llvm.func @sub_constant_op0(%arg0: i8) -> vector<2xi8> {
    ...
    %12 = llvm.mlir.constant(1 : i32) : i32
    %13 = llvm.insertelement %8, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.sub %13, %14 overflow<nsw, nuw>  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def sub_constant_op0_not_undef_lane_combined := [llvmfunc|
  llvm.func @sub_constant_op0_not_undef_lane(%arg0: i8) -> vector<2xi8> {
    ...
    %8 = llvm.mlir.constant(dense<[42, -42]> : vector<2xi8>) : vector<2xi8>
    %9 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %10 = llvm.sub %8, %9 overflow<nuw>  : vector<2xi8>
    llvm.return %10 : vector<2xi8>
  }]
...
def mul_constant_combined := [llvmfunc|
  llvm.func @mul_constant(%arg0: i8) -> vector<3xi8> {
    ...
    %13 = llvm.insertelement %1, %11[%12 : i32] : vector<3xi8>
    %14 = llvm.mlir.constant(1 : i32) : i32
    %15 = llvm.insertelement %1, %13[%14 : i32] : vector<3xi8>
    %16 = llvm.mlir.constant(2 : i32) : i32
    %17 = llvm.insertelement %10, %15[%16 : i32] : vector<3xi8>
    %18 = llvm.insertelement %arg0, %8[%9 : i64] : vector<3xi8>
    %19 = llvm.mul %18, %17  : vector<3xi8>
...
def mul_constant_not_undef_lane_combined := [llvmfunc|
  llvm.func @mul_constant_not_undef_lane(%arg0: i8) -> vector<3xi8> {
    ...
    %9 = llvm.mlir.constant(2 : i64) : i64
    %10 = llvm.mlir.constant(-42 : i8) : i8
    %11 = llvm.mlir.constant(42 : i8) : i8
    %12 = llvm.mlir.undef : vector<3xi8>
    %13 = llvm.mlir.constant(0 : i32) : i32
    %14 = llvm.insertelement %11, %12[%13 : i32] : vector<3xi8>
    %15 = llvm.mlir.constant(1 : i32) : i32
    %16 = llvm.insertelement %1, %14[%15 : i32] : vector<3xi8>
    %17 = llvm.mlir.constant(2 : i32) : i32
    %18 = llvm.insertelement %10, %16[%17 : i32] : vector<3xi8>
    %19 = llvm.insertelement %arg0, %8[%9 : i64] : vector<3xi8>
    %20 = llvm.mul %19, %18  : vector<3xi8>
    llvm.return %20 : vector<3xi8>
  }]
...
def shl_constant_op0_not_undef_lane_combined := [llvmfunc|
  llvm.func @shl_constant_op0_not_undef_lane(%arg0: i8) -> vector<2xi8> {
    ...
    %6 = llvm.insertelement %0, %4[%5 : i32] : vector<2xi8>
    %7 = llvm.mlir.constant(1 : i64) : i64
    %8 = llvm.mlir.constant(dense<[5, 2]> : vector<2xi8>) : vector<2xi8>
    %9 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %10 = llvm.shl %8, %9  : vector<2xi8>
    llvm.return %10 : vector<2xi8>
  }]
...
def shl_constant_op1_combined := [llvmfunc|
  llvm.func @shl_constant_op1(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.shl %14, %13 overflow<nuw>  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def ashr_constant_op0_combined := [llvmfunc|
  llvm.func @ashr_constant_op0(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %8, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.ashr %13, %14  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def ashr_constant_op1_combined := [llvmfunc|
  llvm.func @ashr_constant_op1(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.ashr %14, %13  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def lshr_constant_op0_combined := [llvmfunc|
  llvm.func @lshr_constant_op0(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.lshr %13, %14  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def lshr_constant_op1_combined := [llvmfunc|
  llvm.func @lshr_constant_op1(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %8, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.lshr %14, %13  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def urem_constant_op0_combined := [llvmfunc|
  llvm.func @urem_constant_op0(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.urem %13, %14  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def srem_constant_op0_combined := [llvmfunc|
  llvm.func @srem_constant_op0(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.srem %13, %14  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def udiv_constant_op0_combined := [llvmfunc|
  llvm.func @udiv_constant_op0(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.udiv %13, %14  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def sdiv_constant_op0_combined := [llvmfunc|
  llvm.func @sdiv_constant_op0(%arg0: i8) -> vector<2xi8> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xi8>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi8>
    %15 = llvm.sdiv %13, %14  : vector<2xi8>
    llvm.return %15 : vector<2xi8>
  }]
...
def fadd_constant_combined := [llvmfunc|
  llvm.func @fadd_constant(%arg0: f32) -> vector<2xf32> {
    ...
    %7 = llvm.mlir.constant(0 : i64) : i64
    %8 = llvm.mlir.constant(4.200000e+01 : f32) : f32
    %9 = llvm.mlir.undef : vector<2xf32>
    %10 = llvm.mlir.constant(0 : i32) : i32
    %11 = llvm.insertelement %8, %9[%10 : i32] : vector<2xf32>
    %12 = llvm.mlir.constant(1 : i32) : i32
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xf32>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xf32>
    %15 = llvm.fadd %14, %13  : vector<2xf32>
...
def fdiv_constant_op1_combined := [llvmfunc|
  llvm.func @fdiv_constant_op1(%arg0: f32) -> vector<2xf32> {
    ...
    %13 = llvm.insertelement %0, %11[%12 : i32] : vector<2xf32>
    %14 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xf32>
    %15 = llvm.fdiv %14, %13  : vector<2xf32>
    llvm.return %15 : vector<2xf32>
  }]
