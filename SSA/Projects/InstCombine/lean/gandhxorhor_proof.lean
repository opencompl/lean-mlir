...
open Std (BitVec)
open Ctxt (Var)
theorem and_xor_not_common_op_thm (x x_1 : _root_.BitVec 32) : (x_1 ^^^ (x ^^^ 4294967295#32)) &&& x_1 = x_1 &&& x := sorry

theorem and_not_xor_common_op_thm (x x_1 : _root_.BitVec 32) : (x_1 ^^^ x ^^^ 4294967295#32) &&& x = x &&& x_1 := sorry
...
theorem and_shl_thm (x x_1 x_2 x_3 : _root_.BitVec 8) :
  (Option.bind (if 8 ≤ x_2.toNat then none else some (x_3 <<< x_2)) fun a =>
    ...
    Option.bind (if 8 ≤ x_2.toNat then none else some ((x_1 &&& x_3) <<< x_2)) fun a => some (a &&& x) := sorry
...
theorem or_shl_thm (x x_1 x_2 x_3 : _root_.BitVec 8) :
  (Option.bind (if 8 ≤ x_2.toNat then none else some (x_3 <<< x_2)) fun a =>
    ...
    Option.bind (if 8 ≤ x_2.toNat then none else some ((x_3 ||| x) <<< x_2)) fun a => some (a ||| x_1) := sorry
...
theorem and_orn_xor_thm (x x_1 : _root_.BitVec 4) : (x_1 ^^^ 15#4 ||| x) &&& (x_1 ^^^ x) = (x_1 ^^^ 15#4) &&& x := sorry

theorem and_orn_xor_commute8_thm (x x_1 : _root_.BitVec 32) :
  (x_1 ^ 2 ^^^ x ^ 2) &&& (x_1 ^ 2 ||| x ^ 2 ^^^ 4294967295#32) = x_1 ^ 2 &&& (x ^ 2 ^^^ 4294967295#32) := sorry

theorem canonicalize_logic_first_or0_thm (x : _root_.BitVec 32) : x + 112#32 ||| 15#32 = 112#32 + (x ||| 15#32) := sorry

theorem canonicalize_logic_first_or0_nsw_thm (x : _root_.BitVec 32) : x + 112#32 ||| 15#32 = 112#32 + (x ||| 15#32) := sorry

theorem canonicalize_logic_first_or0_nswnuw_thm (x : _root_.BitVec 32) : x + 112#32 ||| 15#32 = 112#32 + (x ||| 15#32) := sorry

theorem canonicalize_logic_first_and0_thm (x : _root_.BitVec 8) : x + 48#8 &&& 246#8 = 48#8 + (x &&& 246#8) := sorry

theorem canonicalize_logic_first_and0_nsw_thm (x : _root_.BitVec 8) : x + 48#8 &&& 246#8 = 48#8 + (x &&& 246#8) := sorry

theorem canonicalize_logic_first_and0_nswnuw_thm (x : _root_.BitVec 8) : x + 48#8 &&& 246#8 = 48#8 + (x &&& 246#8) := sorry

theorem canonicalize_logic_first_xor_0_thm (x : _root_.BitVec 8) : x + 96#8 ^^^ 31#8 = 96#8 + (x ^^^ 31#8) := sorry

theorem canonicalize_logic_first_xor_0_nsw_thm (x : _root_.BitVec 8) : x + 96#8 ^^^ 31#8 = 96#8 + (x ^^^ 31#8) := sorry

theorem canonicalize_logic_first_xor_0_nswnuw_thm (x : _root_.BitVec 8) : x + 96#8 ^^^ 31#8 = 96#8 + (x ^^^ 31#8) := sorry
