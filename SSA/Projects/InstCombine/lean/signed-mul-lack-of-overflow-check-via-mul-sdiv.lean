...
open Std (BitVec)
open Ctxt (Var)
namespace  signed-mul-lack-of-overflow-check-via-mul-sdiv
...
def t0_basic_combined := [llvmfunc|
  llvm.func @t0_basic(%arg0: i8, %arg1: i8) -> i1 {
    ...
    %1 = "llvm.intr.smul.with.overflow"(%arg0, %arg1) : (i8, i8) -> !llvm.struct<(i8, i1)>
...
def t1_vec_combined := [llvmfunc|
  llvm.func @t1_vec(%arg0: vector<2xi8>, %arg1: vector<2xi8>) -> vector<2xi1> {
    ...
    %2 = "llvm.intr.smul.with.overflow"(%arg0, %arg1) : (vector<2xi8>, vector<2xi8>) -> !llvm.struct<(vector<2xi8>, vector<2xi1>)>
...
def t2_commutative_combined := [llvmfunc|
  llvm.func @t2_commutative(%arg0: i8) -> i1 {
    %0 = llvm.mlir.constant(true) : i1
    %1 = llvm.call @gen8() : () -> i8
    %2 = "llvm.intr.smul.with.overflow"(%arg0, %1) : (i8, i8) -> !llvm.struct<(i8, i1)>
