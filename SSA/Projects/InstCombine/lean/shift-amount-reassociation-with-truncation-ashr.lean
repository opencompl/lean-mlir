...
open Std (BitVec)
open Ctxt (Var)
namespace  shift-amount-reassociation-with-truncation-ashr
...
def n10_lshr_ashr_before := [llvmfunc|
...
def t3_vec_nonsplat_poison0_combined := [llvmfunc|
  llvm.func @t3_vec_nonsplat_poison0(%arg0: vector<3xi32>, %arg1: vector<3xi16>) -> vector<3xi16> {
    ...
    %9 = llvm.ashr %arg0, %8  : vector<3xi32>
...
theorem inst_combine_t9_ashr   : t9_ashr_before  ⊑  t9_ashr_combined := by
  unfold t9_ashr_before t9_ashr_combined
  simp_alive_peephole
  sorry
def n10_lshr_ashr_combined := [llvmfunc|
  llvm.func @n10_lshr_ashr(%arg0: i32, %arg1: i16) -> i16 {
    %0 = llvm.mlir.constant(32 : i16) : i16
    %1 = llvm.mlir.constant(-1 : i16) : i16
    %2 = llvm.sub %0, %arg1  : i16
...
theorem inst_combine_n10_lshr_ashr   : n10_lshr_ashr_before  ⊑  n10_lshr_ashr_combined := by
  unfold n10_lshr_ashr_before n10_lshr_ashr_combined
  simp_alive_peephole
  sorry
