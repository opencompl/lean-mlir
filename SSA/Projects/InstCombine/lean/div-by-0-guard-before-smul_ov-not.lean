...
open Std (BitVec)
open Ctxt (Var)
namespace  div-by-0-guard-before-smul_ov-not
...
def n4_not_and_before := [llvmfunc|
  llvm.func @n4_not_and(%arg0: i4, %arg1: i4) -> i1 {
    ...
    %4 = "llvm.intr.smul.with.overflow"(%arg0, %arg1) : (i4, i4) -> !llvm.struct<(i4, i1)>
...
def t0_umul_combined := [llvmfunc|
  llvm.func @t0_umul(%arg0: i4, %arg1: i4) -> i1 {
    ...
    %2 = "llvm.intr.smul.with.overflow"(%arg0, %1) : (i4, i4) -> !llvm.struct<(i4, i1)>
...
def t1_commutative_combined := [llvmfunc|
  llvm.func @t1_commutative(%arg0: i4, %arg1: i4) -> i1 {
    %0 = llvm.mlir.constant(true) : i1
    %1 = "llvm.intr.smul.with.overflow"(%arg0, %arg1) : (i4, i4) -> !llvm.struct<(i4, i1)>
