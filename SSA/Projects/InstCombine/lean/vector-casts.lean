...
def f_before := [llvmfunc|
  llvm.func @f(%arg0: i32) -> vector<4xf32> {
    ...
    %7 = llvm.mlir.undef : vector<4xf32>
    %8 = llvm.insertelement %arg0, %0[%1 : i32] : vector<4xi32>
    %9 = llvm.insertelement %arg0, %8[%2 : i32] : vector<4xi32>
    %10 = llvm.insertelement %arg0, %9[%3 : i32] : vector<4xi32>
    %11 = llvm.insertelement %arg0, %10[%4 : i32] : vector<4xi32>
    %12 = llvm.getelementptr %5[%2] : (!llvm.ptr, i32) -> !llvm.ptr, vector<4xf32>
    %13 = llvm.ptrtoint %12 : !llvm.ptr to i64
    %14 = llvm.trunc %13 : i64 to i32
    %15 = llvm.insertelement %14, %0[%1 : i32] : vector<4xi32>
    %16 = llvm.insertelement %14, %15[%2 : i32] : vector<4xi32>
    %17 = llvm.insertelement %14, %16[%3 : i32] : vector<4xi32>
    %18 = llvm.insertelement %14, %17[%4 : i32] : vector<4xi32>
    %19 = llvm.mul %11, %18  : vector<4xi32>
    %20 = llvm.add %6, %19  : vector<4xi32>
    %21 = llvm.add %20, %0  : vector<4xi32>
...
def sitofp_shuf_before := [llvmfunc|
  llvm.func @sitofp_shuf(%arg0: vector<4xi32>) -> vector<4xf32> {
    %0 = llvm.mlir.poison : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 2, 3, -1] : vector<4xi32> 
    %2 = llvm.sitofp %1 : vector<4xi32> to vector<4xf32>
    llvm.return %2 : vector<4xf32>
  }]

def uitofp_shuf_before := [llvmfunc|
  llvm.func @uitofp_shuf(%arg0: vector<3xi16>) -> vector<3xf16> {
    %0 = llvm.mlir.poison : vector<3xi16>
    %1 = llvm.shufflevector %arg0, %0 [2, -1, 0] : vector<3xi16> 
    %2 = llvm.uitofp %1 : vector<3xi16> to vector<3xf16>
    llvm.return %2 : vector<3xf16>
  }]

def fptosi_shuf_before := [llvmfunc|
  llvm.func @fptosi_shuf(%arg0: vector<4xf64>) -> vector<4xi64> {
    %0 = llvm.mlir.poison : vector<4xf64>
    %1 = llvm.shufflevector %arg0, %0 [-1, 2, 3, -1] : vector<4xf64> 
    %2 = llvm.fptosi %1 : vector<4xf64> to vector<4xi64>
    llvm.return %2 : vector<4xi64>
  }]

def fptoui_shuf_before := [llvmfunc|
  llvm.func @fptoui_shuf(%arg0: vector<2xf32>) -> vector<2xi32> {
    %0 = llvm.mlir.poison : vector<2xf32>
    %1 = llvm.shufflevector %arg0, %0 [1, 1] : vector<2xf32> 
    %2 = llvm.fptoui %1 : vector<2xf32> to vector<2xi32>
    llvm.return %2 : vector<2xi32>
  }]

def narrowing_sitofp_shuf_before := [llvmfunc|
  llvm.func @narrowing_sitofp_shuf(%arg0: vector<4xi32>) -> vector<4xf16> {
    %0 = llvm.mlir.poison : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 2, 3, -1] : vector<4xi32> 
    %2 = llvm.sitofp %1 : vector<4xi32> to vector<4xf16>
    llvm.return %2 : vector<4xf16>
  }]

def widening_uitofp_shuf_before := [llvmfunc|
  llvm.func @widening_uitofp_shuf(%arg0: vector<4xi32>) -> vector<4xf64> {
    %0 = llvm.mlir.poison : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 2, 3, -1] : vector<4xi32> 
    %2 = llvm.uitofp %1 : vector<4xi32> to vector<4xf64>
    llvm.return %2 : vector<4xf64>
  }]

def fptosi_narrowing_shuf_before := [llvmfunc|
  llvm.func @fptosi_narrowing_shuf(%arg0: vector<4xf64>) -> vector<3xi64> {
    %0 = llvm.mlir.poison : vector<4xf64>
    %1 = llvm.shufflevector %arg0, %0 [-1, 2, 3] : vector<4xf64> 
    %2 = llvm.fptosi %1 : vector<3xf64> to vector<3xi64>
    llvm.return %2 : vector<3xi64>
  }]

def fptoui_widening_shuf_before := [llvmfunc|
  llvm.func @fptoui_widening_shuf(%arg0: vector<2xf32>) -> vector<3xi32> {
    %0 = llvm.mlir.poison : vector<2xf32>
    %1 = llvm.shufflevector %arg0, %0 [1, 1, 0] : vector<2xf32> 
    %2 = llvm.fptoui %1 : vector<3xf32> to vector<3xi32>
    llvm.return %2 : vector<3xi32>
  }]

def narrowing_sitofp_widening_shuf_before := [llvmfunc|
  llvm.func @narrowing_sitofp_widening_shuf(%arg0: vector<2xi32>) -> vector<4xf16> {
    %0 = llvm.mlir.poison : vector<2xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 0, 0, -1] : vector<2xi32> 
    %2 = llvm.sitofp %1 : vector<4xi32> to vector<4xf16>
    llvm.return %2 : vector<4xf16>
  }]

def sitofp_shuf_extra_use_before := [llvmfunc|
  llvm.func @sitofp_shuf_extra_use(%arg0: vector<4xi32>) -> vector<4xf32> {
    %0 = llvm.mlir.poison : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 2, 3, -1] : vector<4xi32> 
    llvm.call @use(%1) : (vector<4xi32>) -> ()
    %2 = llvm.sitofp %1 : vector<4xi32> to vector<4xf32>
    llvm.return %2 : vector<4xf32>
  }]

def sitofp_shuf_scalable_before := [llvmfunc|
  llvm.func @sitofp_shuf_scalable(%arg0: !llvm.vec<? x 4 x  i32>) -> !llvm.vec<? x 4 x  f32> {
    %0 = llvm.mlir.poison : !llvm.vec<? x 4 x  i32>
    %1 = llvm.shufflevector %arg0, %0 [0, 0, 0, 0] : !llvm.vec<? x 4 x  i32> 
    %2 = llvm.sitofp %1 : vector<[4]xi32> to !llvm.vec<? x 4 x  f32>
...
theorem inst_combine_zext_less_casting_with_wideop   : zext_less_casting_with_wideop_before  ⊑  zext_less_casting_with_wideop_combined := by
  ...
  simp_alive_peephole
  sorry
def sitofp_shuf_combined := [llvmfunc|
  llvm.func @sitofp_shuf(%arg0: vector<4xi32>) -> vector<4xf32> {
    %0 = llvm.mlir.poison : vector<4xf32>
    %1 = llvm.sitofp %arg0 : vector<4xi32> to vector<4xf32>
    %2 = llvm.shufflevector %1, %0 [1, 2, 3, -1] : vector<4xf32> 
    llvm.return %2 : vector<4xf32>
  }]

theorem inst_combine_sitofp_shuf   : sitofp_shuf_before  ⊑  sitofp_shuf_combined := by
  unfold sitofp_shuf_before sitofp_shuf_combined
  simp_alive_peephole
  sorry
def uitofp_shuf_combined := [llvmfunc|
  llvm.func @uitofp_shuf(%arg0: vector<3xi16>) -> vector<3xf16> {
    %0 = llvm.mlir.poison : vector<3xf16>
    %1 = llvm.uitofp %arg0 : vector<3xi16> to vector<3xf16>
    %2 = llvm.shufflevector %1, %0 [2, -1, 0] : vector<3xf16> 
    llvm.return %2 : vector<3xf16>
  }]

theorem inst_combine_uitofp_shuf   : uitofp_shuf_before  ⊑  uitofp_shuf_combined := by
  unfold uitofp_shuf_before uitofp_shuf_combined
  simp_alive_peephole
  sorry
def fptosi_shuf_combined := [llvmfunc|
  llvm.func @fptosi_shuf(%arg0: vector<4xf64>) -> vector<4xi64> {
    %0 = llvm.mlir.poison : vector<4xi64>
    %1 = llvm.fptosi %arg0 : vector<4xf64> to vector<4xi64>
    %2 = llvm.shufflevector %1, %0 [-1, 2, 3, -1] : vector<4xi64> 
    llvm.return %2 : vector<4xi64>
  }]

theorem inst_combine_fptosi_shuf   : fptosi_shuf_before  ⊑  fptosi_shuf_combined := by
  unfold fptosi_shuf_before fptosi_shuf_combined
  simp_alive_peephole
  sorry
def fptoui_shuf_combined := [llvmfunc|
  llvm.func @fptoui_shuf(%arg0: vector<2xf32>) -> vector<2xi32> {
    %0 = llvm.mlir.poison : vector<2xi32>
    %1 = llvm.fptoui %arg0 : vector<2xf32> to vector<2xi32>
    %2 = llvm.shufflevector %1, %0 [1, 1] : vector<2xi32> 
    llvm.return %2 : vector<2xi32>
  }]

theorem inst_combine_fptoui_shuf   : fptoui_shuf_before  ⊑  fptoui_shuf_combined := by
  unfold fptoui_shuf_before fptoui_shuf_combined
  simp_alive_peephole
  sorry
def narrowing_sitofp_shuf_combined := [llvmfunc|
  llvm.func @narrowing_sitofp_shuf(%arg0: vector<4xi32>) -> vector<4xf16> {
    %0 = llvm.mlir.poison : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 2, 3, -1] : vector<4xi32> 
    %2 = llvm.sitofp %1 : vector<4xi32> to vector<4xf16>
...
theorem inst_combine_narrowing_sitofp_shuf   : narrowing_sitofp_shuf_before  ⊑  narrowing_sitofp_shuf_combined := by
  unfold narrowing_sitofp_shuf_before narrowing_sitofp_shuf_combined
  simp_alive_peephole
  sorry
def widening_uitofp_shuf_combined := [llvmfunc|
  llvm.func @widening_uitofp_shuf(%arg0: vector<4xi32>) -> vector<4xf64> {
    %0 = llvm.mlir.poison : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 2, 3, -1] : vector<4xi32> 
    %2 = llvm.uitofp %1 : vector<4xi32> to vector<4xf64>
...
theorem inst_combine_widening_uitofp_shuf   : widening_uitofp_shuf_before  ⊑  widening_uitofp_shuf_combined := by
  unfold widening_uitofp_shuf_before widening_uitofp_shuf_combined
  simp_alive_peephole
  sorry
def fptosi_narrowing_shuf_combined := [llvmfunc|
  llvm.func @fptosi_narrowing_shuf(%arg0: vector<4xf64>) -> vector<3xi64> {
    %0 = llvm.mlir.poison : vector<4xf64>
    %1 = llvm.shufflevector %arg0, %0 [-1, 2, 3] : vector<4xf64> 
    %2 = llvm.fptosi %1 : vector<3xf64> to vector<3xi64>
...
theorem inst_combine_fptosi_narrowing_shuf   : fptosi_narrowing_shuf_before  ⊑  fptosi_narrowing_shuf_combined := by
  unfold fptosi_narrowing_shuf_before fptosi_narrowing_shuf_combined
  simp_alive_peephole
  sorry
def fptoui_widening_shuf_combined := [llvmfunc|
  llvm.func @fptoui_widening_shuf(%arg0: vector<2xf32>) -> vector<3xi32> {
    %0 = llvm.mlir.poison : vector<2xf32>
    %1 = llvm.shufflevector %arg0, %0 [1, 1, 0] : vector<2xf32> 
    %2 = llvm.fptoui %1 : vector<3xf32> to vector<3xi32>
...
theorem inst_combine_fptoui_widening_shuf   : fptoui_widening_shuf_before  ⊑  fptoui_widening_shuf_combined := by
  unfold fptoui_widening_shuf_before fptoui_widening_shuf_combined
  simp_alive_peephole
  sorry
def narrowing_sitofp_widening_shuf_combined := [llvmfunc|
  llvm.func @narrowing_sitofp_widening_shuf(%arg0: vector<2xi32>) -> vector<4xf16> {
    %0 = llvm.mlir.poison : vector<2xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 0, 0, -1] : vector<2xi32> 
    %2 = llvm.sitofp %1 : vector<4xi32> to vector<4xf16>
...
theorem inst_combine_narrowing_sitofp_widening_shuf   : narrowing_sitofp_widening_shuf_before  ⊑  narrowing_sitofp_widening_shuf_combined := by
  unfold narrowing_sitofp_widening_shuf_before narrowing_sitofp_widening_shuf_combined
  simp_alive_peephole
  sorry
def sitofp_shuf_extra_use_combined := [llvmfunc|
  llvm.func @sitofp_shuf_extra_use(%arg0: vector<4xi32>) -> vector<4xf32> {
    %0 = llvm.mlir.poison : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %0 [1, 2, 3, -1] : vector<4xi32> 
    llvm.call @use(%1) : (vector<4xi32>) -> ()
...
theorem inst_combine_sitofp_shuf_extra_use   : sitofp_shuf_extra_use_before  ⊑  sitofp_shuf_extra_use_combined := by
  unfold sitofp_shuf_extra_use_before sitofp_shuf_extra_use_combined
  simp_alive_peephole
  sorry
def sitofp_shuf_scalable_combined := [llvmfunc|
  llvm.func @sitofp_shuf_scalable(%arg0: !llvm.vec<? x 4 x  i32>) -> !llvm.vec<? x 4 x  f32> {
    %0 = llvm.mlir.poison : !llvm.vec<? x 4 x  i32>
    %1 = llvm.shufflevector %arg0, %0 [0, 0, 0, 0] : !llvm.vec<? x 4 x  i32> 
    %2 = llvm.sitofp %1 : vector<[4]xi32> to !llvm.vec<? x 4 x  f32>
...
theorem inst_combine_sitofp_shuf_scalable   : sitofp_shuf_scalable_before  ⊑  sitofp_shuf_scalable_combined := by
  unfold sitofp_shuf_scalable_before sitofp_shuf_scalable_combined
  simp_alive_peephole
  sorry
