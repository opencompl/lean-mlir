...
open Std (BitVec)
open Ctxt (Var)
namespace  insert-const-shuf-inseltpoison
...
def longerMask_combined := [llvmfunc|
  llvm.func @longerMask(%arg0: vector<3xi8>) -> vector<5xi8> {
    ...
    %11 = llvm.shufflevector %arg0, %8 [2, 1, 4, -1, -1] : vector<3xi8> 
    %12 = llvm.insertelement %9, %11[%10 : i64] : vector<5xi8>
    llvm.return %12 : vector<5xi8>
  }]
