...
open Std (BitVec)
open Ctxt (Var)
namespace  redundant-left-shift-input-masking-after-truncation-variant-c
...
def t2_vec_splat_poison_before := [llvmfunc|
  llvm.func @t2_vec_splat_poison(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    llvm.call @use8xi64(%41) : (vector<8xi64>) -> ()
...
def t2_vec_splat_poison_combined := [llvmfunc|
  llvm.func @t2_vec_splat_poison(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    llvm.call @use8xi32(%40) : (vector<8xi32>) -> ()
    llvm.call @use8xi64(%41) : (vector<8xi64>) -> ()
    %42 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %43 = llvm.shl %42, %40  : vector<8xi32>
    llvm.return %43 : vector<8xi32>
  }]
...
def t3_vec_nonsplat_combined := [llvmfunc|
  llvm.func @t3_vec_nonsplat(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    llvm.call @use8xi32(%46) : (vector<8xi32>) -> ()
    llvm.call @use8xi64(%47) : (vector<8xi64>) -> ()
    %48 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %49 = llvm.shl %48, %46  : vector<8xi32>
    llvm.return %49 : vector<8xi32>
  }]
