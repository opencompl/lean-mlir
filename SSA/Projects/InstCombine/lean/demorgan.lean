...
def demorgan_plus_and_to_xor_vec_before := [llvm|
{
...
def demorgan_plus_and_to_xor_vec_after := [llvm|
{
^0(%arg0 : vector<4xi32>, %arg1 : vector<4xi32>):
...
theorem demorgan_plus_and_to_xor_vec_proof : demorgan_plus_and_to_xor_vec_before ⊑ demorgan_plus_and_to_xor_vec_after := by
  sorry
