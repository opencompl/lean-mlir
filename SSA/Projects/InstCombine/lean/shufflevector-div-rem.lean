...
open Std (BitVec)
open Ctxt (Var)
namespace  shufflevector-div-rem
...
def test_srem_combined := [llvmfunc|
  llvm.func @test_srem(%arg0: i16, %arg1: i1) -> vector<2xi16> {
    ...
    %8 = llvm.mlir.constant(dense<[2, 1]> : vector<2xi16>) : vector<2xi16>
    %9 = llvm.mlir.poison : vector<2xi16>
    %10 = llvm.mlir.constant(dense<[77, 99]> : vector<2xi16>) : vector<2xi16>
    %11 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi16>
    %12 = llvm.srem %11, %8  : vector<2xi16>
    %13 = llvm.shufflevector %12, %9 [-1, 0] : vector<2xi16> 
    %14 = llvm.select %arg1, %10, %13 : i1, vector<2xi16>
...
def test_urem_combined := [llvmfunc|
  llvm.func @test_urem(%arg0: i16, %arg1: i1) -> vector<2xi16> {
    ...
    %6 = llvm.insertelement %0, %4[%5 : i32] : vector<2xi16>
    %7 = llvm.mlir.constant(0 : i64) : i64
    %8 = llvm.mlir.constant(dense<[3, 1]> : vector<2xi16>) : vector<2xi16>
    %9 = llvm.mlir.poison : vector<2xi16>
    %10 = llvm.mlir.constant(dense<[77, 99]> : vector<2xi16>) : vector<2xi16>
    %11 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi16>
    %12 = llvm.urem %11, %8  : vector<2xi16>
    %13 = llvm.shufflevector %12, %9 [-1, 0] : vector<2xi16> 
    %14 = llvm.select %arg1, %10, %13 : i1, vector<2xi16>
    llvm.return %14 : vector<2xi16>
  }]
...
def test_sdiv_combined := [llvmfunc|
  llvm.func @test_sdiv(%arg0: i16, %arg1: i1) -> vector<2xi16> {
    ...
    %10 = llvm.mlir.constant(dense<[77, 99]> : vector<2xi16>) : vector<2xi16>
    %11 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi16>
    %12 = llvm.sdiv %11, %8  : vector<2xi16>
    %13 = llvm.shufflevector %12, %9 [-1, 0] : vector<2xi16> 
    %14 = llvm.select %arg1, %10, %13 : i1, vector<2xi16>
    llvm.return %14 : vector<2xi16>
  }]
...
def test_udiv_combined := [llvmfunc|
  llvm.func @test_udiv(%arg0: i16, %arg1: i1) -> vector<2xi16> {
    ...
    %10 = llvm.mlir.constant(dense<[77, 99]> : vector<2xi16>) : vector<2xi16>
    %11 = llvm.insertelement %arg0, %6[%7 : i64] : vector<2xi16>
    %12 = llvm.udiv %11, %8  : vector<2xi16>
    %13 = llvm.shufflevector %12, %9 [-1, 0] : vector<2xi16> 
    %14 = llvm.select %arg1, %10, %13 : i1, vector<2xi16>
    llvm.return %14 : vector<2xi16>
  }]
