...
def fold_strncmp_cst_cst_before := [llvmfunc|
  llvm.func @fold_strncmp_cst_cst(%arg0: !llvm.ptr) {
...
def fold_strncmp_cst_var_before := [llvmfunc|
  llvm.func @fold_strncmp_cst_var(%arg0: !llvm.ptr, %arg1: i64) {
    %0 = llvm.mlir.constant("abcdef\7F") : !llvm.array<7 x i8>
    %1 = llvm.mlir.addressof @a : !llvm.ptr
    %2 = llvm.mlir.constant(0 : i64) : i64
...
def fold_strncmp_cst_cst_combined := [llvmfunc|
  llvm.func @fold_strncmp_cst_cst(%arg0: !llvm.ptr) {
...
theorem inst_combine_fold_strncmp_cst_cst   : fold_strncmp_cst_cst_before  ⊑  fold_strncmp_cst_cst_combined := by
  unfold fold_strncmp_cst_cst_before fold_strncmp_cst_cst_combined
  simp_alive_peephole
  sorry
...
theorem inst_combine_fold_strncmp_cst_cst   : fold_strncmp_cst_cst_before  ⊑  fold_strncmp_cst_cst_combined := by
  ...
  simp_alive_peephole
  sorry
def fold_strncmp_cst_var_combined := [llvmfunc|
  llvm.func @fold_strncmp_cst_var(%arg0: !llvm.ptr, %arg1: i64) {
...
theorem inst_combine_fold_strncmp_cst_var   : fold_strncmp_cst_var_before  ⊑  fold_strncmp_cst_var_combined := by
  unfold fold_strncmp_cst_var_before fold_strncmp_cst_var_combined
  simp_alive_peephole
  sorry
