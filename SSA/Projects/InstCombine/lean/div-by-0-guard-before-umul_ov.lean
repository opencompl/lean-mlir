...
open Std (BitVec)
open Ctxt (Var)
namespace  div-by-0-guard-before-umul_ov
...
def t0_umul_combined := [llvmfunc|
  llvm.func @t0_umul(%arg0: i4, %arg1: i4) -> i1 {
    %0 = "llvm.intr.umul.with.overflow"(%arg0, %arg1) : (i4, i4) -> !llvm.struct<(i4, i1)>
...
def t1_commutative_combined := [llvmfunc|
  llvm.func @t1_commutative(%arg0: i4, %arg1: i4) -> i1 {
    ...
    %1 = "llvm.intr.umul.with.overflow"(%arg0, %0) : (i4, i4) -> !llvm.struct<(i4, i1)>
...
def n5_not_zero_combined := [llvmfunc|
  llvm.func @n5_not_zero(%arg0: i4, %arg1: i4) -> i1 {
    %0 = llvm.mlir.constant(1 : i4) : i4
    %1 = llvm.icmp "ne" %arg0, %0 : i4
    %2 = "llvm.intr.umul.with.overflow"(%arg0, %arg1) : (i4, i4) -> !llvm.struct<(i4, i1)>
