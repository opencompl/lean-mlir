...
def PR1738_logical_noundef_before := [llvmfunc|
...
def PR15737_logical_before := [llvmfunc|
...
def fcmp_ord_nonzero_before := [llvmfunc|
...
def fcmp_ord_nonzero_logical_before := [llvmfunc|
...
def fcmp_ord_nonzero_vec_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_vector_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_commute_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_commute_nsz_rhs_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_commute_nsz_lhs_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_commute_nofabs_ueq_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_commute_nsz_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_ugt_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_ult_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_ule_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_ueq_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_une_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_uno_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_ord_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_oge_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_olt_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_ole_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_oeq_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_unnececcary_fabs_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_not_ord_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_missing_fabs_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_neg_inf_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_not_inf_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_nsz_lhs_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_nsz_rhs_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_nsz_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_fneg_before := [llvmfunc|
...
def clang_builtin_isnormal_inf_check_copysign_before := [llvmfunc|
...
def isnormal_logical_select_0_before := [llvmfunc|
...
def isnormal_logical_select_1_before := [llvmfunc|
...
def isnormal_logical_select_0_fmf0_before := [llvmfunc|
...
def isnormal_logical_select_0_fmf1_before := [llvmfunc|
...
theorem inst_combine_PR1738_logical   : PR1738_logical_before  ⊑  PR1738_logical_combined := by
  ...
  simp_alive_peephole
  sorry
def PR1738_logical_noundef_combined := [llvmfunc|
  llvm.func @PR1738_logical_noundef(%arg0: f64, %arg1: f64 {llvm.noundef}) -> i1 {
    %0 = llvm.fcmp "ord" %arg0, %arg1 : f64
    llvm.return %0 : i1
  }]

theorem inst_combine_PR1738_logical_noundef   : PR1738_logical_noundef_before  ⊑  PR1738_logical_noundef_combined := by
  unfold PR1738_logical_noundef_before PR1738_logical_noundef_combined
  simp_alive_peephole
  sorry
def PR1738_vec_undef_combined := [llvmfunc|
  llvm.func @PR1738_vec_undef(%arg0: vector<2xf64>, %arg1: vector<2xf64>) -> vector<2xi1> {
    %0 = llvm.fcmp "ord" %arg0, %arg1 : vector<2xf64>
...
def PR41069_vec_combined := [llvmfunc|
  llvm.func @PR41069_vec(%arg0: vector<2xf64>, %arg1: vector<2xf64>, %arg2: vector<2xf64>, %arg3: vector<2xf64>) -> vector<2xi1> {
    %0 = llvm.fcmp "ord" %arg0, %arg1 : vector<2xf64>
    %1 = llvm.fcmp "ord" %arg3, %arg2 : vector<2xf64>
    %2 = llvm.and %1, %0  : vector<2xi1>
...
theorem inst_combine_PR15737   : PR15737_before  ⊑  PR15737_combined := by
  unfold PR15737_before PR15737_combined
  simp_alive_peephole
  sorry
def PR15737_logical_combined := [llvmfunc|
  llvm.func @PR15737_logical(%arg0: f32, %arg1: f64) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f32) : f32
    %1 = llvm.mlir.constant(0.000000e+00 : f64) : f64
    %2 = llvm.mlir.constant(false) : i1
...
theorem inst_combine_PR15737_logical   : PR15737_logical_before  ⊑  PR15737_logical_combined := by
  unfold PR15737_logical_before PR15737_logical_combined
  simp_alive_peephole
  sorry
...
theorem inst_combine_t9   : t9_before  ⊑  t9_combined := by
  ...
  simp_alive_peephole
  sorry
def fcmp_ord_nonzero_combined := [llvmfunc|
  llvm.func @fcmp_ord_nonzero(%arg0: f32, %arg1: f32) -> i1 {
    %0 = llvm.fcmp "ord" %arg0, %arg1 : f32
    llvm.return %0 : i1
  }]

theorem inst_combine_fcmp_ord_nonzero   : fcmp_ord_nonzero_before  ⊑  fcmp_ord_nonzero_combined := by
  unfold fcmp_ord_nonzero_before fcmp_ord_nonzero_combined
  simp_alive_peephole
  sorry
def fcmp_ord_nonzero_logical_combined := [llvmfunc|
  llvm.func @fcmp_ord_nonzero_logical(%arg0: f32, %arg1: f32) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f32) : f32
    %1 = llvm.mlir.constant(false) : i1
    %2 = llvm.fcmp "ord" %arg0, %0 : f32
    %3 = llvm.fcmp "ord" %arg1, %0 : f32
    %4 = llvm.select %2, %3, %1 : i1, i1
    llvm.return %4 : i1
  }]

theorem inst_combine_fcmp_ord_nonzero_logical   : fcmp_ord_nonzero_logical_before  ⊑  fcmp_ord_nonzero_logical_combined := by
  unfold fcmp_ord_nonzero_logical_before fcmp_ord_nonzero_logical_combined
  simp_alive_peephole
  sorry
def fcmp_ord_nonzero_vec_combined := [llvmfunc|
  llvm.func @fcmp_ord_nonzero_vec(%arg0: vector<3xf32>, %arg1: vector<3xf32>) -> vector<3xi1> {
    %0 = llvm.fcmp "ord" %arg0, %arg1 : vector<3xf32>
    llvm.return %0 : vector<3xi1>
  }]

theorem inst_combine_fcmp_ord_nonzero_vec   : fcmp_ord_nonzero_vec_before  ⊑  fcmp_ord_nonzero_vec_combined := by
  unfold fcmp_ord_nonzero_vec_before fcmp_ord_nonzero_vec_combined
  simp_alive_peephole
  sorry
...
theorem inst_combine_intersect_fmf_4   : intersect_fmf_4_before  ⊑  intersect_fmf_4_combined := by
  ...
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
    llvm.return %2 : i1
  }]

theorem inst_combine_clang_builtin_isnormal_inf_check   : clang_builtin_isnormal_inf_check_before  ⊑  clang_builtin_isnormal_inf_check_combined := by
  unfold clang_builtin_isnormal_inf_check_before clang_builtin_isnormal_inf_check_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_vector_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_vector(%arg0: vector<2xf16>) -> vector<2xi1> {
    %0 = llvm.mlir.constant(dense<0x7C00> : vector<2xf16>) : vector<2xf16>
    %1 = llvm.intr.fabs(%arg0)  : (vector<2xf16>) -> vector<2xf16>
    %2 = llvm.fcmp "oge" %1, %0 : vector<2xf16>
    llvm.return %2 : vector<2xi1>
  }]

theorem inst_combine_clang_builtin_isnormal_inf_check_vector   : clang_builtin_isnormal_inf_check_vector_before  ⊑  clang_builtin_isnormal_inf_check_vector_combined := by
  unfold clang_builtin_isnormal_inf_check_vector_before clang_builtin_isnormal_inf_check_vector_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_commute_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_commute(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_commute   : clang_builtin_isnormal_inf_check_commute_before  ⊑  clang_builtin_isnormal_inf_check_commute_combined := by
  unfold clang_builtin_isnormal_inf_check_commute_before clang_builtin_isnormal_inf_check_commute_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_commute_nsz_rhs_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_commute_nsz_rhs(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_commute_nsz_rhs   : clang_builtin_isnormal_inf_check_commute_nsz_rhs_before  ⊑  clang_builtin_isnormal_inf_check_commute_nsz_rhs_combined := by
  unfold clang_builtin_isnormal_inf_check_commute_nsz_rhs_before clang_builtin_isnormal_inf_check_commute_nsz_rhs_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_commute_nsz_lhs_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_commute_nsz_lhs(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_commute_nsz_lhs   : clang_builtin_isnormal_inf_check_commute_nsz_lhs_before  ⊑  clang_builtin_isnormal_inf_check_commute_nsz_lhs_combined := by
  unfold clang_builtin_isnormal_inf_check_commute_nsz_lhs_before clang_builtin_isnormal_inf_check_commute_nsz_lhs_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_commute_nofabs_ueq_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_commute_nofabs_ueq(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_commute_nofabs_ueq   : clang_builtin_isnormal_inf_check_commute_nofabs_ueq_before  ⊑  clang_builtin_isnormal_inf_check_commute_nofabs_ueq_combined := by
  unfold clang_builtin_isnormal_inf_check_commute_nofabs_ueq_before clang_builtin_isnormal_inf_check_commute_nofabs_ueq_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_commute_nsz_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_commute_nsz(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_commute_nsz   : clang_builtin_isnormal_inf_check_commute_nsz_before  ⊑  clang_builtin_isnormal_inf_check_commute_nsz_combined := by
  ...
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_ugt_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_ugt(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(false) : i1
    llvm.return %0 : i1
  }]

theorem inst_combine_clang_builtin_isnormal_inf_check_ugt   : clang_builtin_isnormal_inf_check_ugt_before  ⊑  clang_builtin_isnormal_inf_check_ugt_combined := by
  unfold clang_builtin_isnormal_inf_check_ugt_before clang_builtin_isnormal_inf_check_ugt_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_ult_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_ult(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_ult   : clang_builtin_isnormal_inf_check_ult_before  ⊑  clang_builtin_isnormal_inf_check_ult_combined := by
  unfold clang_builtin_isnormal_inf_check_ult_before clang_builtin_isnormal_inf_check_ult_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_ule_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_ule(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f16) : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_ule   : clang_builtin_isnormal_inf_check_ule_before  ⊑  clang_builtin_isnormal_inf_check_ule_combined := by
  unfold clang_builtin_isnormal_inf_check_ule_before clang_builtin_isnormal_inf_check_ule_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_ueq_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_ueq(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_ueq   : clang_builtin_isnormal_inf_check_ueq_before  ⊑  clang_builtin_isnormal_inf_check_ueq_combined := by
  unfold clang_builtin_isnormal_inf_check_ueq_before clang_builtin_isnormal_inf_check_ueq_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_une_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_une(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_une   : clang_builtin_isnormal_inf_check_une_before  ⊑  clang_builtin_isnormal_inf_check_une_combined := by
  unfold clang_builtin_isnormal_inf_check_une_before clang_builtin_isnormal_inf_check_une_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_uno_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_uno(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(false) : i1
    llvm.return %0 : i1
  }]

theorem inst_combine_clang_builtin_isnormal_inf_check_uno   : clang_builtin_isnormal_inf_check_uno_before  ⊑  clang_builtin_isnormal_inf_check_uno_combined := by
  unfold clang_builtin_isnormal_inf_check_uno_before clang_builtin_isnormal_inf_check_uno_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_ord_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_ord(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f16) : f16
    %1 = llvm.fcmp "ord" %arg0, %0 : f16
    llvm.return %1 : i1
...
theorem inst_combine_clang_builtin_isnormal_inf_check_ord   : clang_builtin_isnormal_inf_check_ord_before  ⊑  clang_builtin_isnormal_inf_check_ord_combined := by
  unfold clang_builtin_isnormal_inf_check_ord_before clang_builtin_isnormal_inf_check_ord_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_oge_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_oge(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oeq" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_oge   : clang_builtin_isnormal_inf_check_oge_before  ⊑  clang_builtin_isnormal_inf_check_oge_combined := by
  unfold clang_builtin_isnormal_inf_check_oge_before clang_builtin_isnormal_inf_check_oge_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_olt_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_olt(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "one" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_olt   : clang_builtin_isnormal_inf_check_olt_before  ⊑  clang_builtin_isnormal_inf_check_olt_combined := by
  unfold clang_builtin_isnormal_inf_check_olt_before clang_builtin_isnormal_inf_check_olt_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_ole_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_ole(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f16) : f16
    %1 = llvm.fcmp "ord" %arg0, %0 : f16
    llvm.return %1 : i1
...
theorem inst_combine_clang_builtin_isnormal_inf_check_ole   : clang_builtin_isnormal_inf_check_ole_before  ⊑  clang_builtin_isnormal_inf_check_ole_combined := by
  unfold clang_builtin_isnormal_inf_check_ole_before clang_builtin_isnormal_inf_check_ole_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_oeq_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_oeq(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oeq" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_oeq   : clang_builtin_isnormal_inf_check_oeq_before  ⊑  clang_builtin_isnormal_inf_check_oeq_combined := by
  unfold clang_builtin_isnormal_inf_check_oeq_before clang_builtin_isnormal_inf_check_oeq_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_unnececcary_fabs_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_unnececcary_fabs(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_unnececcary_fabs   : clang_builtin_isnormal_inf_check_unnececcary_fabs_before  ⊑  clang_builtin_isnormal_inf_check_unnececcary_fabs_combined := by
  unfold clang_builtin_isnormal_inf_check_unnececcary_fabs_before clang_builtin_isnormal_inf_check_unnececcary_fabs_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_not_ord_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_not_ord(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f16) : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_not_ord   : clang_builtin_isnormal_inf_check_not_ord_before  ⊑  clang_builtin_isnormal_inf_check_not_ord_combined := by
  unfold clang_builtin_isnormal_inf_check_not_ord_before clang_builtin_isnormal_inf_check_not_ord_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_missing_fabs_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_missing_fabs(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_missing_fabs   : clang_builtin_isnormal_inf_check_missing_fabs_before  ⊑  clang_builtin_isnormal_inf_check_missing_fabs_combined := by
  unfold clang_builtin_isnormal_inf_check_missing_fabs_before clang_builtin_isnormal_inf_check_missing_fabs_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_neg_inf_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_neg_inf(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f16) : f16
    %1 = llvm.fcmp "ord" %arg0, %0 : f16
    llvm.return %1 : i1
...
theorem inst_combine_clang_builtin_isnormal_inf_check_neg_inf   : clang_builtin_isnormal_inf_check_neg_inf_before  ⊑  clang_builtin_isnormal_inf_check_neg_inf_combined := by
  unfold clang_builtin_isnormal_inf_check_neg_inf_before clang_builtin_isnormal_inf_check_neg_inf_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_not_inf_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_not_inf(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f16) : f16
    %1 = llvm.mlir.constant(6.550400e+04 : f16) : f16
    %2 = llvm.intr.fabs(%arg0)  : (f16) -> f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_not_inf   : clang_builtin_isnormal_inf_check_not_inf_before  ⊑  clang_builtin_isnormal_inf_check_not_inf_combined := by
  unfold clang_builtin_isnormal_inf_check_not_inf_before clang_builtin_isnormal_inf_check_not_inf_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_nsz_lhs_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_nsz_lhs(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_nsz_lhs   : clang_builtin_isnormal_inf_check_nsz_lhs_before  ⊑  clang_builtin_isnormal_inf_check_nsz_lhs_combined := by
  unfold clang_builtin_isnormal_inf_check_nsz_lhs_before clang_builtin_isnormal_inf_check_nsz_lhs_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_nsz_rhs_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_nsz_rhs(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_nsz_rhs   : clang_builtin_isnormal_inf_check_nsz_rhs_before  ⊑  clang_builtin_isnormal_inf_check_nsz_rhs_combined := by
  unfold clang_builtin_isnormal_inf_check_nsz_rhs_before clang_builtin_isnormal_inf_check_nsz_rhs_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_nsz_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_nsz(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 {fastmathFlags = #llvm.fastmath<nsz>} : f16
...
theorem inst_combine_clang_builtin_isnormal_inf_check_nsz   : clang_builtin_isnormal_inf_check_nsz_before  ⊑  clang_builtin_isnormal_inf_check_nsz_combined := by
  ...
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_fneg_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_fneg(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.fcmp "oge" %arg0, %0 : f16
    llvm.return %1 : i1
...
theorem inst_combine_clang_builtin_isnormal_inf_check_fneg   : clang_builtin_isnormal_inf_check_fneg_before  ⊑  clang_builtin_isnormal_inf_check_fneg_combined := by
  unfold clang_builtin_isnormal_inf_check_fneg_before clang_builtin_isnormal_inf_check_fneg_combined
  simp_alive_peephole
  sorry
def clang_builtin_isnormal_inf_check_copysign_combined := [llvmfunc|
  llvm.func @clang_builtin_isnormal_inf_check_copysign(%arg0: f16, %arg1: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.copysign(%arg0, %arg1)  : (f16, f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
    llvm.return %2 : i1
  }]

theorem inst_combine_clang_builtin_isnormal_inf_check_copysign   : clang_builtin_isnormal_inf_check_copysign_before  ⊑  clang_builtin_isnormal_inf_check_copysign_combined := by
  unfold clang_builtin_isnormal_inf_check_copysign_before clang_builtin_isnormal_inf_check_copysign_combined
  simp_alive_peephole
  sorry
def isnormal_logical_select_0_combined := [llvmfunc|
  llvm.func @isnormal_logical_select_0(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_isnormal_logical_select_0   : isnormal_logical_select_0_before  ⊑  isnormal_logical_select_0_combined := by
  unfold isnormal_logical_select_0_before isnormal_logical_select_0_combined
  simp_alive_peephole
  sorry
def isnormal_logical_select_1_combined := [llvmfunc|
  llvm.func @isnormal_logical_select_1(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_isnormal_logical_select_1   : isnormal_logical_select_1_before  ⊑  isnormal_logical_select_1_combined := by
  unfold isnormal_logical_select_1_before isnormal_logical_select_1_combined
  simp_alive_peephole
  sorry
def isnormal_logical_select_0_fmf0_combined := [llvmfunc|
  llvm.func @isnormal_logical_select_0_fmf0(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
...
theorem inst_combine_isnormal_logical_select_0_fmf0   : isnormal_logical_select_0_fmf0_before  ⊑  isnormal_logical_select_0_fmf0_combined := by
  ...
  simp_alive_peephole
  sorry
def isnormal_logical_select_0_fmf1_combined := [llvmfunc|
  llvm.func @isnormal_logical_select_0_fmf1(%arg0: f16) -> i1 {
    %0 = llvm.mlir.constant(0x7C00 : f16) : f16
    %1 = llvm.intr.fabs(%arg0)  : (f16) -> f16
    %2 = llvm.fcmp "oge" %1, %0 : f16
...
theorem inst_combine_isnormal_logical_select_0_fmf1   : isnormal_logical_select_0_fmf1_before  ⊑  isnormal_logical_select_0_fmf1_combined := by
  unfold isnormal_logical_select_0_fmf1_before isnormal_logical_select_0_fmf1_combined
  simp_alive_peephole
  sorry
