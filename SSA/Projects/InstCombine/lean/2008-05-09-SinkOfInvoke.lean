...
def _ZNSt5ctypeIcEC2EPiPKtbm_combined := [llvmfunc|
  llvm.func @_ZNSt5ctypeIcEC2EPiPKtbm(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: !llvm.ptr, %arg3: i8 {llvm.zeroext}, %arg4: i64) attributes {personality = @__gxx_personality_v0} {
  ...
  ^bb3:  // pred: ^bb2
    %5 = llvm.load %4 {alignment = 8 : i64} : !llvm.ptr -> !llvm.ptr
    %6 = llvm.getelementptr %arg0[%0, 4] : (!llvm.ptr, i64) -> !llvm.ptr, !llvm.struct<"struct.std::ctype<char>", (struct<"struct.std::locale::facet", (ptr, i32)>, ptr, i8, ptr, ptr, ptr, i8, array<256 x i8>, array<256 x i8>, i8)>
    llvm.store %5, %6 {alignment = 8 : i64} : !llvm.ptr, !llvm.ptr
    llvm.return
  ^bb4:  // 3 preds: ^bb0, ^bb1, ^bb2
    %7 = llvm.landingpad cleanup : !llvm.struct<(ptr, i32)>
...
theorem inst_combine__ZNSt5ctypeIcEC2EPiPKtbm   : _ZNSt5ctypeIcEC2EPiPKtbm_before  ⊑  _ZNSt5ctypeIcEC2EPiPKtbm_combined := by
  unfold _ZNSt5ctypeIcEC2EPiPKtbm_before _ZNSt5ctypeIcEC2EPiPKtbm_combined
  simp_alive_peephole
  sorry
