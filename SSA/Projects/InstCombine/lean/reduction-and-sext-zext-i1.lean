...
open Std (BitVec)
open Ctxt (Var)
namespace  reduction-and-sext-zext-i1
set_option pp.proofs false
set_option pp.proofs.withType false
set_option linter.deprecated false
def reduce_and_self_before := [llvmfunc|
  llvm.func @reduce_and_self(%arg0: vector<8xi1>) -> i1 {
    %0 = "llvm.intr.vector.reduce.and"(%arg0) : (vector<8xi1>) -> i1
    llvm.return %0 : i1
  }]

def reduce_and_sext_before := [llvmfunc|
  llvm.func @reduce_and_sext(%arg0: vector<4xi1>) -> i32 {
    %0 = llvm.sext %arg0 : vector<4xi1> to vector<4xi32>
    %1 = "llvm.intr.vector.reduce.and"(%0) : (vector<4xi32>) -> i32
    llvm.return %1 : i32
  }]

def reduce_and_zext_before := [llvmfunc|
  llvm.func @reduce_and_zext(%arg0: vector<8xi1>) -> i64 {
    %0 = llvm.zext %arg0 : vector<8xi1> to vector<8xi64>
    %1 = "llvm.intr.vector.reduce.and"(%0) : (vector<8xi64>) -> i64
    llvm.return %1 : i64
  }]

def reduce_and_sext_same_before := [llvmfunc|
  llvm.func @reduce_and_sext_same(%arg0: vector<16xi1>) -> i16 {
    %0 = llvm.sext %arg0 : vector<16xi1> to vector<16xi16>
    %1 = "llvm.intr.vector.reduce.and"(%0) : (vector<16xi16>) -> i16
    llvm.return %1 : i16
  }]

def reduce_and_zext_long_before := [llvmfunc|
  llvm.func @reduce_and_zext_long(%arg0: vector<128xi1>) -> i8 {
    %0 = llvm.sext %arg0 : vector<128xi1> to vector<128xi8>
    %1 = "llvm.intr.vector.reduce.and"(%0) : (vector<128xi8>) -> i8
    llvm.return %1 : i8
  }]

def reduce_and_zext_long_external_use_before := [llvmfunc|
  llvm.func @reduce_and_zext_long_external_use(%arg0: vector<128xi1>) -> i8 {
    %0 = llvm.mlir.constant(0 : i32) : i32
    %1 = llvm.mlir.addressof @glob : !llvm.ptr
    %2 = llvm.sext %arg0 : vector<128xi1> to vector<128xi8>
    %3 = "llvm.intr.vector.reduce.and"(%2) : (vector<128xi8>) -> i8
...
def reduce_and_zext_external_use_before := [llvmfunc|
  llvm.func @reduce_and_zext_external_use(%arg0: vector<8xi1>) -> i64 {
    %0 = llvm.mlir.constant(0 : i32) : i32
    %1 = llvm.mlir.addressof @glob1 : !llvm.ptr
    %2 = llvm.zext %arg0 : vector<8xi1> to vector<8xi64>
    %3 = "llvm.intr.vector.reduce.and"(%2) : (vector<8xi64>) -> i64
...
def reduce_and_pointer_cast_before := [llvmfunc|
  llvm.func @reduce_and_pointer_cast(%arg0: !llvm.ptr, %arg1: !llvm.ptr) -> i1 {
    ...
    %2 = llvm.icmp "eq" %0, %1 : vector<8xi8>
    %3 = "llvm.intr.vector.reduce.and"(%2) : (vector<8xi1>) -> i1
    llvm.return %3 : i1
  }]

def reduce_and_pointer_cast_wide_before := [llvmfunc|
  llvm.func @reduce_and_pointer_cast_wide(%arg0: !llvm.ptr, %arg1: !llvm.ptr) -> i1 {
    ...
    %2 = llvm.icmp "eq" %0, %1 : vector<8xi16>
    %3 = "llvm.intr.vector.reduce.and"(%2) : (vector<8xi1>) -> i1
    llvm.return %3 : i1
  }]

def reduce_and_pointer_cast_ne_before := [llvmfunc|
  llvm.func @reduce_and_pointer_cast_ne(%arg0: !llvm.ptr, %arg1: !llvm.ptr) -> i1 {
    ...
    %3 = llvm.icmp "eq" %1, %2 : vector<8xi8>
    %4 = "llvm.intr.vector.reduce.and"(%3) : (vector<8xi1>) -> i1
    %5 = llvm.xor %4, %0  : i1
    llvm.return %5 : i1
  }]

def reduce_and_pointer_cast_ne_wide_before := [llvmfunc|
  llvm.func @reduce_and_pointer_cast_ne_wide(%arg0: !llvm.ptr, %arg1: !llvm.ptr) -> i1 {
    ...
    %3 = llvm.icmp "eq" %1, %2 : vector<8xi16>
    %4 = "llvm.intr.vector.reduce.and"(%3) : (vector<8xi1>) -> i1
    %5 = llvm.xor %4, %0  : i1
    llvm.return %5 : i1
  }]

def reduce_and_self_combined := [llvmfunc|
  llvm.func @reduce_and_self(%arg0: vector<8xi1>) -> i1 {
...
theorem inst_combine_reduce_and_self   : reduce_and_self_before  ⊑  reduce_and_self_combined := by
  unfold reduce_and_self_before reduce_and_self_combined
  simp_alive_peephole
  sorry
def reduce_and_sext_combined := [llvmfunc|
  llvm.func @reduce_and_sext(%arg0: vector<4xi1>) -> i32 {
...
theorem inst_combine_reduce_and_sext   : reduce_and_sext_before  ⊑  reduce_and_sext_combined := by
  unfold reduce_and_sext_before reduce_and_sext_combined
  simp_alive_peephole
  sorry
def reduce_and_zext_combined := [llvmfunc|
  llvm.func @reduce_and_zext(%arg0: vector<8xi1>) -> i64 {
    %0 = llvm.mlir.constant(-1 : i8) : i8
    %1 = llvm.bitcast %arg0 : vector<8xi1> to i8
    %2 = llvm.icmp "eq" %1, %0 : i8
...
theorem inst_combine_reduce_and_zext   : reduce_and_zext_before  ⊑  reduce_and_zext_combined := by
  unfold reduce_and_zext_before reduce_and_zext_combined
  simp_alive_peephole
  sorry
def reduce_and_sext_same_combined := [llvmfunc|
  llvm.func @reduce_and_sext_same(%arg0: vector<16xi1>) -> i16 {
...
theorem inst_combine_reduce_and_sext_same   : reduce_and_sext_same_before  ⊑  reduce_and_sext_same_combined := by
  unfold reduce_and_sext_same_before reduce_and_sext_same_combined
  simp_alive_peephole
  sorry
def reduce_and_zext_long_combined := [llvmfunc|
  llvm.func @reduce_and_zext_long(%arg0: vector<128xi1>) -> i8 {
...
theorem inst_combine_reduce_and_zext_long   : reduce_and_zext_long_before  ⊑  reduce_and_zext_long_combined := by
  unfold reduce_and_zext_long_before reduce_and_zext_long_combined
  simp_alive_peephole
  sorry
def reduce_and_zext_long_external_use_combined := [llvmfunc|
  llvm.func @reduce_and_zext_long_external_use(%arg0: vector<128xi1>) -> i8 {
    %0 = llvm.mlir.constant(-1 : i128) : i128
...
theorem inst_combine_reduce_and_zext_long_external_use   : reduce_and_zext_long_external_use_before  ⊑  reduce_and_zext_long_external_use_combined := by
  ...
  simp_alive_peephole
  sorry
def reduce_and_zext_external_use_combined := [llvmfunc|
  llvm.func @reduce_and_zext_external_use(%arg0: vector<8xi1>) -> i64 {
    %0 = llvm.mlir.constant(-1 : i8) : i8
    %1 = llvm.mlir.constant(0 : i64) : i64
