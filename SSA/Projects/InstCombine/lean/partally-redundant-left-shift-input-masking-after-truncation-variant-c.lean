...
open Std (BitVec)
open Ctxt (Var)
namespace  partally-redundant-left-shift-input-masking-after-truncation-variant-c
...
def t1_vec_splat_combined := [llvmfunc|
  llvm.func @t1_vec_splat(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    %4 = llvm.lshr %0, %3  : vector<8xi64>
    %5 = llvm.add %arg1, %1  : vector<8xi32>
    llvm.call @use8xi64(%3) : (vector<8xi64>) -> ()
    llvm.call @use8xi64(%4) : (vector<8xi64>) -> ()
    llvm.call @use8xi32(%5) : (vector<8xi32>) -> ()
    %6 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %7 = llvm.shl %6, %5  : vector<8xi32>
...
def t2_vec_splat_poison_combined := [llvmfunc|
  llvm.func @t2_vec_splat_poison(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    %57 = llvm.lshr %18, %56  : vector<8xi64>
    %58 = llvm.add %arg1, %37  : vector<8xi32>
    llvm.call @use8xi64(%56) : (vector<8xi64>) -> ()
    llvm.call @use8xi64(%57) : (vector<8xi64>) -> ()
    llvm.call @use8xi32(%58) : (vector<8xi32>) -> ()
    %59 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %60 = llvm.shl %59, %58  : vector<8xi32>
    %61 = llvm.and %60, %55  : vector<8xi32>
    llvm.return %61 : vector<8xi32>
  }]
...
def t3_vec_nonsplat_combined := [llvmfunc|
  llvm.func @t3_vec_nonsplat(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    %65 = llvm.lshr %18, %64  : vector<8xi64>
    %66 = llvm.add %arg1, %43  : vector<8xi32>
    llvm.call @use8xi64(%64) : (vector<8xi64>) -> ()
    llvm.call @use8xi64(%65) : (vector<8xi64>) -> ()
    llvm.call @use8xi32(%66) : (vector<8xi32>) -> ()
    %67 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %68 = llvm.shl %67, %66  : vector<8xi32>
    %69 = llvm.and %68, %63  : vector<8xi32>
    llvm.return %69 : vector<8xi32>
  }]
