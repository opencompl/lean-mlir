...
def reduce_mul_zext_before := [llvmfunc|
...
def reduce_mul_sext_same_before := [llvmfunc|
...
def reduce_mul_zext_long_before := [llvmfunc|
...
def reduce_mul_zext_long_external_use_before := [llvmfunc|
...
def reduce_mul_zext_external_use_before := [llvmfunc|
...
def reduce_mul_self_combined := [llvmfunc|
  llvm.func @reduce_mul_self(%arg0: vector<8xi1>) -> i1 {
...
theorem inst_combine_reduce_mul_self   : reduce_mul_self_before  ⊑  reduce_mul_self_combined := by
  unfold reduce_mul_self_before reduce_mul_self_combined
  simp_alive_peephole
  sorry
def reduce_mul_sext_combined := [llvmfunc|
  llvm.func @reduce_mul_sext(%arg0: vector<4xi1>) -> i32 {
...
theorem inst_combine_reduce_mul_sext   : reduce_mul_sext_before  ⊑  reduce_mul_sext_combined := by
  unfold reduce_mul_sext_before reduce_mul_sext_combined
  simp_alive_peephole
  sorry
def reduce_mul_zext_combined := [llvmfunc|
  llvm.func @reduce_mul_zext(%arg0: vector<8xi1>) -> i64 {
    %0 = llvm.mlir.constant(-1 : i8) : i8
    %1 = llvm.bitcast %arg0 : vector<8xi1> to i8
    %2 = llvm.icmp "eq" %1, %0 : i8
...
theorem inst_combine_reduce_mul_zext   : reduce_mul_zext_before  ⊑  reduce_mul_zext_combined := by
  unfold reduce_mul_zext_before reduce_mul_zext_combined
  simp_alive_peephole
  sorry
def reduce_mul_sext_same_combined := [llvmfunc|
  llvm.func @reduce_mul_sext_same(%arg0: vector<16xi1>) -> i16 {
    %0 = llvm.mlir.constant(-1 : i16) : i16
    %1 = llvm.bitcast %arg0 : vector<16xi1> to i16
    %2 = llvm.icmp "eq" %1, %0 : i16
    %3 = llvm.zext %2 : i1 to i16
    llvm.return %3 : i16
  }]

theorem inst_combine_reduce_mul_sext_same   : reduce_mul_sext_same_before  ⊑  reduce_mul_sext_same_combined := by
  unfold reduce_mul_sext_same_before reduce_mul_sext_same_combined
  simp_alive_peephole
  sorry
def reduce_mul_zext_long_combined := [llvmfunc|
  llvm.func @reduce_mul_zext_long(%arg0: vector<128xi1>) -> i8 {
...
theorem inst_combine_reduce_mul_zext_long   : reduce_mul_zext_long_before  ⊑  reduce_mul_zext_long_combined := by
  unfold reduce_mul_zext_long_before reduce_mul_zext_long_combined
  simp_alive_peephole
  sorry
def reduce_mul_zext_long_external_use_combined := [llvmfunc|
  llvm.func @reduce_mul_zext_long_external_use(%arg0: vector<128xi1>) -> i8 {
    %0 = llvm.mlir.constant(-1 : i128) : i128
...
theorem inst_combine_reduce_mul_zext_long_external_use   : reduce_mul_zext_long_external_use_before  ⊑  reduce_mul_zext_long_external_use_combined := by
  unfold reduce_mul_zext_long_external_use_before reduce_mul_zext_long_external_use_combined
  simp_alive_peephole
  sorry
    llvm.return %5 : i8
  }]
...
theorem inst_combine_reduce_mul_zext_long_external_use   : reduce_mul_zext_long_external_use_before  ⊑  reduce_mul_zext_long_external_use_combined := by
  ...
  simp_alive_peephole
  sorry
def reduce_mul_zext_external_use_combined := [llvmfunc|
  llvm.func @reduce_mul_zext_external_use(%arg0: vector<8xi1>) -> i64 {
    %0 = llvm.mlir.constant(-1 : i8) : i8
    %1 = llvm.mlir.constant(0 : i64) : i64
...
theorem inst_combine_reduce_mul_zext_external_use   : reduce_mul_zext_external_use_before  ⊑  reduce_mul_zext_external_use_combined := by
  unfold reduce_mul_zext_external_use_before reduce_mul_zext_external_use_combined
  simp_alive_peephole
  sorry
    llvm.return %5 : i64
  }]
