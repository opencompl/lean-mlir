...
def extract_element_binop_splat_variable_index_may_trap_before := [llvmfunc|
  llvm.func @extract_element_binop_splat_variable_index_may_trap(%arg0: vector<4xi8>, %arg1: vector<4xi8>, %arg2: i32) -> i8 {
    %0 = llvm.mlir.constant(dense<42> : vector<4xi8>) : vector<4xi8>
    %1 = llvm.sdiv %0, %arg1  : vector<4xi8>
    %2 = llvm.extractelement %1[%arg2 : i32] : vector<4xi8>
    llvm.return %2 : i8
  }]

def extract_element_binop_constant_index_may_trap_before := [llvmfunc|
  llvm.func @extract_element_binop_constant_index_may_trap(%arg0: vector<4xi8>, %arg1: vector<4xi8>, %arg2: i32) -> i8 {
    %0 = llvm.mlir.constant(dense<42> : vector<4xi8>) : vector<4xi8>
    %1 = llvm.mlir.constant(3 : i32) : i32
    %2 = llvm.sdiv %0, %arg1  : vector<4xi8>
    %3 = llvm.extractelement %2[%1 : i32] : vector<4xi8>
    llvm.return %3 : i8
  }]
...
def extractelt_vector_fcmp_copy_flags_before := [llvmfunc|
  llvm.func @extractelt_vector_fcmp_copy_flags(%arg0: vector<4xf32>) -> i1 {
    %0 = llvm.mlir.constant(0.000000e+00 : f32) : f32
    %1 = llvm.mlir.constant(dense<0.000000e+00> : vector<4xf32>) : vector<4xf32>
    %2 = llvm.mlir.constant(2 : i32) : i32
    %3 = llvm.fcmp "oeq" %arg0, %1 {fastmathFlags = #llvm.fastmath<nsz, arcp>} : vector<4xf32>]

    %4 = llvm.extractelement %3[%2 : i32] : vector<4xi1>
    llvm.return %4 : i1
  }]
...
theorem inst_combine_extract_element_binop_splat_variable_index   : extract_element_binop_splat_variable_index_before  ⊑  extract_element_binop_splat_variable_index_combined := by
  ...
  simp_alive_peephole
  sorry
def extract_element_binop_splat_variable_index_may_trap_combined := [llvmfunc|
  llvm.func @extract_element_binop_splat_variable_index_may_trap(%arg0: vector<4xi8>, %arg1: vector<4xi8>, %arg2: i32) -> i8 {
    %0 = llvm.mlir.constant(42 : i8) : i8
    %1 = llvm.extractelement %arg1[%arg2 : i32] : vector<4xi8>
    %2 = llvm.sdiv %0, %1  : i8
    llvm.return %2 : i8
  }]

theorem inst_combine_extract_element_binop_splat_variable_index_may_trap   : extract_element_binop_splat_variable_index_may_trap_before  ⊑  extract_element_binop_splat_variable_index_may_trap_combined := by
  unfold extract_element_binop_splat_variable_index_may_trap_before extract_element_binop_splat_variable_index_may_trap_combined
  simp_alive_peephole
  sorry
def extract_element_binop_constant_index_may_trap_combined := [llvmfunc|
  llvm.func @extract_element_binop_constant_index_may_trap(%arg0: vector<4xi8>, %arg1: vector<4xi8>, %arg2: i32) -> i8 {
    %0 = llvm.mlir.constant(3 : i64) : i64
    %1 = llvm.mlir.constant(42 : i8) : i8
    %2 = llvm.extractelement %arg1[%0 : i64] : vector<4xi8>
    %3 = llvm.sdiv %1, %2  : i8
    llvm.return %3 : i8
  }]

theorem inst_combine_extract_element_binop_constant_index_may_trap   : extract_element_binop_constant_index_may_trap_before  ⊑  extract_element_binop_constant_index_may_trap_combined := by
  unfold extract_element_binop_constant_index_may_trap_before extract_element_binop_constant_index_may_trap_combined
  simp_alive_peephole
  sorry
...
theorem inst_combine_extractelt_vector_fcmp_constrhs_dynidx   : extractelt_vector_fcmp_constrhs_dynidx_before  ⊑  extractelt_vector_fcmp_constrhs_dynidx_combined := by
  ...
  simp_alive_peephole
  sorry
def extractelt_vector_fcmp_copy_flags_combined := [llvmfunc|
  llvm.func @extractelt_vector_fcmp_copy_flags(%arg0: vector<4xf32>) -> i1 {
    %0 = llvm.mlir.constant(2 : i64) : i64
    %1 = llvm.mlir.constant(0.000000e+00 : f32) : f32
    %2 = llvm.extractelement %arg0[%0 : i64] : vector<4xf32>
...
theorem inst_combine_extractelt_vector_fcmp_copy_flags   : extractelt_vector_fcmp_copy_flags_before  ⊑  extractelt_vector_fcmp_copy_flags_combined := by
  unfold extractelt_vector_fcmp_copy_flags_before extractelt_vector_fcmp_copy_flags_combined
  simp_alive_peephole
  sorry
