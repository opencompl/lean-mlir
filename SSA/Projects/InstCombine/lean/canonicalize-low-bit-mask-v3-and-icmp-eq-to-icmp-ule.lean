...
open Std (BitVec)
open Ctxt (Var)
namespace  canonicalize-low-bit-mask-v3-and-icmp-eq-to-icmp-ule
...
def p4_vec_poiso2_before := [llvmfunc|
...
theorem inst_combine_p3_vec_poison0   : p3_vec_poison0_before  ⊑  p3_vec_poison0_combined := by
  ...
  simp_alive_peephole
  sorry
def p4_vec_poiso2_combined := [llvmfunc|
  llvm.func @p4_vec_poiso2(%arg0: vector<3xi8>, %arg1: vector<3xi8>) -> vector<3xi1> {
    %0 = llvm.mlir.constant(1 : i8) : i8
    %1 = llvm.mlir.poison : i8
    %2 = llvm.mlir.undef : vector<3xi8>
...
theorem inst_combine_p4_vec_poiso2   : p4_vec_poiso2_before  ⊑  p4_vec_poiso2_combined := by
  unfold p4_vec_poiso2_before p4_vec_poiso2_combined
  simp_alive_peephole
  sorry
