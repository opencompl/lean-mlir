...
def sub_to_xor_extra_use_and_or_before := [llvmfunc|
...
def sub_to_xor_vec_combined := [llvmfunc|
  llvm.func @sub_to_xor_vec(%arg0: vector<2xi32>, %arg1: vector<2xi32>) -> vector<2xi32> {
    ...
    %2 = llvm.xor %arg1, %arg0  : vector<2xi32>
...
theorem inst_combine_sub_to_xor_vec   : sub_to_xor_vec_before  ⊑  sub_to_xor_vec_combined := by
  ...
  simp_alive_peephole
  sorry
def sub_to_xor_extra_use_and_or_combined := [llvmfunc|
  llvm.func @sub_to_xor_extra_use_and_or(%arg0: i32, %arg1: i32) -> i32 {
    %0 = llvm.or %arg0, %arg1  : i32
    llvm.call @use(%0) : (i32) -> ()
    %1 = llvm.and %arg0, %arg1  : i32
...
theorem inst_combine_sub_to_xor_extra_use_and_or   : sub_to_xor_extra_use_and_or_before  ⊑  sub_to_xor_extra_use_and_or_combined := by
  unfold sub_to_xor_extra_use_and_or_before sub_to_xor_extra_use_and_or_combined
  simp_alive_peephole
  sorry
