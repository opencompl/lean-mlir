...
open Std (BitVec)
open Ctxt (Var)
namespace  redundant-left-shift-input-masking-variant-f
...
def t2_vec_splat_before := [llvmfunc|
  llvm.func @t2_vec_splat(%arg0: vector<3xi32>, %arg1: vector<3xi32>) -> vector<3xi32> {
    ...
    %2 = llvm.ashr %1, %arg1  : vector<3xi32>
...
def t4_vec_undef_before := [llvmfunc|
  llvm.func @t4_vec_undef(%arg0: vector<3xi32>, %arg1: vector<3xi32>) -> vector<3xi32> {
    ...
    %10 = llvm.ashr %9, %arg1  : vector<3xi32>
...
def n11_shamt_is_smaller_before := [llvmfunc|
  llvm.func @n11_shamt_is_smaller(%arg0: i32, %arg1: i32) -> i32 {
    %0 = llvm.mlir.constant(-1 : i32) : i32
    %1 = llvm.shl %arg0, %arg1  : i32
    %2 = llvm.ashr %1, %arg1  : i32
    %3 = llvm.add %arg1, %0  : i32
...
theorem inst_combine_n10_different_shamts1   : n10_different_shamts1_before  ⊑  n10_different_shamts1_combined := by
  ...
  simp_alive_peephole
  sorry
def n11_shamt_is_smaller_combined := [llvmfunc|
  llvm.func @n11_shamt_is_smaller(%arg0: i32, %arg1: i32) -> i32 {
    %0 = llvm.mlir.constant(-1 : i32) : i32
    %1 = llvm.shl %arg0, %arg1  : i32
    %2 = llvm.ashr %1, %arg1  : i32
...
theorem inst_combine_n11_shamt_is_smaller   : n11_shamt_is_smaller_before  ⊑  n11_shamt_is_smaller_combined := by
  unfold n11_shamt_is_smaller_before n11_shamt_is_smaller_combined
  simp_alive_peephole
  sorry
