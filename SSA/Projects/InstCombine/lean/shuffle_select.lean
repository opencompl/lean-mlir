...
def or_2_vars_undef_mask_elt_before := [llvmfunc|
...
def mul_neg_2_vars_before := [llvmfunc|
...
def neg_mul_2_vars_before := [llvmfunc|
...
def add_or_disjoint_before := [llvmfunc|
...
def sel_common_op_commute0_before := [llvmfunc|
...
def sel_common_op_commute1_before := [llvmfunc|
...
def sel_common_op_commute2_before := [llvmfunc|
...
def sel_common_op_commute3_before := [llvmfunc|
...
def sel_common_op_commute3_poison_mask_elts_before := [llvmfunc|
...
def sel_not_common_op_commute3_before := [llvmfunc|
...
def not_sel_common_op_before := [llvmfunc|
...
def sel_common_op_extra_use_before := [llvmfunc|
...
def identity_mask_before := [llvmfunc|
...
theorem inst_combine_or_2_vars   : or_2_vars_before  ⊑  or_2_vars_combined := by
  ...
  simp_alive_peephole
  sorry
def or_2_vars_undef_mask_elt_combined := [llvmfunc|
  llvm.func @or_2_vars_undef_mask_elt(%arg0: vector<4xi32>, %arg1: vector<4xi32>) -> vector<4xi32> {
    %0 = llvm.mlir.constant(dense<[1, 2, 3, 4]> : vector<4xi32>) : vector<4xi32>
    %1 = llvm.mlir.undef : i32
    %2 = llvm.mlir.constant(3 : i32) : i32
    ...
    %14 = llvm.or %arg0, %0  : vector<4xi32>
    llvm.call @use_v4i32(%14) : (vector<4xi32>) -> ()
    %15 = llvm.shufflevector %arg1, %arg0 [0, 1, 6, -1] : vector<4xi32> 
    %16 = llvm.or %15, %13  : vector<4xi32>
    llvm.return %16 : vector<4xi32>
  }]

theorem inst_combine_or_2_vars_undef_mask_elt   : or_2_vars_undef_mask_elt_before  ⊑  or_2_vars_undef_mask_elt_combined := by
  unfold or_2_vars_undef_mask_elt_before or_2_vars_undef_mask_elt_combined
  simp_alive_peephole
  sorry
...
theorem inst_combine_shl_mul_2_vars   : shl_mul_2_vars_before  ⊑  shl_mul_2_vars_combined := by
  ...
  simp_alive_peephole
  sorry
def mul_neg_combined := [llvmfunc|
  llvm.func @mul_neg(%arg0: vector<4xi32>) -> vector<4xi32> {
    %0 = llvm.mlir.constant(dense<[257, -3, -1, -9]> : vector<4xi32>) : vector<4xi32>
    %1 = llvm.mul %arg0, %0  : vector<4xi32>
    llvm.return %1 : vector<4xi32>
  }]

theorem inst_combine_mul_neg   : mul_neg_before  ⊑  mul_neg_combined := by
  unfold mul_neg_before mul_neg_combined
  simp_alive_peephole
  sorry
def neg_mul_combined := [llvmfunc|
  llvm.func @neg_mul(%arg0: vector<3xi79>) -> vector<3xi79> {
    %0 = llvm.mlir.constant(-1 : i79) : i79
    %1 = llvm.mlir.constant(-3 : i79) : i79
    %2 = llvm.mlir.constant(dense<[-1, -3, -1]> : vector<3xi79>) : vector<3xi79>
    %3 = llvm.mul %arg0, %2 overflow<nsw>  : vector<3xi79>
    llvm.return %3 : vector<3xi79>
  }]

theorem inst_combine_neg_mul   : neg_mul_before  ⊑  neg_mul_combined := by
  unfold neg_mul_before neg_mul_combined
  simp_alive_peephole
  sorry
def mul_neg_2_vars_combined := [llvmfunc|
  llvm.func @mul_neg_2_vars(%arg0: vector<4xi32>, %arg1: vector<4xi32>) -> vector<4xi32> {
    %0 = llvm.mlir.constant(dense<[42, -1, -1, 6]> : vector<4xi32>) : vector<4xi32>
    %1 = llvm.shufflevector %arg0, %arg1 [0, 5, 6, 3] : vector<4xi32> 
    %2 = llvm.mul %1, %0  : vector<4xi32>
    llvm.return %2 : vector<4xi32>
  }]

theorem inst_combine_mul_neg_2_vars   : mul_neg_2_vars_before  ⊑  mul_neg_2_vars_combined := by
  unfold mul_neg_2_vars_before mul_neg_2_vars_combined
  simp_alive_peephole
  sorry
def neg_mul_2_vars_combined := [llvmfunc|
  llvm.func @neg_mul_2_vars(%arg0: vector<4xi32>, %arg1: vector<4xi32>) -> vector<4xi32> {
    %0 = llvm.mlir.constant(dense<[-1, 42, -1, 6]> : vector<4xi32>) : vector<4xi32>
    %1 = llvm.shufflevector %arg1, %arg0 [0, 5, 2, 7] : vector<4xi32> 
    %2 = llvm.mul %1, %0 overflow<nsw>  : vector<4xi32>
    llvm.return %2 : vector<4xi32>
  }]

theorem inst_combine_neg_mul_2_vars   : neg_mul_2_vars_before  ⊑  neg_mul_2_vars_combined := by
  unfold neg_mul_2_vars_before neg_mul_2_vars_combined
  simp_alive_peephole
  sorry
...
theorem inst_combine_add_or   : add_or_before  ⊑  add_or_combined := by
  ...
  simp_alive_peephole
  sorry
def add_or_disjoint_combined := [llvmfunc|
  llvm.func @add_or_disjoint(%arg0: vector<4xi32>) -> vector<4xi32> {
    ...
    %17 = llvm.insertelement %12, %15[%16 : i32] : vector<4xi32>
    %18 = llvm.mlir.constant(2 : i32) : i32
    %19 = llvm.insertelement %2, %17[%18 : i32] : vector<4xi32>
    %20 = llvm.mlir.constant(3 : i32) : i32
    %21 = llvm.insertelement %2, %19[%20 : i32] : vector<4xi32>
    %22 = llvm.add %arg0, %11  : vector<4xi32>
    %23 = llvm.or %arg0, %21  : vector<4xi32>
    %24 = llvm.shufflevector %23, %22 [0, 1, 6, 7] : vector<4xi32> 
    llvm.return %24 : vector<4xi32>
  }]

theorem inst_combine_add_or_disjoint   : add_or_disjoint_before  ⊑  add_or_disjoint_combined := by
  unfold add_or_disjoint_before add_or_disjoint_combined
  simp_alive_peephole
  sorry
...
def PR41419_combined := [llvmfunc|
  llvm.func @PR41419(%arg0: vector<4xi32>) -> vector<4xi32> {
    ...
    %9 = llvm.mlir.constant(3 : i32) : i32
    %10 = llvm.insertelement %0, %8[%9 : i32] : vector<4xi32>
    %11 = llvm.shufflevector %arg0, %10 [4, 5, 2, 7] : vector<4xi32> 
...
theorem inst_combine_PR41419   : PR41419_before  ⊑  PR41419_combined := by
  ...
  simp_alive_peephole
  sorry
def sel_common_op_commute0_combined := [llvmfunc|
  llvm.func @sel_common_op_commute0(%arg0: vector<5xi4>, %arg1: vector<5xi4>) -> vector<5xi4> {
    %0 = llvm.shufflevector %arg0, %arg1 [0, 6, 2, 3, 4] : vector<5xi4> 
    llvm.return %0 : vector<5xi4>
  }]

theorem inst_combine_sel_common_op_commute0   : sel_common_op_commute0_before  ⊑  sel_common_op_commute0_combined := by
  unfold sel_common_op_commute0_before sel_common_op_commute0_combined
  simp_alive_peephole
  sorry
def sel_common_op_commute1_combined := [llvmfunc|
  llvm.func @sel_common_op_commute1(%arg0: vector<5xi4>, %arg1: vector<5xi4>) -> vector<5xi4> {
    %0 = llvm.shufflevector %arg0, %arg1 [0, 1, 7, 3, 4] : vector<5xi4> 
    llvm.return %0 : vector<5xi4>
  }]

theorem inst_combine_sel_common_op_commute1   : sel_common_op_commute1_before  ⊑  sel_common_op_commute1_combined := by
  unfold sel_common_op_commute1_before sel_common_op_commute1_combined
  simp_alive_peephole
  sorry
def sel_common_op_commute2_combined := [llvmfunc|
  llvm.func @sel_common_op_commute2(%arg0: vector<5xi4>, %arg1: vector<5xi4>) -> vector<5xi4> {
    %0 = llvm.shufflevector %arg0, %arg1 [0, 1, 2, 3, 9] : vector<5xi4> 
    llvm.return %0 : vector<5xi4>
  }]

theorem inst_combine_sel_common_op_commute2   : sel_common_op_commute2_before  ⊑  sel_common_op_commute2_combined := by
  unfold sel_common_op_commute2_before sel_common_op_commute2_combined
  simp_alive_peephole
  sorry
def sel_common_op_commute3_combined := [llvmfunc|
  llvm.func @sel_common_op_commute3(%arg0: vector<5xi4>, %arg1: vector<5xi4>) -> vector<5xi4> {
    %0 = llvm.shufflevector %arg1, %arg0 [0, 6, 7, 3, 9] : vector<5xi4> 
    llvm.return %0 : vector<5xi4>
  }]

theorem inst_combine_sel_common_op_commute3   : sel_common_op_commute3_before  ⊑  sel_common_op_commute3_combined := by
  unfold sel_common_op_commute3_before sel_common_op_commute3_combined
  simp_alive_peephole
  sorry
def sel_common_op_commute3_poison_mask_elts_combined := [llvmfunc|
  llvm.func @sel_common_op_commute3_poison_mask_elts(%arg0: vector<5xi4>, %arg1: vector<5xi4>) -> vector<5xi4> {
    %0 = llvm.shufflevector %arg1, %arg0 [0, 6, -1, -1, 9] : vector<5xi4> 
    llvm.return %0 : vector<5xi4>
  }]

theorem inst_combine_sel_common_op_commute3_poison_mask_elts   : sel_common_op_commute3_poison_mask_elts_before  ⊑  sel_common_op_commute3_poison_mask_elts_combined := by
  unfold sel_common_op_commute3_poison_mask_elts_before sel_common_op_commute3_poison_mask_elts_combined
  simp_alive_peephole
  sorry
def sel_not_common_op_commute3_combined := [llvmfunc|
  llvm.func @sel_not_common_op_commute3(%arg0: vector<5xi4>, %arg1: vector<5xi4>, %arg2: vector<5xi4>) -> vector<5xi4> {
    %0 = llvm.shufflevector %arg1, %arg2 [0, -1, -1, 3, 9] : vector<5xi4> 
    %1 = llvm.shufflevector %0, %arg0 [0, 6, 7, 3, 4] : vector<5xi4> 
    llvm.return %1 : vector<5xi4>
  }]

theorem inst_combine_sel_not_common_op_commute3   : sel_not_common_op_commute3_before  ⊑  sel_not_common_op_commute3_combined := by
  unfold sel_not_common_op_commute3_before sel_not_common_op_commute3_combined
  simp_alive_peephole
  sorry
def not_sel_common_op_combined := [llvmfunc|
  llvm.func @not_sel_common_op(%arg0: vector<5xi4>, %arg1: vector<5xi4>) -> vector<5xi4> {
    %0 = llvm.shufflevector %arg1, %arg0 [-1, 6, -1, 3, 9] : vector<5xi4> 
    %1 = llvm.shufflevector %0, %arg0 [1, 6, 7, 3, 4] : vector<5xi4> 
    llvm.return %1 : vector<5xi4>
  }]

theorem inst_combine_not_sel_common_op   : not_sel_common_op_before  ⊑  not_sel_common_op_combined := by
  unfold not_sel_common_op_before not_sel_common_op_combined
  simp_alive_peephole
  sorry
def sel_common_op_extra_use_combined := [llvmfunc|
  llvm.func @sel_common_op_extra_use(%arg0: vector<4xi32>, %arg1: vector<4xi32>) -> vector<4xi32> {
    %0 = llvm.shufflevector %arg1, %arg0 [0, 5, 2, 7] : vector<4xi32> 
    llvm.call @use_v4i32(%0) : (vector<4xi32>) -> ()
    %1 = llvm.shufflevector %arg1, %arg0 [0, 5, 6, 7] : vector<4xi32> 
    llvm.return %1 : vector<4xi32>
  }]

theorem inst_combine_sel_common_op_extra_use   : sel_common_op_extra_use_before  ⊑  sel_common_op_extra_use_combined := by
  unfold sel_common_op_extra_use_before sel_common_op_extra_use_combined
  simp_alive_peephole
  sorry
def identity_mask_combined := [llvmfunc|
  llvm.func @identity_mask(%arg0: vector<4xf32>, %arg1: vector<4xf32>) -> vector<4xf32> {
    %0 = llvm.mlir.poison : vector<4xf32>
    %1 = llvm.shufflevector %arg0, %0 [0, -1, 2, 3] : vector<4xf32> 
    llvm.return %1 : vector<4xf32>
  }]

theorem inst_combine_identity_mask   : identity_mask_before  ⊑  identity_mask_combined := by
  unfold identity_mask_before identity_mask_combined
  simp_alive_peephole
  sorry
