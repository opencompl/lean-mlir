...
open Std (BitVec)
open Ctxt (Var)
namespace  sink-not-into-logical-and
...
theorem inst_combine_PR59704   : PR59704_before  ⊑  PR59704_combined := by
  unfold PR59704_before PR59704_combined
  simp_alive_peephole
  sorry
