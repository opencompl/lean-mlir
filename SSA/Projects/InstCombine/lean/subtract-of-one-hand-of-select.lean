...
open Std (BitVec)
open Ctxt (Var)
namespace  subtract-of-one-hand-of-select
set_option pp.proofs false
set_option pp.proofs.withType false
set_option linter.deprecated false
def t0_sub_of_trueval_before := [llvmfunc|
  llvm.func @t0_sub_of_trueval(%arg0: i1, %arg1: i8, %arg2: i8) -> i8 {
    %0 = llvm.select %arg0, %arg1, %arg2 : i1, i8
    %1 = llvm.sub %0, %arg1  : i8
    llvm.return %1 : i8
  }]

def t1_sub_of_falseval_before := [llvmfunc|
  llvm.func @t1_sub_of_falseval(%arg0: i1, %arg1: i8, %arg2: i8) -> i8 {
    %0 = llvm.select %arg0, %arg1, %arg2 : i1, i8
...
def t0_sub_of_trueval_combined := [llvmfunc|
  llvm.func @t0_sub_of_trueval(%arg0: i1, %arg1: i8, %arg2: i8) -> i8 {
...
theorem inst_combine_t0_sub_of_trueval   : t0_sub_of_trueval_before  ⊑  t0_sub_of_trueval_combined := by
  unfold t0_sub_of_trueval_before t0_sub_of_trueval_combined
  simp_alive_peephole
  sorry
def t1_sub_of_falseval_combined := [llvmfunc|
  llvm.func @t1_sub_of_falseval(%arg0: i1, %arg1: i8, %arg2: i8) -> i8 {
    %0 = llvm.mlir.constant(0 : i8) : i8
...
theorem inst_combine_t1_sub_of_falseval   : t1_sub_of_falseval_before  ⊑  t1_sub_of_falseval_combined := by
  unfold t1_sub_of_falseval_before t1_sub_of_falseval_combined
  simp_alive_peephole
  sorry
def t2_vec_combined := [llvmfunc|
  llvm.func @t2_vec(%arg0: i1, %arg1: vector<2xi8>, %arg2: vector<2xi8>) -> vector<2xi8> {
    ...
    %2 = llvm.sub %arg2, %arg1  : vector<2xi8>
