...
open Std (BitVec)
open Ctxt (Var)
namespace  partally-redundant-left-shift-input-masking-after-truncation-variant-d
...
def t1_vec_splat_combined := [llvmfunc|
  llvm.func @t1_vec_splat(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    %4 = llvm.shl %0, %3 overflow<nsw>  : vector<8xi64>
    %5 = llvm.lshr %4, %3  : vector<8xi64>
    %6 = llvm.add %arg1, %1  : vector<8xi32>
    llvm.call @use8xi64(%3) : (vector<8xi64>) -> ()
    llvm.call @use8xi64(%4) : (vector<8xi64>) -> ()
    llvm.call @use8xi64(%5) : (vector<8xi64>) -> ()
    llvm.call @use8xi32(%6) : (vector<8xi32>) -> ()
    %7 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %8 = llvm.shl %7, %6  : vector<8xi32>
    %9 = llvm.and %8, %2  : vector<8xi32>
...
def t2_vec_splat_poison_combined := [llvmfunc|
  llvm.func @t2_vec_splat_poison(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    %36 = llvm.mlir.constant(7 : i32) : i32
    %37 = llvm.insertelement %19, %35[%36 : i32] : vector<8xi32>
    %38 = llvm.mlir.constant(2147483647 : i32) : i32
    ...
    %53 = llvm.insertelement %20, %51[%52 : i32] : vector<8xi32>
    ...
    %57 = llvm.shl %18, %56 overflow<nsw>  : vector<8xi64>
    %58 = llvm.lshr %57, %56  : vector<8xi64>
    %59 = llvm.add %arg1, %37  : vector<8xi32>
    ...
    %60 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %61 = llvm.shl %60, %59  : vector<8xi32>
    %62 = llvm.and %61, %55  : vector<8xi32>
...
def t3_vec_nonsplat_combined := [llvmfunc|
  llvm.func @t3_vec_nonsplat(%arg0: vector<8xi64>, %arg1: vector<8xi32>) -> vector<8xi32> {
    ...
    %45 = llvm.mlir.constant(2147483647 : i32) : i32
    %46 = llvm.mlir.constant(1 : i32) : i32
    %47 = llvm.mlir.undef : vector<8xi32>
    %48 = llvm.mlir.constant(0 : i32) : i32
    %49 = llvm.insertelement %20, %47[%48 : i32] : vector<8xi32>
    %50 = llvm.mlir.constant(1 : i32) : i32
    %51 = llvm.insertelement %46, %49[%50 : i32] : vector<8xi32>
    %52 = llvm.mlir.constant(2 : i32) : i32
    %53 = llvm.insertelement %45, %51[%52 : i32] : vector<8xi32>
    %54 = llvm.mlir.constant(3 : i32) : i32
    %55 = llvm.insertelement %44, %53[%54 : i32] : vector<8xi32>
    %56 = llvm.mlir.constant(4 : i32) : i32
    %57 = llvm.insertelement %44, %55[%56 : i32] : vector<8xi32>
    %58 = llvm.mlir.constant(5 : i32) : i32
    %59 = llvm.insertelement %44, %57[%58 : i32] : vector<8xi32>
    %60 = llvm.mlir.constant(6 : i32) : i32
    %61 = llvm.insertelement %20, %59[%60 : i32] : vector<8xi32>
    %62 = llvm.mlir.constant(7 : i32) : i32
    %63 = llvm.insertelement %20, %61[%62 : i32] : vector<8xi32>
    %64 = llvm.zext %arg1 : vector<8xi32> to vector<8xi64>
    %65 = llvm.shl %18, %64 overflow<nsw>  : vector<8xi64>
    %66 = llvm.lshr %65, %64  : vector<8xi64>
    %67 = llvm.add %arg1, %43  : vector<8xi32>
    llvm.call @use8xi64(%64) : (vector<8xi64>) -> ()
    llvm.call @use8xi64(%65) : (vector<8xi64>) -> ()
    llvm.call @use8xi64(%66) : (vector<8xi64>) -> ()
    llvm.call @use8xi32(%67) : (vector<8xi32>) -> ()
    %68 = llvm.trunc %arg0 : vector<8xi64> to vector<8xi32>
    %69 = llvm.shl %68, %67  : vector<8xi32>
    %70 = llvm.and %69, %63  : vector<8xi32>
    llvm.return %70 : vector<8xi32>
  }]
...
theorem inst_combine_PR51351   : PR51351_before  ⊑  PR51351_combined := by
  unfold PR51351_before PR51351_combined
  simp_alive_peephole
  sorry
