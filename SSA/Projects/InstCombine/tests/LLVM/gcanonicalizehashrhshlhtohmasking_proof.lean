...
theorem positive_sameconst_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 3 = x := by
  sorry

theorem positive_biggerashr_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 6 <<< 3 = x.sshiftRight 3 := by
  sorry

theorem positive_biggershl_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 6 = x <<< 3 := by
  sorry
...
theorem positive_sameconst_shlnsw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 3 = x := by
  sorry

theorem positive_biggerashr_shlnsw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 6 <<< 3 = x.sshiftRight 3 := by
  sorry

theorem positive_biggershl_shlnsw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 6 = x <<< 3 := by
  sorry
...
theorem positive_sameconst_shlnuw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 3 = x := by
  sorry

theorem positive_biggerashr_shlnuw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 6 <<< 3 = x.sshiftRight 3 := by
  sorry

theorem positive_biggershl_shlnuw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 6 = x <<< 3 := by
  sorry
...
theorem positive_sameconst_shlnuwnsw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 3 = x := by
  sorry

theorem positive_biggerashr_shlnuwnsw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 6 <<< 3 = x.sshiftRight 3 := by
  sorry

theorem positive_biggershl_shlnuwnsw_ashrexact_thm (x : _root_.BitVec 8) : 
    x.sshiftRight 3 <<< 6 = x <<< 3 := by
  sorry
