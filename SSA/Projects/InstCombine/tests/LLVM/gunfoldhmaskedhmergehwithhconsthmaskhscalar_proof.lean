...
theorem in_constant_14_vary_thm (x : BitVec 4) : (x ^^^ 14#4) &&& 1#4 ^^^ x = x &&& 14#4 := sorry

theorem c_1_0_0_thm (x x_1 : BitVec 4) : (x_1 ^^^ x) &&& 14#4 ^^^ x_1 = x &&& 14#4 ||| x_1 &&& 1#4 := sorry

theorem c_0_1_0_thm (x x_1 : BitVec 4) : (x_1 ^^^ x) &&& 14#4 ^^^ x_1 = x &&& 14#4 ||| x_1 &&& 1#4 := sorry
