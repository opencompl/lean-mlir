import SSA.Projects.InstCombine.tests.LLVM.g2012h08h28hudiv_ashl_proof
...
{
^0(%arg5 : i32):
  %0 = "llvm.mlir.constant"() <{value = 400 : i32}> : () -> i32
...
{
^0(%arg2 : i80):
  %0 = "llvm.mlir.constant"() <{value = 2 : i80}> : () -> i80
  %1 = "llvm.mlir.constant"() <{value = 100 : i80}> : () -> i80
...
{
^0(%arg2 : i80):
  %0 = "llvm.mlir.constant"() <{value = 400 : i80}> : () -> i80
