...
theorem test12_commuted_thm (x x_1 : _root_.BitVec 32) : 
...
theorem or_and_xor_not_constant_commute1_thm (x x_1 : _root_.BitVec 9) : 
    (x_1 ^^^ x) &&& 42#9 ||| x_1 &&& 469#9 = x &&& 42#9 ^^^ x_1 := by
  sorry

theorem not_or_xor_thm (x : _root_.BitVec 8) : 
    (x ^^^ 255#8 ||| 7#8) ^^^ 12#8 = x &&& 248#8 ^^^ 243#8 := by
  sorry

theorem xor_or_thm (x : _root_.BitVec 8) : 
    x ^^^ 32#8 ||| 7#8 = x &&& 248#8 ^^^ 39#8 := by
  sorry

theorem xor_or2_thm (x : _root_.BitVec 8) : 
    x ^^^ 33#8 ||| 7#8 = x &&& 248#8 ^^^ 39#8 := by
  sorry

theorem xor_or_xor_thm (x : _root_.BitVec 8) : 
    (x ^^^ 33#8 ||| 7#8) ^^^ 12#8 = x &&& 248#8 ^^^ 43#8 := by
  sorry

theorem or_xor_or_thm (x : _root_.BitVec 8) : 
...
theorem test23_thm (x : _root_.BitVec 8) : 
