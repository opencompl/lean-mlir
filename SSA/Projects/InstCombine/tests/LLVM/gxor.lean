...
^0(%arg176 : i32):
  ...
  %1 = llvm.xor %0, %arg176 : i32
  %2 = llvm.xor %arg176, %1 : i32
  "llvm.return"(%2) : (i32) -> ()
}
]
...
^0(%arg172 : i32, %arg173 : i32):
  ...
  %2 = llvm.and %arg172, %0 : i32
  %3 = llvm.and %arg173, %1 : i32
  %4 = llvm.xor %2, %3 : i32
  "llvm.return"(%4) : (i32) -> ()
}
]
...
^0(%arg162 : i32, %arg163 : i32):
  %0 = llvm.xor %arg162, %arg163 : i32
  %1 = llvm.xor %0, %arg162 : i32
  "llvm.return"(%1) : (i32) -> ()
}
]
...
^0(%arg151 : i32, %arg152 : i32):
  %0 = "llvm.mlir.constant"() <{value = -1 : i32}> : () -> i32
  %1 = llvm.xor %arg152, %0 : i32
  %2 = llvm.and %1, %arg151 : i32
  %3 = llvm.xor %2, %arg151 : i32
  "llvm.return"(%3) : (i32) -> ()
}
]
...
{
^0(%arg76 : i4, %arg77 : i4, %arg78 : i4):
  %0 = llvm.or %arg78, %arg76 : i4
  %1 = llvm.or %arg78, %arg77 : i4
  %2 = llvm.xor %0, %1 : i4
  "llvm.return"(%2) : (i4) -> ()
}
]
...
^0(%arg76 : i4, %arg77 : i4, %arg78 : i4):
  ...
  %1 = llvm.xor %arg78, %0 : i4
  %2 = llvm.xor %arg76, %arg77 : i4
  %3 = llvm.and %2, %1 : i4
  "llvm.return"(%3) : (i4) -> ()
}
]
...
{
^0(%arg73 : i4, %arg74 : i4, %arg75 : i4):
  %0 = llvm.or %arg73, %arg75 : i4
  %1 = llvm.or %arg75, %arg74 : i4
  %2 = llvm.xor %0, %1 : i4
  "llvm.return"(%2) : (i4) -> ()
}
]
...
^0(%arg73 : i4, %arg74 : i4, %arg75 : i4):
  %0 = "llvm.mlir.constant"() <{value = -1 : i4}> : () -> i4
  %1 = llvm.xor %arg75, %0 : i4
  %2 = llvm.xor %arg73, %arg74 : i4
  %3 = llvm.and %2, %1 : i4
  "llvm.return"(%3) : (i4) -> ()
}
]
...
{
^0(%arg70 : i4, %arg71 : i4, %arg72 : i4):
  %0 = llvm.or %arg72, %arg70 : i4
  %1 = llvm.or %arg71, %arg72 : i4
  %2 = llvm.xor %0, %1 : i4
  "llvm.return"(%2) : (i4) -> ()
}
]
...
^0(%arg70 : i4, %arg71 : i4, %arg72 : i4):
  %0 = "llvm.mlir.constant"() <{value = -1 : i4}> : () -> i4
  %1 = llvm.xor %arg72, %0 : i4
  %2 = llvm.xor %arg70, %arg71 : i4
  %3 = llvm.and %2, %1 : i4
  "llvm.return"(%3) : (i4) -> ()
}
]
...
^0(%arg57 : i32, %arg58 : i32):
  ...
  %2 = llvm.xor %arg57, %0 : i32
  %3 = llvm.add %2, %arg58 : i32
  %4 = llvm.shl %3, %1 : i32
  "llvm.return"(%4) : (i32) -> ()
}
]
...
^0(%arg10 : i32):
  ...
  %2 = llvm.ashr %0, %arg10 : i32
  %3 = llvm.lshr %1, %arg10 : i32
  %4 = llvm.xor %2, %3 : i32
  "llvm.return"(%4) : (i32) -> ()
}
]
...
^0(%arg9 : i32):
  %0 = "llvm.mlir.constant"() <{value = -3 : i32}> : () -> i32
  %1 = "llvm.mlir.constant"() <{value = 5 : i32}> : () -> i32
  %2 = llvm.ashr %0, %arg9 : i32
  %3 = llvm.lshr %1, %arg9 : i32
  %4 = llvm.xor %3, %2 : i32
  "llvm.return"(%4) : (i32) -> ()
}
]
...
^0(%arg6 : i32):
  %0 = "llvm.mlir.constant"() <{value = -3 : i32}> : () -> i32
  %1 = "llvm.mlir.constant"() <{value = -5 : i32}> : () -> i32
  %2 = llvm.ashr %0, %arg6 : i32
  %3 = llvm.ashr %1, %arg6 : i32
  %4 = llvm.xor %2, %3 : i32
  "llvm.return"(%4) : (i32) -> ()
}
]
...
{
^0(%arg3 : i4, %arg4 : i4, %arg5 : i4):
  %0 = "llvm.mlir.constant"() <{value = -1 : i4}> : () -> i4
  %1 = llvm.and %arg5, %arg3 : i4
  %2 = llvm.xor %arg5, %0 : i4
  %3 = llvm.and %2, %arg4 : i4
  %4 = llvm.xor %1, %3 : i4
  "llvm.return"(%4) : (i4) -> ()
}
]
