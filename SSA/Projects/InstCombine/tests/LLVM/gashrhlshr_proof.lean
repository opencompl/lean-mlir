...
theorem lshr_mul_times_3_div_2_exact_2_thm (x : BitVec 32) :
  ((if twoPow 64 31 <<< 1 ≤ setWidth 64 x * 3#64 then none else some (x * 3#32)).bind fun a => some (a >>> 1)) ⊑
...
theorem lshr_mul_times_5_div_4_exact_2_thm (x : BitVec 32) :
  ((if twoPow 64 31 <<< 1 ≤ setWidth 64 x * 5#64 then none else some (x * 5#32)).bind fun a => some (a >>> 2)) ⊑
