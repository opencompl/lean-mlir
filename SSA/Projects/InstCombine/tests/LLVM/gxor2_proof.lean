...
theorem test7_thm (x x_1 : BitVec 32) : (x_1 ||| x) ^^^ (x_1 ^^^ 4294967295#32) = x ^^^ 4294967295#32 ||| x_1 := sorry

theorem test8_thm (x x_1 : BitVec 32) : x_1 ^^^ 4294967295#32 ^^^ (x_1 ||| x) = x ^^^ 4294967295#32 ||| x_1 := sorry
...
theorem test11e_thm (x x_1 x_2 : BitVec 32) :
  (x_2 * x_1 ^^^ x) &&& (x_2 * x_1 ^^^ (x ^^^ 4294967295#32)) =
    (x_2 * x_1 ^^^ x) &&& (x_2 * x_1 ^^^ x ^^^ 4294967295#32) := sorry
