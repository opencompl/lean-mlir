...
theorem positive_sameconst_thm (x : BitVec 8) : x >>> 3 <<< 3 = x &&& 248#8 := sorry
...
theorem positive_sameconst_shlnuw_thm (x : BitVec 8) : x >>> 3 <<< 3 = x &&& 248#8 := sorry
...
theorem positive_sameconst_shlnsw_thm (x : BitVec 8) : x >>> 3 <<< 3 = x &&& 248#8 := sorry
...
theorem positive_sameconst_shlnuwnsw_thm (x : BitVec 8) : x >>> 3 <<< 3 = x &&& 248#8 := sorry
...
theorem positive_sameconst_lshrexact_thm (x : BitVec 8) : x >>> 3 <<< 3 = x := sorry
...
theorem positive_sameconst_shlnsw_lshrexact_thm (x : BitVec 8) : x >>> 3 <<< 3 = x := sorry
...
theorem positive_sameconst_shlnuw_lshrexact_thm (x : BitVec 8) : x >>> 3 <<< 3 = x := sorry
...
theorem positive_sameconst_shlnuwnsw_lshrexact_thm (x : BitVec 8) : x >>> 3 <<< 3 = x := sorry
