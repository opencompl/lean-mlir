...
theorem test1_thm (e✝ e✝¹ : IntW 447) :
  LLVM.xor (LLVM.and e✝¹ (const? 70368744177664)) (LLVM.and e✝ (const? 70368744177663)) ⊑
    LLVM.or (LLVM.and e✝¹ (const? 70368744177664)) (LLVM.and e✝ (const? 70368744177663)) := by 
    simp_alive_undef
    simp_alive_ops
