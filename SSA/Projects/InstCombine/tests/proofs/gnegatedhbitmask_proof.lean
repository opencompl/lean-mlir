...
theorem sub_mask1_trunc_lshr_thm :
  ∀ (e : IntW 64),
...
theorem sub_sext_mask1_trunc_lshr_thm :
  ∀ (e : IntW 64),
...
theorem sub_zext_trunc_lshr_thm :
  ∀ (e : IntW 64),
...
theorem neg_signbit_thm :
  ∀ (e : IntW 8), sub (const? 0) (zext 32 (lshr e (const? 7))) ⊑ sext 32 (ashr e (const? 7)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
