...
theorem udiv_i8_thm (e✝ e✝¹ : IntW 8) : trunc 8 (LLVM.udiv (zext 32 e✝¹) (zext 32 e✝)) ⊑ LLVM.udiv e✝¹ e✝ := by 
    simp_alive_undef
    simp_alive_ops
...
theorem urem_i8_thm (e✝ e✝¹ : IntW 8) : trunc 8 (urem (zext 32 e✝¹) (zext 32 e✝)) ⊑ urem e✝¹ e✝ := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem udiv_i32_thm (e✝ e✝¹ : IntW 8) : LLVM.udiv (zext 32 e✝¹) (zext 32 e✝) ⊑ zext 32 (LLVM.udiv e✝¹ e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem udiv_i32_multiuse_thm (e✝ e✝¹ : IntW 8) :
  mul (LLVM.udiv (zext 32 e✝¹) (zext 32 e✝)) (add (zext 32 e✝¹) (zext 32 e✝)) ⊑
    mul (LLVM.udiv (zext 32 e✝¹) (zext 32 e✝)) (add (zext 32 e✝¹) (zext 32 e✝) { «nsw» := true, «nuw» := true })
...
theorem udiv_illegal_type_thm (e✝ e✝¹ : IntW 9) : LLVM.udiv (zext 32 e✝¹) (zext 32 e✝) ⊑ zext 32 (LLVM.udiv e✝¹ e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem urem_i32_thm (e✝ e✝¹ : IntW 8) : urem (zext 32 e✝¹) (zext 32 e✝) ⊑ zext 32 (urem e✝¹ e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem urem_i32_multiuse_thm (e✝ e✝¹ : IntW 8) :
  mul (urem (zext 32 e✝¹) (zext 32 e✝)) (add (zext 32 e✝¹) (zext 32 e✝)) ⊑
    mul (urem (zext 32 e✝¹) (zext 32 e✝)) (add (zext 32 e✝¹) (zext 32 e✝) { «nsw» := true, «nuw» := true })
      { «nsw» := true, «nuw» := true } := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
...
theorem urem_illegal_type_thm (e✝ e✝¹ : IntW 9) : urem (zext 32 e✝¹) (zext 32 e✝) ⊑ zext 32 (urem e✝¹ e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
