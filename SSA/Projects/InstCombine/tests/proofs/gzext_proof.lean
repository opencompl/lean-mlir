...
theorem fold_xor_zext_sandwich_thm (e✝ : IntW 1) :
  zext 64 (LLVM.xor (zext 32 e✝) (const? 1)) ⊑ zext 64 (LLVM.xor e✝ (const? 1)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem zext_nneg_flag_drop_thm (e✝ : IntW 16) (e✝¹ : IntW 8) :
  LLVM.or (LLVM.or (zext 16 (LLVM.and e✝¹ (const? 127))) e✝) (const? 128) ⊑
    LLVM.or (LLVM.or e✝ (zext 16 e✝¹)) (const? 128) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
