...
theorem bool_zext_thm (x : BitVec 1) : signExtend 16 x >>> 15 = setWidth 16 x := by bv_compare'

theorem smear_sign_and_widen_thm (x : BitVec 8) : signExtend 32 x >>> 24 = setWidth 32 (x.sshiftRight 7) := by bv_compare'

theorem fake_sext_thm (x : BitVec 3) : signExtend 18 x >>> 17 = setWidth 18 (x >>> 2) := by bv_compare'
...
theorem trunc_sandwich_thm (x : BitVec 32) : setWidth 12 (x >>> 28) >>> 2 = setWidth 12 (x >>> 30) := by bv_compare'

theorem trunc_sandwich_min_shift1_thm (x : BitVec 32) : setWidth 12 (x >>> 20) >>> 1 = setWidth 12 (x >>> 21) := by bv_compare'

theorem trunc_sandwich_small_shift1_thm (x : BitVec 32) : setWidth 12 (x >>> 19) >>> 1 = setWidth 12 (x >>> 20) &&& 2047#12 := by bv_compare'

theorem trunc_sandwich_max_sum_shift_thm (x : BitVec 32) : setWidth 12 (x >>> 20) >>> 11 = setWidth 12 (x >>> 31) := by bv_compare'

theorem trunc_sandwich_max_sum_shift2_thm (x : BitVec 32) : setWidth 12 (x >>> 30) >>> 1 = setWidth 12 (x >>> 31) := by bv_compare'

theorem trunc_sandwich_big_sum_shift1_thm (x : BitVec 32) : setWidth 12 (x >>> 21) >>> 11 = 0#12 := by bv_compare'

theorem trunc_sandwich_big_sum_shift2_thm (x : BitVec 32) : setWidth 12 (x >>> 31) >>> 1 = 0#12 := by bv_compare'
...
theorem lshr_sext_i1_to_i16_thm (x : BitVec 1) :
  some (signExtend 16 x >>> 4) ⊑
    ...
    | some { toFin := ⟨0, ⋯⟩ } => some 0#16 := by bv_compare'
...
theorem lshr_sext_i1_to_i128_thm (x : BitVec 1) :
  some (signExtend 128 x >>> 42) ⊑
    ...
    | some { toFin := ⟨0, ⋯⟩ } => some 0#128 := by bv_compare'

theorem bool_add_lshr_thm (x x_1 : BitVec 1) :
  (setWidth 2 x_1 + setWidth 2 x) >>> 1 = setWidth 2 x_1 &&& setWidth 2 x := by bv_compare'
...
theorem bool_add_ashr_thm (x x_1 : BitVec 1) :
  some ((setWidth 2 x_1 + setWidth 2 x).sshiftRight 1) ⊑
    (if setWidth 2 x_1 + setWidth 2 x < setWidth 2 x_1 ∨ setWidth 2 x_1 + setWidth 2 x < setWidth 2 x then none
      ...
      fun x' => some (x'.sshiftRight 1) := by bv_compare'
