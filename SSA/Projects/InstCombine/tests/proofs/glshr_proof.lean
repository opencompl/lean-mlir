...
theorem mul_splat_fold_thm :
  ∀ (e : IntW 32), lshr (mul e (const? 65537) { «nsw» := false, «nuw» := true }) (const? 16) ⊑ e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem shl_add_lshr_flag_preservation_thm :
  ∀ (e e_1 e_2 : IntW 32),
...
theorem shl_sub_lshr_reverse_thm :
  ∀ (e e_1 e_2 : IntW 32),
...
theorem shl_sub_lshr_reverse_no_nsw_thm :
  ∀ (e e_1 e_2 : IntW 32),
...
theorem shl_sub_lshr_reverse_nsw_on_op1_thm :
  ∀ (e e_1 e_2 : IntW 32),
...
theorem shl_or_disjoint_lshr_thm :
  ∀ (e e_1 e_2 : IntW 32),
    lshr (LLVM.or (shl e_2 e_1 { «nsw» := false, «nuw» := true }) e) e_1 ⊑ LLVM.or (lshr e e_1) e_2 := by 
    simp_alive_undef
    simp_alive_ops
...
theorem shl_lshr_and_exact_thm :
  ∀ (e e_1 e_2 : IntW 32),
    lshr (LLVM.and (shl e_2 e_1 { «nsw» := false, «nuw» := true }) e) e_1 ⊑ LLVM.and (lshr e e_1) e_2 := by 
    simp_alive_undef
    simp_alive_ops
...
theorem mul_splat_fold_no_nuw_thm :
  ∀ (e : IntW 32),
...
theorem mul_splat_fold_too_narrow_thm :
  ∀ (e : IntW 2), lshr (mul e (const? (-2)) { «nsw» := false, «nuw» := true }) (const? 1) ⊑ e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_sandwich_thm :
  ∀ (e : IntW 32), lshr (trunc 12 (lshr e (const? 28))) (const? 2) ⊑ trunc 12 (lshr e (const? 30)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_sandwich_min_shift1_thm :
  ∀ (e : IntW 32), lshr (trunc 12 (lshr e (const? 20))) (const? 1) ⊑ trunc 12 (lshr e (const? 21)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_sandwich_small_shift1_thm :
  ∀ (e : IntW 32),
...
theorem trunc_sandwich_max_sum_shift_thm :
  ∀ (e : IntW 32), lshr (trunc 12 (lshr e (const? 20))) (const? 11) ⊑ trunc 12 (lshr e (const? 31)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_sandwich_max_sum_shift2_thm :
  ∀ (e : IntW 32), lshr (trunc 12 (lshr e (const? 30))) (const? 1) ⊑ trunc 12 (lshr e (const? 31)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lshr_sext_i1_to_i128_thm :
  ∀ (e : IntW 1), lshr (sext 128 e) (const? 42) ⊑ select e (const? 77371252455336267181195263) (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
