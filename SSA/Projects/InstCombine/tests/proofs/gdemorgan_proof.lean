...
theorem demorgan_or_apint1_thm :
  ∀ (e e_1 : IntW 43),
...
theorem demorgan_or_apint2_thm :
  ∀ (e e_1 : IntW 129),
    LLVM.or (LLVM.xor e_1 (const? (-1))) (LLVM.xor e (const? (-1))) ⊑ LLVM.xor (LLVM.and e_1 e) (const? (-1)) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem demorgan_and_apint1_thm :
  ∀ (e e_1 : IntW 477),
...
theorem demorgan_and_apint2_thm :
  ∀ (e e_1 : IntW 129),
    LLVM.and (LLVM.xor e_1 (const? (-1))) (LLVM.xor e (const? (-1))) ⊑ LLVM.xor (LLVM.or e_1 e) (const? (-1)) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem demorgan_and_apint3_thm :
  ∀ (e e_1 : IntW 65),
...
theorem demorgan_and_apint4_thm :
  ∀ (e e_1 : IntW 66),
    LLVM.and (LLVM.xor e_1 (const? (-1))) (LLVM.xor e (const? (-1))) ⊑ LLVM.xor (LLVM.or e_1 e) (const? (-1)) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem demorgan_and_apint5_thm :
  ∀ (e e_1 : IntW 47),
    LLVM.and (LLVM.xor e_1 (const? (-1))) (LLVM.xor e (const? (-1))) ⊑ LLVM.xor (LLVM.or e_1 e) (const? (-1)) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem test4_apint_thm :
  ∀ (e : IntW 61), LLVM.and (LLVM.xor e (const? (-1))) (const? 5) ⊑ LLVM.xor (LLVM.and e (const? 5)) (const? 5) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem demorgan_nand_apint1_thm :
  ∀ (e e_1 : IntW 7),
    LLVM.xor (LLVM.and (LLVM.xor e_1 (const? (-1))) e) (const? (-1)) ⊑ LLVM.or e_1 (LLVM.xor e (const? (-1))) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem demorgan_nand_apint2_thm :
  ∀ (e e_1 : IntW 117),
    LLVM.xor (LLVM.and (LLVM.xor e_1 (const? (-1))) e) (const? (-1)) ⊑ LLVM.or e_1 (LLVM.xor e (const? (-1))) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem demorgan_nor_use2a_thm :
  ∀ (e e_1 : IntW 8),
...
theorem demorgan_nor_use2b_thm :
  ∀ (e e_1 : IntW 8),
...
theorem demorgan_nor_use2c_thm :
  ∀ (e e_1 : IntW 8),
    LLVM.sdiv (LLVM.xor (LLVM.or (LLVM.xor e_1 (const? (-1))) e) (const? (-1)))
...
theorem demorgan_nor_use2ab_thm :
  ∀ (e e_1 : IntW 8),
...
theorem demorgan_nor_use2ac_thm :
  ∀ (e e_1 : IntW 8),
    LLVM.sdiv
        (LLVM.sdiv (LLVM.xor (LLVM.or (LLVM.xor e_1 (const? (-1))) e) (const? (-1)))
          (mul (LLVM.or (LLVM.xor e_1 (const? (-1))) e) (const? 23)))
...
theorem demorgan_nor_use2bc_thm :
  ∀ (e e_1 : IntW 8),
    LLVM.sdiv
        (LLVM.sdiv (LLVM.xor (LLVM.or (LLVM.xor e_1 (const? (-1))) e) (const? (-1)))
          (mul (LLVM.or (LLVM.xor e_1 (const? (-1))) e) (const? 23)))
...
theorem demorganize_constant2_thm :
  ∀ (e : IntW 32),
...
theorem demorgan_plus_and_to_xor_thm :
  ∀ (e e_1 : IntW 32),
