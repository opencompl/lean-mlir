...
^0(%arg31 : i16):
  ...
  %1 = "llvm.mlir.constant"() <{value = 512 : i16}> : () -> i16
...
^0(%arg23 : i16, %arg24 : i16):
  ...
  %1 = "llvm.mlir.constant"() <{value = -16385 : i16}> : () -> i16
...
^0(%arg19 : i16, %arg20 : i16):
  %0 = "llvm.mlir.constant"() <{value = -21845 : i16}> : () -> i16
  %1 = "llvm.mlir.constant"() <{value = 21843 : i16}> : () -> i16
...
^0(%arg15 : i16, %arg16 : i16):
  %0 = "llvm.mlir.constant"() <{value = -21845 : i16}> : () -> i16
  %1 = "llvm.mlir.constant"() <{value = -10923 : i16}> : () -> i16
