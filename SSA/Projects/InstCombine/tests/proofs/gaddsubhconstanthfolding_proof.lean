...
theorem add_nsw_const_const_sub_nsw_thm :
  ∀ (e : IntW 8),
...
theorem add_nsw_const_const_sub_thm :
  ∀ (e : IntW 8),
...
theorem add_const_const_sub_nsw_thm :
  ∀ (e : IntW 8),
    sub (const? (-127)) (add e (const? 1)) { «nsw» := true, «nuw» := false } ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
...
theorem add_nsw_const_const_sub_nsw_ov_thm :
  ∀ (e : IntW 8),
...
theorem add_nuw_const_const_sub_nuw_thm :
  ∀ (e : IntW 8),
...
theorem add_nuw_const_const_sub_thm :
  ∀ (e : IntW 8),
...
theorem add_const_const_sub_nuw_thm :
  ∀ (e : IntW 8),
    sub (const? (-127)) (add e (const? 1)) { «nsw» := false, «nuw» := true } ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
...
theorem addsub_combine_constants_thm :
  ∀ (e e_1 : IntW 7),
    add (add e_1 (const? 42)) (sub (const? 10) e) { «nsw» := true, «nuw» := false } ⊑
      add (sub e_1 e) (const? 52) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
