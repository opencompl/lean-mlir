...
theorem addsub_combine_constants_thm (e✝ e✝¹ : IntW 7) :
  add (add e✝¹ (const? 42)) (sub (const? 10) e✝) { «nsw» := true, «nuw» := false } ⊑
    add (sub e✝¹ e✝) (const? 52) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem sub_from_constant_thm (e✝ e✝¹ : IntW 5) : add (sub (const? 10) e✝¹) e✝ ⊑ add (sub e✝ e✝¹) (const? 10) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem sub_from_constant_commute_thm (e✝ e✝¹ : IntW 5) :
  add (mul e✝¹ e✝¹) (sub (const? 10) e✝ { «nsw» := true, «nuw» := false }) { «nsw» := true, «nuw» := false } ⊑
    add (sub (mul e✝¹ e✝¹) e✝) (const? 10) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
