...
theorem add_nsw_const_const_sub_nsw_thm : ∀ (e : IntW 8), sub (const? (-127)) (add e (const? 1)) ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_nsw_const_const_sub_thm : ∀ (e : IntW 8), sub (const? (-127)) (add e (const? 1)) ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_const_const_sub_nsw_thm : ∀ (e : IntW 8), sub (const? (-127)) (add e (const? 1)) ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_nsw_const_const_sub_nsw_ov_thm : ∀ (e : IntW 8), sub (const? (-127)) (add e (const? 2)) ⊑ sub (const? 127) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_nuw_const_const_sub_nuw_thm : ∀ (e : IntW 8), sub (const? (-127)) (add e (const? 1)) ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_nuw_const_const_sub_thm : ∀ (e : IntW 8), sub (const? (-127)) (add e (const? 1)) ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_const_const_sub_nuw_thm : ∀ (e : IntW 8), sub (const? (-127)) (add e (const? 1)) ⊑ sub (const? (-128)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem addsub_combine_constants_thm :
  ∀ (e e_1 : IntW 7), add (add e_1 (const? 42)) (sub (const? 10) e) ⊑ add (sub e_1 e) (const? 52) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem sub_from_constant_commute_thm :
  ∀ (e e_1 : IntW 5), add (mul e_1 e_1) (sub (const? 10) e) ⊑ add (sub (mul e_1 e_1) e) (const? 10) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
