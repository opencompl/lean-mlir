...
theorem xor_logic_and_logic_or1_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem xor_logic_and_logic_or2_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem xor_logic_and_logic_or4_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem xor_and_or_thm :
  ∀ (e e_1 e_2 : IntW 1), LLVM.xor (LLVM.and e_2 e_1) (LLVM.or e e_2) ⊑ select e_2 (LLVM.xor e_1 (const? 1)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
