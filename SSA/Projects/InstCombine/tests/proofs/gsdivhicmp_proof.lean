...
theorem sdiv_exact_eq_0_thm (e e_1 : IntW 8) :
  icmp IntPredicate.eq (LLVM.sdiv e_1 e) (const? 8 0) ⊑ icmp IntPredicate.eq e_1 (const? 8 0) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem udiv_exact_ne_0_thm (e e_1 : IntW 8) :
  icmp IntPredicate.ne (LLVM.udiv e_1 e) (const? 8 0) ⊑ icmp IntPredicate.ne e_1 (const? 8 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem udiv_exact_eq_1_thm (e e_1 : IntW 8) :
  icmp IntPredicate.ne (LLVM.udiv e_1 e) (const? 8 1) ⊑ icmp IntPredicate.ne e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem sdiv_exact_eq_9_no_of_thm (e e_1 : IntW 8) :
  icmp IntPredicate.eq (LLVM.sdiv e_1 (LLVM.and e (const? 8 7))) (const? 8 9) ⊑
...
theorem udiv_exact_ne_30_no_of_thm (e e_1 : IntW 8) :
  icmp IntPredicate.ne (LLVM.udiv e_1 (LLVM.and e (const? 8 7))) (const? 8 30) ⊑
