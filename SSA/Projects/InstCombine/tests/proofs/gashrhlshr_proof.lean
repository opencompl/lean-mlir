...
theorem ashr_lshr_exact_ashr_only_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.sgt e_1 (const? (-1))) (lshr e_1 e) (ashr e_1 e) ⊑ ashr e_1 e := by 
    simp_alive_undef
    simp_alive_ops
...
theorem ashr_lshr2_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.sgt e_1 (const? 5)) (lshr e_1 e) (ashr e_1 e) ⊑ ashr e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_cst_thm (e : IntW 32) :
  select (icmp IntPredicate.slt e (const? 1)) (ashr e (const? 8)) (lshr e (const? 8)) ⊑ ashr e (const? 8) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_cst2_thm (e : IntW 32) :
  select (icmp IntPredicate.sgt e (const? (-1))) (lshr e (const? 8)) (ashr e (const? 8)) ⊑ ashr e (const? 8) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_inv_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.slt e_1 (const? 1)) (ashr e_1 e) (lshr e_1 e) ⊑ ashr e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_inv2_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.slt e_1 (const? 7)) (ashr e_1 e) (lshr e_1 e) ⊑ ashr e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_wrong_cond_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.sge e_1 (const? (-1))) (lshr e_1 e) (ashr e_1 e) ⊑
    select (icmp IntPredicate.sgt e_1 (const? (-2))) (lshr e_1 e) (ashr e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_shift_wrong_pred_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.sle e_1 (const? 0)) (lshr e_1 e) (ashr e_1 e) ⊑
    select (icmp IntPredicate.slt e_1 (const? 1)) (lshr e_1 e) (ashr e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_shift_wrong_pred2_thm (e e_1 e_2 : IntW 32) :
  select (icmp IntPredicate.sge e_2 (const? 0)) (lshr e_1 e) (ashr e_1 e) ⊑
    select (icmp IntPredicate.slt e_2 (const? 0)) (ashr e_1 e) (lshr e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_wrong_operands_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.sge e_1 (const? 0)) (ashr e_1 e) (lshr e_1 e) ⊑
    select (icmp IntPredicate.slt e_1 (const? 0)) (lshr e_1 e) (ashr e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_no_ashr_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.sge e_1 (const? 0)) (lshr e_1 e) (LLVM.xor e_1 e) ⊑
    select (icmp IntPredicate.slt e_1 (const? 0)) (LLVM.xor e_1 e) (lshr e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_shift_amt_mismatch_thm (e e_1 e_2 : IntW 32) :
  select (icmp IntPredicate.sge e_2 (const? 0)) (lshr e_2 e_1) (ashr e_2 e) ⊑
    select (icmp IntPredicate.slt e_2 (const? 0)) (ashr e_2 e) (lshr e_2 e_1) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_shift_base_mismatch_thm (e e_1 e_2 : IntW 32) :
  select (icmp IntPredicate.sge e_2 (const? 0)) (lshr e_2 e_1) (ashr e e_1) ⊑
    select (icmp IntPredicate.slt e_2 (const? 0)) (ashr e e_1) (lshr e_2 e_1) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_lshr_no_lshr_thm (e e_1 : IntW 32) :
  select (icmp IntPredicate.sge e_1 (const? 0)) (add e_1 e) (ashr e_1 e) ⊑
    select (icmp IntPredicate.slt e_1 (const? 0)) (ashr e_1 e) (add e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lshr_sub_nsw_thm (e e_1 : IntW 32) :
  lshr (sub e_1 e { «nsw» := true, «nuw» := false }) (const? 31) ⊑ zext 32 (icmp IntPredicate.slt e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_sub_nsw_thm (e e_1 : IntW 17) :
  ashr (sub e_1 e { «nsw» := true, «nuw» := false }) (const? 16) ⊑ sext 17 (icmp IntPredicate.slt e_1 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_known_pos_exact_thm (e e_1 : IntW 8) : ashr (LLVM.and e_1 (const? 127)) e ⊑ lshr (LLVM.and e_1 (const? 127)) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lsb_mask_sign_zext_thm (e : IntW 32) :
  lshr (LLVM.and (add e (const? (-1))) (LLVM.xor e (const? (-1)))) (const? 31) ⊑
    zext 32 (icmp IntPredicate.eq e (const? 0)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lsb_mask_sign_zext_commuted_thm (e : IntW 32) :
  lshr (LLVM.and (LLVM.xor e (const? (-1))) (add e (const? (-1)))) (const? 31) ⊑
    zext 32 (icmp IntPredicate.eq e (const? 0)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
...
theorem lsb_mask_sign_sext_thm (e : IntW 32) :
  ashr (LLVM.and (add e (const? (-1))) (LLVM.xor e (const? (-1)))) (const? 31) ⊑
...
theorem lsb_mask_sign_sext_commuted_thm (e : IntW 32) :
  ashr (LLVM.and (LLVM.xor e (const? (-1))) (add e (const? (-1)))) (const? 31) ⊑
    sext 32 (icmp IntPredicate.eq e (const? 0)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
