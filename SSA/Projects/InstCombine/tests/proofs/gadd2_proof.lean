...
theorem test1_thm (e : IntW 64) (e_1 : IntW 32) :
  LLVM.and (add (shl (zext 64 e_1) (const? 32)) e) (const? 123) ⊑ LLVM.and e (const? 123) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem test3_thm (e : IntW 32) :
  add (LLVM.and e (const? 128)) (lshr e (const? 30)) ⊑ LLVM.or (LLVM.and e (const? 128)) (lshr e (const? 30)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test10_thm (e e_1 : IntW 32) :
  add (add e_1 (const? 1)) (LLVM.xor (LLVM.or (ashr e (const? 3)) (const? (-1431655766))) (const? 1431655765)) ⊑
    sub e_1 (LLVM.and (ashr e (const? 3)) (const? 1431655765)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test11_thm (e e_1 : IntW 32) :
  add (add e_1 (const? 1)) (LLVM.xor (LLVM.or e (const? (-1431655766))) (const? 1431655765)) ⊑
    sub e_1 (LLVM.and e (const? 1431655765)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test13_thm (e e_1 : IntW 32) :
  add (add e_1 (const? 1)) (LLVM.xor (LLVM.or e (const? (-1431655767))) (const? 1431655766)) ⊑
    sub e_1 (LLVM.and e (const? 1431655766)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test15_thm (e e_1 : IntW 32) :
  add (add e_1 (const? 1)) (LLVM.xor (LLVM.and e (const? (-1431655767))) (const? (-1431655767))) ⊑
    sub e_1 (LLVM.or e (const? 1431655766)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test17_thm (e e_1 : IntW 32) :
  add (LLVM.xor (LLVM.and e_1 (const? (-1431655766))) (const? (-1431655765))) e { «nsw» := true, «nuw» := false } ⊑
    sub e (LLVM.or e_1 (const? 1431655765)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test18_thm (e e_1 : IntW 32) :
  add (add e_1 (const? 1) { «nsw» := true, «nuw» := false })
    ...
    sub e_1 (LLVM.or e (const? 1431655765)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem mul_add_to_mul_6_thm (e e_1 : IntW 32) :
  add (mul e_1 e { «nsw» := true, «nuw» := false })
      ...
      { «nsw» := true, «nuw» := false } ⊑
    mul (mul e_1 e { «nsw» := true, «nuw» := false }) (const? 6) { «nsw» := true, «nuw» := false } := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem mul_add_to_mul_8_thm (e : IntW 16) :
  add (mul e (const? 16383) { «nsw» := true, «nuw» := false }) (mul e (const? 16384) { «nsw» := true, «nuw» := false })
      { «nsw» := true, «nuw» := false } ⊑
...
theorem mul_add_to_mul_9_thm (e : IntW 16) :
  add (mul e (const? 16384) { «nsw» := true, «nuw» := false }) (mul e (const? 16384) { «nsw» := true, «nuw» := false })
      { «nsw» := true, «nuw» := false } ⊑
    shl e (const? 15) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem add_of_selects_thm (e : IntW 32) (e_1 : IntW 1) :
  add (select e_1 (const? 0) (const? (-2))) (select e_1 e (const? 2)) ⊑ select e_1 e (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
