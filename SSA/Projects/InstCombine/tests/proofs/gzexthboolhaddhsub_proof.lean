...
theorem PR30273_three_bools_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select e_2
...
theorem sext_sub_nuw_thm :
  ∀ (e : IntW 1) (e_1 : IntW 8), sub e_1 (sext 8 e) { «nsw» := false, «nuw» := true } ⊑ add e_1 (zext 8 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem sextbool_add_commute_thm :
