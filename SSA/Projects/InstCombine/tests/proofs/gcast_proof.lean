...
theorem test84_thm (e : IntW 32) :
  trunc 8 (lshr (add e (const? 32 (-16777216)) { «nsw» := true, «nuw» := false }) (const? 32 23)) ⊑
...
theorem test85_thm (e : IntW 32) :
  trunc 8 (lshr (add e (const? 32 (-16777216)) { «nsw» := false, «nuw» := true }) (const? 32 23)) ⊑
    trunc 8 (lshr (add e (const? 32 2130706432)) (const? 32 23)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
...
theorem PR23309_thm (e e_1 : IntW 32) :
  trunc 1 (sub (add e_1 (const? 32 (-4))) e { «nsw» := true, «nuw» := false }) ⊑
    icmp IntPredicate.ne (LLVM.and (sub e_1 e) (const? 32 1)) (const? 32 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem PR23309v2_thm (e e_1 : IntW 32) :
  trunc 1 (add (add e_1 (const? 32 (-4))) e { «nsw» := false, «nuw» := true }) ⊑
    icmp IntPredicate.ne (LLVM.and (add e_1 e) (const? 32 1)) (const? 32 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem trunc_lshr_sext_exact_thm (e : IntW 8) : trunc 8 (lshr (sext 32 e) (const? 32 6)) ⊑ ashr e (const? 8 6) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem trunc_lshr_sext_wide_input_exact_thm (e : IntW 16) : trunc 8 (lshr (sext 32 e) (const? 32 9)) ⊑ trunc 8 (ashr e (const? 16 9)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem trunc_lshr_zext_exact_thm (e : IntW 8) : trunc 8 (lshr (zext 32 e) (const? 32 6)) ⊑ lshr e (const? 8 6) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
