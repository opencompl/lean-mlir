...
theorem logic_and_logic_or_1_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_and_logic_or_2_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_and_logic_or_3_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_and_logic_or_4_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_and_logic_or_5_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 e_1 (const? 0)) (const? 1) (select e_2 e (const? 0)) ⊑
      select e_2 (select e_1 (const? 1) e) (const? 0) := by 
    simp_alive_undef
...
theorem logic_and_logic_or_6_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 e_1 (const? 0)) (const? 1) (select e e_2 (const? 0)) ⊑
      select e_2 (select e_1 (const? 1) e) (const? 0) := by 
    simp_alive_undef
...
theorem logic_and_logic_or_7_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 e_1 (const? 0)) (const? 1) (select e e_1 (const? 0)) ⊑
      select (select e_2 (const? 1) e) e_1 (const? 0) := by 
    simp_alive_undef
...
theorem logic_and_logic_or_8_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 e_1 (const? 0)) (const? 1) (select e_1 e (const? 0)) ⊑
      select e_1 (select e_2 (const? 1) e) (const? 0) := by 
    simp_alive_undef
...
theorem and_logic_and_logic_or_1_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_logic_and_logic_or_2_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_logic_and_logic_or_3_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_logic_and_logic_or_4_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_logic_and_logic_or_5_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_logic_and_logic_or_6_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_logic_and_logic_or_7_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_logic_and_logic_or_8_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_and_logic_or_1_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem and_and_logic_or_2_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_or_logic_and_1_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_or_logic_and_2_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_or_logic_and_3_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_or_logic_and_4_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem logic_or_logic_and_5_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 (const? 1) e_1) (select e_2 (const? 1) e) (const? 0) ⊑
      select e_2 (const? 1) (select e_1 e (const? 0)) := by 
    simp_alive_undef
...
theorem logic_or_logic_and_6_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 (const? 1) e_1) (select e (const? 1) e_2) (const? 0) ⊑
      select e_2 (const? 1) (select e_1 e (const? 0)) := by 
    simp_alive_undef
...
theorem logic_or_logic_and_7_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 (const? 1) e_1) (select e (const? 1) e_1) (const? 0) ⊑
      select (select e_2 e (const? 0)) (const? 1) e_1 := by 
    simp_alive_undef
...
theorem logic_or_logic_and_8_thm :
  ∀ (e e_1 e_2 : IntW 1),
    select (select e_2 (const? 1) e_1) (select e_1 (const? 1) e) (const? 0) ⊑
      select e_1 (const? 1) (select e_2 e (const? 0)) := by 
    simp_alive_undef
...
theorem or_logic_or_logic_and_1_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem or_logic_or_logic_and_2_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem or_logic_or_logic_and_3_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem or_logic_or_logic_and_4_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem or_logic_or_logic_and_5_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem or_logic_or_logic_and_6_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem or_logic_or_logic_and_7_thm :
  ∀ (e e_1 e_2 : IntW 1),
...
theorem or_logic_or_logic_and_8_thm :
  ∀ (e e_1 e_2 : IntW 1),
