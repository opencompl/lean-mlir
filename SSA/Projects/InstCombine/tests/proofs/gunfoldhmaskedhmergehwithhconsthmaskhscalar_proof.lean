...
theorem in_constant_varx_mone_thm :
  ∀ (e : IntW 4),
...
theorem in_constant_varx_14_thm :
  ∀ (e : IntW 4),
...
theorem in_constant_mone_vary_thm :
  ∀ (e : IntW 4), LLVM.xor (LLVM.and (LLVM.xor e (const? (-1))) (const? 1)) e ⊑ LLVM.or e (const? 1) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem in_constant_14_vary_thm :
  ∀ (e : IntW 4), LLVM.xor (LLVM.and (LLVM.xor e (const? (-2))) (const? 1)) e ⊑ LLVM.and e (const? (-2)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem commutativity_constant_14_vary_thm :
  ∀ (e : IntW 4), LLVM.xor e (LLVM.and (LLVM.xor e (const? (-2))) (const? 1)) ⊑ LLVM.and e (const? (-2)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
