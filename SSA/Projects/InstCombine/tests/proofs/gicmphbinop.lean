import SSA.Projects.InstCombine.tests.proofs.gicmphbinop_proof
...
theorem mul_setnzV_unkV_nuw_eq_proof : mul_setnzV_unkV_nuw_eq_before ⊑ mul_setnzV_unkV_nuw_eq_after := by
  ...
  apply mul_setnzV_unkV_nuw_eq_thm
