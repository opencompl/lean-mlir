...
theorem icmp_sle_x_negy_thm (e e_1 : IntW 8) :
  icmp IntPredicate.sle (LLVM.and (LLVM.or e_1 (const? (-128))) e) e ⊑ const? 1 := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem icmp_eq_x_invertable_y_todo_thm (e : IntW 1) (e_1 : IntW 8) :
  icmp IntPredicate.eq e_1 (LLVM.and e_1 (select e (const? 7) (const? 24))) ⊑
    icmp IntPredicate.eq (LLVM.and e_1 (select e (const? (-8)) (const? (-25)))) (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem icmp_eq_x_invertable_y_thm (e e_1 : IntW 8) :
  icmp IntPredicate.eq e_1 (LLVM.and e_1 (LLVM.xor e (const? (-1)))) ⊑
...
theorem icmp_eq_x_invertable_y2_todo_thm (e : IntW 8) (e_1 : IntW 1) :
  icmp IntPredicate.eq (select e_1 (const? 7) (const? 24)) (LLVM.and e (select e_1 (const? 7) (const? 24))) ⊑
    icmp IntPredicate.eq (LLVM.or e (select e_1 (const? (-8)) (const? (-25)))) (const? (-1)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem icmp_eq_x_invertable_y2_thm (e e_1 : IntW 8) :
  icmp IntPredicate.eq (LLVM.xor e_1 (const? (-1))) (LLVM.and e (LLVM.xor e_1 (const? (-1)))) ⊑
    icmp IntPredicate.eq (LLVM.or e e_1) (const? (-1)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
