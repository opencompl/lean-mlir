...
theorem add_signbit_shl_thm :
  ∀ (e : IntW 32), shl (add e (const? (-65536))) (const? 8) ⊑ add (shl e (const? 8)) (const? (-16777216)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_nosignbit_shl_thm :
  ∀ (e : IntW 32), shl (add e (const? 2147418112)) (const? 8) ⊑ add (shl e (const? 8)) (const? (-16777216)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem and_nosignbit_lshr_thm :
  ∀ (e : IntW 32),
...
theorem xor_nosignbit_lshr_thm :
  ∀ (e : IntW 32),
...
theorem and_nosignbit_ashr_thm :
  ∀ (e : IntW 32),
...
theorem or_signbit_ashr_thm :
  ∀ (e : IntW 32), ashr (LLVM.or e (const? (-65536))) (const? 8) ⊑ LLVM.or (lshr e (const? 8)) (const? (-256)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem xor_nosignbit_ashr_thm :
  ∀ (e : IntW 32),
