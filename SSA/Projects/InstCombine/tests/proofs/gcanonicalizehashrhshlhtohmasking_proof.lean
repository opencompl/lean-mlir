...
theorem positive_sameconst_thm (x : BitVec 8) : x.sshiftRight 3 <<< 3 = x &&& 248#8 := by bv_compare'

theorem positive_biggerashr_thm (x : BitVec 8) : x.sshiftRight 6 <<< 3 = x.sshiftRight 3 &&& 248#8 := by bv_compare'

theorem positive_biggershl_thm (x : BitVec 8) : x.sshiftRight 3 <<< 6 = x <<< 3 &&& 192#8 := by bv_compare'
...
theorem positive_biggerashr_shlnuw_thm (x : BitVec 8) :
  (if x.sshiftRight 6 <<< 3 >>> 3 = x.sshiftRight 6 then none else some (x.sshiftRight 6 <<< 3)) ⊑
    some (x.sshiftRight 3 &&& 248#8) := by bv_compare'
...
theorem positive_biggershl_shlnsw_thm (x : BitVec 8) :
  (if (x.sshiftRight 3 <<< 6).sshiftRight 6 = x.sshiftRight 3 then none else some (x.sshiftRight 3 <<< 6)) ⊑
    (if (x <<< 3).sshiftRight 3 = x then none else some (x <<< 3)).bind fun x' => some (x' &&& 192#8) := by bv_compare'
...
theorem positive_sameconst_ashrexact_thm (x : BitVec 8) : x.sshiftRight 3 <<< 3 = x := by bv_compare'

theorem positive_biggerashr_ashrexact_thm (x : BitVec 8) : x.sshiftRight 6 <<< 3 = x.sshiftRight 3 := by bv_compare'

theorem positive_biggershl_ashrexact_thm (x : BitVec 8) : x.sshiftRight 3 <<< 6 = x <<< 3 := by bv_compare'
...
theorem positive_biggerashr_shlnsw_ashrexact_thm (x : BitVec 8) :
  (if (x.sshiftRight 6 <<< 3).sshiftRight 3 = x.sshiftRight 6 then none else some (x.sshiftRight 6 <<< 3)) ⊑
    some (x.sshiftRight 3) := by bv_compare'

theorem positive_biggershl_shlnsw_ashrexact_thm (x : BitVec 8) :
  (if (x.sshiftRight 3 <<< 6).sshiftRight 6 = x.sshiftRight 3 then none else some (x.sshiftRight 3 <<< 6)) ⊑
    if (x <<< 3).sshiftRight 3 = x then none else some (x <<< 3) := by bv_compare'
...
theorem positive_sameconst_shlnuw_ashrexact_thm (x : BitVec 8) :
  (if x.sshiftRight 3 <<< 3 >>> 3 = x.sshiftRight 3 then none else some (x.sshiftRight 3 <<< 3)) ⊑ some x := by bv_compare'
