...
theorem sel_sext_thm (e : IntW 32) (e_1 : IntW 1) :
  sext 64 (select e_1 e (const? 42)) ⊑ select e_1 (sext 64 e) (const? 42) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem sel_zext_thm (e : IntW 32) (e_1 : IntW 1) :
  zext 64 (select e_1 e (const? 42)) ⊑ select e_1 (zext 64 e) (const? 42) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_sel_equal_sext_thm (e : IntW 32) (e_1 : IntW 1) :
  sext 32 (select e_1 (trunc 16 e) (const? 42)) ⊑ select e_1 (ashr (shl e (const? 16)) (const? 16)) (const? 42) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_sel_larger_zext_thm (e : IntW 32) (e_1 : IntW 1) :
  zext 64 (select e_1 (trunc 16 e) (const? 42)) ⊑ select e_1 (zext 64 (LLVM.and e (const? 65535))) (const? 42) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_sel_smaller_zext_thm (e : IntW 64) (e_1 : IntW 1) :
  zext 32 (select e_1 (trunc 16 e) (const? 42)) ⊑ select e_1 (LLVM.and (trunc 32 e) (const? 65535)) (const? 42) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test_sext2_thm (e e_1 : IntW 1) : select e_1 (const? (-1)) (sext 32 e) ⊑ sext 32 (select e_1 (const? 1) e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
