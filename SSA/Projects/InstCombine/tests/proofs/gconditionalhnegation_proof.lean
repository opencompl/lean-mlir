...
theorem t2_thm (x : BitVec 1) (x_1 : BitVec 8) (x_2 : BitVec 1) :
  signExtend 8 x_2 + x_1 ^^^ signExtend 8 x = x_1 + signExtend 8 x_2 ^^^ signExtend 8 x := by bv_compare'

theorem t3_thm (x : BitVec 8) (x_1 : BitVec 2) :
  signExtend 8 x_1 + x ^^^ signExtend 8 x_1 = x + signExtend 8 x_1 ^^^ signExtend 8 x_1 := by bv_compare'
