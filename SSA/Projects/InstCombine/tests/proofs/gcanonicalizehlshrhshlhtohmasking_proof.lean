...
theorem positive_biggerlshr_thm (x : BitVec 8) : x >>> 6 <<< 3 = x >>> 3 &&& 24#8 := by bv_compare'

theorem positive_biggershl_thm (x : BitVec 8) : x >>> 3 <<< 6 = x <<< 3 &&& 192#8 := by bv_compare'
...
theorem positive_sameconst_shlnuw_thm (x : BitVec 8) :
  (if (x &&& 248#8) >>> 3 = x >>> 3 then none else some (x &&& 248#8)) ⊑ some (x &&& 248#8) := by bv_compare'

theorem positive_biggerlshr_shlnuw_thm (x : BitVec 8) :
  (if x >>> 6 <<< 3 >>> 3 = x >>> 6 then none else some (x >>> 6 <<< 3)) ⊑ some (x >>> 3 &&& 24#8) := by bv_compare'

theorem positive_biggershl_shlnuw_thm (x : BitVec 8) :
  (if x >>> 3 <<< 6 >>> 6 = x >>> 3 then none else some (x >>> 3 <<< 6)) ⊑
    (if x <<< 3 >>> 3 = x then none else some (x <<< 3)).bind fun x' => some (x' &&& 192#8) := by bv_compare'
...
theorem positive_sameconst_shlnsw_thm (x : BitVec 8) :
  (if (x &&& 248#8).sshiftRight 3 = x >>> 3 then none else some (x &&& 248#8)) ⊑ some (x &&& 248#8) := by bv_compare'

theorem positive_biggerlshr_shlnsw_thm (x : BitVec 8) :
  (if (x >>> 6 <<< 3).sshiftRight 3 = x >>> 6 then none else some (x >>> 6 <<< 3)) ⊑ some (x >>> 3 &&& 24#8) := by bv_compare'
...
theorem positive_sameconst_lshrexact_thm (x : BitVec 8) : x &&& 248#8 = x := by bv_compare'

theorem positive_biggerlshr_lshrexact_thm (x : BitVec 8) : x >>> 6 <<< 3 = x >>> 3 := by bv_compare'

theorem positive_biggershl_lshrexact_thm (x : BitVec 8) : x >>> 3 <<< 6 = x <<< 3 := by bv_compare'
...
theorem positive_sameconst_shlnsw_lshrexact_thm (x : BitVec 8) :
  (if (x &&& 248#8).sshiftRight 3 = x >>> 3 then none else some (x &&& 248#8)) ⊑ some x := by bv_compare'

theorem positive_biggerlshr_shlnsw_lshrexact_thm (x : BitVec 8) :
  (if (x >>> 6 <<< 3).sshiftRight 3 = x >>> 6 then none else some (x >>> 6 <<< 3)) ⊑ some (x >>> 3) := by bv_compare'

theorem positive_biggershl_shlnsw_lshrexact_thm (x : BitVec 8) :
  (if (x >>> 3 <<< 6).sshiftRight 6 = x >>> 3 then none else some (x >>> 3 <<< 6)) ⊑
    if (x <<< 3).sshiftRight 3 = x then none else if x <<< 3 >>> 3 = x then none else some (x <<< 3) := by bv_compare'
...
theorem positive_sameconst_shlnuw_lshrexact_thm (x : BitVec 8) :
  (if (x &&& 248#8) >>> 3 = x >>> 3 then none else some (x &&& 248#8)) ⊑ some x := by bv_compare'

theorem positive_biggerlshr_shlnuw_lshrexact_thm (x : BitVec 8) :
  (if x >>> 6 <<< 3 >>> 3 = x >>> 6 then none else some (x >>> 6 <<< 3)) ⊑ some (x >>> 3) := by bv_compare'

theorem positive_biggershl_shlnuw_lshrexact_thm (x : BitVec 8) :
  (if x >>> 3 <<< 6 >>> 6 = x >>> 3 then none else some (x >>> 3 <<< 6)) ⊑
    if x <<< 3 >>> 3 = x then none else some (x <<< 3) := by bv_compare'
