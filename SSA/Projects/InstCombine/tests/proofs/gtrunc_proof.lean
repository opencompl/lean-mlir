...
theorem ashr_mul_sign_bits_thm (e✝ e✝¹ : IntW 8) :
  trunc 16 (ashr (mul (sext 32 e✝¹) (sext 32 e✝)) (const? 3)) ⊑
    ashr (mul (sext 16 e✝¹) (sext 16 e✝) { «nsw» := true, «nuw» := false }) (const? 3) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_mul_thm (e✝ e✝¹ : IntW 8) :
  trunc 16 (ashr (mul (sext 20 e✝¹) (sext 20 e✝)) (const? 8)) ⊑
    ashr (mul (sext 16 e✝¹) (sext 16 e✝) { «nsw» := true, «nuw» := false }) (const? 8) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test8_thm (e✝ e✝¹ : IntW 32) :
  trunc 64 (LLVM.or (shl (zext 128 e✝¹) (const? 32)) (zext 128 e✝)) ⊑
    LLVM.or (shl (zext 64 e✝¹) (const? 32) { «nsw» := false, «nuw» := true }) (zext 64 e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test11_thm (e✝ e✝¹ : IntW 32) :
  trunc 64 (shl (zext 128 e✝¹) (LLVM.and (zext 128 e✝) (const? 31))) ⊑
    shl (zext 64 e✝¹) (zext 64 (LLVM.and e✝ (const? 31))) { «nsw» := true, «nuw» := true } := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test12_thm (e✝ e✝¹ : IntW 32) :
  trunc 64 (lshr (zext 128 e✝¹) (LLVM.and (zext 128 e✝) (const? 31))) ⊑
    lshr (zext 64 e✝¹) (zext 64 (LLVM.and e✝ (const? 31))) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test13_thm (e✝ e✝¹ : IntW 32) :
  trunc 64 (ashr (sext 128 e✝¹) (LLVM.and (zext 128 e✝) (const? 31))) ⊑
    ashr (sext 64 e✝¹) (zext 64 (LLVM.and e✝ (const? 31))) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_nsw_nuw_31_i32_i64_thm (e✝ : IntW 64) :
  trunc 32 (shl e✝ (const? 31) { «nsw» := true, «nuw» := true }) ⊑ shl (trunc 32 e✝) (const? 31) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_shl_infloop_thm (e✝ : IntW 64) :
  trunc 32 (shl (shl e✝ (const? 1)) (const? 2)) ⊑ shl (trunc 32 e✝) (const? 3) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_lshr_var_thm (e✝ e✝¹ : IntW 64) :
  trunc 32 (shl (lshr e✝¹ e✝) (const? 2)) ⊑ shl (trunc 32 (lshr e✝¹ e✝)) (const? 2) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_ashr_var_thm (e✝ e✝¹ : IntW 64) :
  trunc 32 (shl (ashr e✝¹ e✝) (const? 2)) ⊑ shl (trunc 32 (ashr e✝¹ e✝)) (const? 2) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_shl_var_thm (e✝ e✝¹ : IntW 64) :
  trunc 32 (shl (shl e✝¹ e✝) (const? 2)) ⊑ shl (trunc 32 (shl e✝¹ e✝)) (const? 2) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem drop_nsw_trunc_thm (e✝ e✝¹ : IntW 16) :
  trunc 8 (LLVM.and (LLVM.and e✝¹ (const? 255)) e✝) ⊑ trunc 8 (LLVM.and e✝¹ e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem drop_nuw_trunc_thm (e✝ e✝¹ : IntW 16) :
  trunc 8 (LLVM.and (LLVM.and e✝¹ (const? 255)) e✝) ⊑ trunc 8 (LLVM.and e✝¹ e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
...
theorem drop_both_trunc_thm (e✝ e✝¹ : IntW 16) :
  trunc 8 (LLVM.and (LLVM.and e✝¹ (const? 255)) e✝) ⊑ trunc 8 (LLVM.and e✝¹ e✝) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
