...
theorem test1_thm (x x_1 : BitVec 8) : setWidth 8 (setWidth 64 x_1 + setWidth 64 x) = x_1 + x := by bv_compare'

theorem test2_thm (x x_1 : BitVec 16) : setWidth 16 (setWidth 64 x_1 + setWidth 64 x) = x_1 + x := by bv_compare'

theorem test3_thm (x x_1 : BitVec 32) : setWidth 32 (setWidth 64 x_1 + setWidth 64 x) = x_1 + x := by bv_compare'
...
theorem test4_thm (x x_1 : BitVec 9) :
  some (setWidth 9 (setWidth 64 x_1 + setWidth 64 x)) ⊑
    (if
      ...
      fun x' => some (setWidth 9 x') := by bv_compare'
