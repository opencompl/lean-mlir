...
theorem p_constmask_thm (e✝ e✝¹ : IntW 32) :
  LLVM.xor (LLVM.and e✝¹ (const? 65280)) (LLVM.and e✝ (const? (-65281))) ⊑
...
theorem p_constmask2_thm (e✝ e✝¹ : IntW 32) :
  LLVM.xor (LLVM.and e✝¹ (const? 61440)) (LLVM.and e✝ (const? (-65281))) ⊑
...
theorem p_commutative2_thm (e✝ e✝¹ e✝² : IntW 32) :
  LLVM.xor (LLVM.and (LLVM.xor e✝² (const? (-1))) e✝¹) (LLVM.and e✝ e✝²) ⊑
...
theorem p_constmask_commutative_thm (e✝ e✝¹ : IntW 32) :
  LLVM.xor (LLVM.and e✝¹ (const? (-65281))) (LLVM.and e✝ (const? 65280)) ⊑
...
theorem n2_badmask_thm (e✝ e✝¹ e✝² e✝³ : IntW 32) :
  LLVM.xor (LLVM.and e✝³ e✝²) (LLVM.and (LLVM.xor e✝¹ (const? (-1))) e✝) ⊑
    LLVM.xor (LLVM.and e✝³ e✝²) (LLVM.and e✝ (LLVM.xor e✝¹ (const? (-1)))) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem n3_constmask_samemask_thm (e✝ e✝¹ : IntW 32) :
  LLVM.xor (LLVM.and e✝¹ (const? 65280)) (LLVM.and e✝ (const? 65280)) ⊑
    LLVM.and (LLVM.xor e✝¹ e✝) (const? 65280) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
