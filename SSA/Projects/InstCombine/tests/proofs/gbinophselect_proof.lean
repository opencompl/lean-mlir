...
theorem mul_sel_op0_thm (e✝ : IntW 32) (e✝¹ : IntW 1) :
  mul (select e✝¹ (const? 0) (LLVM.udiv (const? 42) e✝)) e✝ ⊑ select e✝¹ (const? 0) (const? 42) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem ashr_sel_op1_thm (e✝ : IntW 1) :
  ashr (const? (-2)) (select e✝ (const? 2) (const? 0)) ⊑ select e✝ (const? (-1)) (const? (-2)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
