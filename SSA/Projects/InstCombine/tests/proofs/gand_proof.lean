...
theorem test10_thm :
  ∀ (e : IntW 32), LLVM.and (LLVM.xor (LLVM.and e (const? 12)) (const? 15)) (const? 1) ⊑ const? 1 := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test31_thm :
  ∀ (e : IntW 1), LLVM.and (shl (zext 32 e) (const? 4)) (const? 16) ⊑ select e (const? 16) (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem and_zext_demanded_thm :
  ∀ (e : IntW 16) (e_1 : IntW 32),
...
theorem test32_thm :
  ∀ (e : IntW 32), LLVM.and (lshr (LLVM.and e (const? 16)) (const? 2)) (const? 1) ⊑ const? 0 := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test38_thm :
  ∀ (e : IntW 32), LLVM.and (LLVM.xor (zext 64 e) (const? 7)) (const? 240) ⊑ zext 64 (LLVM.and e (const? 240)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test39_thm :
  ∀ (e : IntW 32), LLVM.and (LLVM.or (zext 64 e) (const? 7)) (const? 240) ⊑ zext 64 (LLVM.and e (const? 240)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lowmask_add_zext_thm :
  ∀ (e : IntW 32) (e_1 : IntW 8), LLVM.and (add (zext 32 e_1) e) (const? 255) ⊑ zext 32 (add e_1 (trunc 8 e)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lowmask_add_zext_commute_thm :
  ∀ (e : IntW 16) (e_1 : IntW 32),
...
theorem lowmask_add_zext_wrong_mask_thm :
  ∀ (e : IntW 32) (e_1 : IntW 8),
...
theorem lowmask_sub_zext_commute_thm :
  ∀ (e : IntW 5) (e_1 : IntW 17), LLVM.and (sub e_1 (zext 17 e)) (const? 31) ⊑ zext 17 (sub (trunc 5 e_1) e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lowmask_mul_zext_thm :
  ∀ (e : IntW 32) (e_1 : IntW 8), LLVM.and (mul (zext 32 e_1) e) (const? 255) ⊑ zext 32 (mul e_1 (trunc 8 e)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lowmask_xor_zext_commute_thm :
...
theorem lowmask_or_zext_commute_thm :
  ∀ (e : IntW 16) (e_1 : IntW 24),
...
theorem test44_thm :
  ∀ (e e_1 : IntW 32), LLVM.and (LLVM.or (LLVM.xor e_1 (const? (-1))) e) e_1 ⊑ LLVM.and e e_1 := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test46_thm :
  ∀ (e e_1 : IntW 32), LLVM.and e_1 (LLVM.or (LLVM.xor e_1 (const? (-1))) e) ⊑ LLVM.and e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test47_thm :
  ∀ (e e_1 : IntW 32), LLVM.and e_1 (LLVM.or e (LLVM.xor e_1 (const? (-1)))) ⊑ LLVM.and e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lowbitmask_casted_shift_thm :
  ∀ (e : IntW 8), LLVM.and (sext 32 (ashr e (const? 1))) (const? 2147483647) ⊑ lshr (sext 32 e) (const? 1) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem flip_masked_bit_thm :
  ∀ (e : IntW 8), LLVM.and (add e (const? 16)) (const? 16) ⊑ LLVM.xor (LLVM.and e (const? 16)) (const? 16) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem not_signbit_splat_mask1_thm :
...
theorem not_signbit_splat_mask2_thm :
  ∀ (e : IntW 16) (e_1 : IntW 8),
...
theorem not_ashr_not_bitwidth_mask_thm :
  ∀ (e e_1 : IntW 8),
...
theorem not_lshr_bitwidth_mask_thm :
  ∀ (e e_1 : IntW 8),
...
theorem not_invert_signbit_splat_mask2_thm :
  ∀ (e : IntW 16) (e_1 : IntW 8),
...
theorem shl_lshr_pow2_const_negative_overflow2_thm :
  ∀ (e : IntW 16), LLVM.and (lshr (shl (const? 8) e) (const? 6)) (const? (-32768)) ⊑ const? 0 := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem lshr_lshr_pow2_const_negative_nopow2_1_thm :
  ∀ (e : IntW 16),
...
theorem lshr_lshr_pow2_const_negative_nopow2_2_thm :
  ∀ (e : IntW 16),
...
theorem lshr_lshr_pow2_const_negative_overflow_thm :
  ∀ (e : IntW 16), LLVM.and (lshr (lshr (const? (-32768)) e) (const? 15)) (const? 4) ⊑ const? 0 := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem and_zext_thm :
  ∀ (e : IntW 1) (e_1 : IntW 32), LLVM.and e_1 (zext 32 e) ⊑ select e (LLVM.and e_1 (const? 1)) (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem and_zext_commuted_thm :
  ∀ (e : IntW 32) (e_1 : IntW 1), LLVM.and (zext 32 e_1) e ⊑ select e_1 (LLVM.and e (const? 1)) (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_constant_equal_with_the_top_bit_of_demandedbits_pass_thm :
  ∀ (e : IntW 32), LLVM.and (add e (const? 16)) (const? 24) ⊑ LLVM.xor (LLVM.and e (const? 24)) (const? 16) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem add_constant_equal_with_the_top_bit_of_demandedbits_insertpt_thm :
  ∀ (e e_1 : IntW 32),
