...
theorem sext_non_bool_xor_sub_1_thm (x : BitVec 64) (x_1 : BitVec 8) : signExtend 64 x_1 ^^^ x = x ^^^ signExtend 64 x_1 := sorry
...
theorem sext_diff_i1_xor_sub_thm (x x_1 : BitVec 1) :
  some (signExtend 64 x_1 - signExtend 64 x) ⊑
    ...
    else some (setWidth 64 x + signExtend 64 x_1) := sorry
