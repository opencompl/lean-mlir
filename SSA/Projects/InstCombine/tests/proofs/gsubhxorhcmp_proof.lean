...
theorem sext_non_bool_xor_sub_1_thm :
  ∀ (e : IntW 64) (e_1 : IntW 8),
...
theorem sext_diff_i1_xor_sub_thm :
  ∀ (e e_1 : IntW 1),
...
theorem sext_diff_i1_xor_sub_1_thm :
  ∀ (e e_1 : IntW 1),
    sub (sext 64 e_1) (sext 64 e) ⊑ add (zext 64 e) (sext 64 e_1) { «nsw» := true, «nuw» := false } := by 
    simp_alive_undef
    simp_alive_ops
...
theorem sext_multi_uses_thm :
  ∀ (e : IntW 64) (e_1 : IntW 1) (e_2 : IntW 64),
