...
theorem shl_add_nuw_thm :
  ∀ (e : IntW 32), add (shl (const? 1) e) (const? (-1)) { «nsw» := false, «nuw» := true } ⊑ const? (-1) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem shl_add_nsw_nuw_thm :
  ∀ (e : IntW 32), add (shl (const? 1) e) (const? (-1)) { «nsw» := true, «nuw» := true } ⊑ const? (-1) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem shl_nsw_add_nsw_nuw_thm :
  ∀ (e : IntW 32),
...
theorem shl_nuw_add_nsw_nuw_thm :
  ∀ (e : IntW 32),
...
theorem shl_nsw_nuw_add_nuw_thm :
  ∀ (e : IntW 32),
...
theorem shl_nsw_nuw_add_nsw_nuw_thm :
  ∀ (e : IntW 32),
...
theorem bad_add0_thm :
  ∀ (e e_1 : IntW 32),
    add (shl (const? 1) e_1) e ⊑ add (shl (const? 1) e_1 { «nsw» := false, «nuw» := true }) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
