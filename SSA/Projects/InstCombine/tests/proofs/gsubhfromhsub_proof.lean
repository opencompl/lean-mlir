...
theorem t0_thm (x x_1 x_2 : BitVec 8) : x_2 - x_1 - x = x_2 - (x_1 + x) := by bv_compare'
...
theorem t1_flags_thm (x x_1 x_2 : BitVec 8) :
  ((if (signExtend 9 x_2 - signExtend 9 x_1).msb = (signExtend 9 x_2 - signExtend 9 x_1).getMsbD 1 then
    ...
    (if x_1.msb = x.msb ∧ ¬(x_1 + x).msb = x_1.msb then none
      ...
      fun y' =>
      if (signExtend 9 x_2 - signExtend 9 y').msb = (signExtend 9 x_2 - signExtend 9 y').getMsbD 1 then
...
theorem t1_flags_nuw_only_thm (x x_1 x_2 : BitVec 8) :
  ((if x_2 < x_1 then none else some (x_2 - x_1)).bind fun a => if a < x then none else some (a - x)) ⊑
    (if x_1 + x < x_1 ∨ x_1 + x < x then none else some (x_1 + x)).bind fun y' =>
      if x_2 < y' then none else some (x_2 - y') := by bv_compare'
...
theorem t1_flags_nuw_first_thm (x x_1 x_2 : BitVec 8) :
  ((if x_2 < x_1 then none else some (x_2 - x_1)).bind fun a => some (a - x)) ⊑ some (x_2 - (x_1 + x)) := by bv_compare'

theorem t1_flags_nuw_second_thm (x x_1 x_2 : BitVec 8) :
  (if x_2 - x_1 < x then none else some (x_2 - x_1 - x)) ⊑ some (x_2 - (x_1 + x)) := by bv_compare'
...
theorem t3_c0_thm (x x_1 : BitVec 8) : 42#8 - x_1 - x = 42#8 - (x_1 + x) := by bv_compare'

theorem t4_c1_thm (x : BitVec 8) : x - 42#8 = x + 214#8 := by bv_compare'

theorem t5_c2_thm (x x_1 : BitVec 8) : x_1 - x - 42#8 = x_1 - x + 214#8 := by bv_compare'

theorem t9_c0_c2_thm (x : BitVec 8) : 42#8 - x - 24#8 = 18#8 - x := by bv_compare'

theorem t10_c1_c2_thm (x : BitVec 8) : x - 42#8 - 24#8 = x + 190#8 := by bv_compare'
