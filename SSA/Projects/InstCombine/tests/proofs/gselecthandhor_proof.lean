...
theorem logical_and_not_thm :
  ∀ (e e_1 : IntW 1), select e_1 (const? 0) e ⊑ select (LLVM.xor e_1 (const? 1)) e (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem logical_or_not_thm :
  ∀ (e e_1 : IntW 1), select e_1 e (const? 1) ⊑ select (LLVM.xor e_1 (const? 1)) (const? 1) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem logical_and_not_cond_reuse_thm :
  ∀ (e e_1 : IntW 1), select e_1 e (LLVM.xor e_1 (const? 1)) ⊑ select (LLVM.xor e_1 (const? 1)) (const? 1) e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem logical_or_not_cond_reuse_thm :
  ∀ (e e_1 : IntW 1), select e_1 (LLVM.xor e_1 (const? 1)) e ⊑ select (LLVM.xor e_1 (const? 1)) e (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem and_or1_wrong_operand_thm :
  ∀ (e e_1 e_2 e_3 : IntW 1),
...
theorem and_or2_wrong_operand_thm :
  ∀ (e e_1 e_2 e_3 : IntW 1),
    select (LLVM.and (LLVM.xor e_3 (const? 1)) e_2) e_1 e ⊑
      select (LLVM.and e_2 (LLVM.xor e_3 (const? 1))) e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
