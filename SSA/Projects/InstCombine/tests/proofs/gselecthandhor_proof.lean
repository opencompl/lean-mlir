...
theorem logical_or_implies_thm (e : IntW 32) :
  select (icmp IntPredicate.eq e (const? 0)) (const? 1) (icmp IntPredicate.eq e (const? 42)) ⊑
    LLVM.or (icmp IntPredicate.eq e (const? 0)) (icmp IntPredicate.eq e (const? 42)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem logical_or_implies_folds_thm (e : IntW 32) :
  select (icmp IntPredicate.slt e (const? 0)) (const? 1) (icmp IntPredicate.sge e (const? 0)) ⊑ const? 1 := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem logical_and_implies_thm (e : IntW 32) :
  select (icmp IntPredicate.ne e (const? 0)) (icmp IntPredicate.ne e (const? 42)) (const? 0) ⊑
    LLVM.and (icmp IntPredicate.ne e (const? 0)) (icmp IntPredicate.ne e (const? 42)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem logical_and_implies_folds_thm (e : IntW 32) :
  select (icmp IntPredicate.ugt e (const? 42)) (icmp IntPredicate.ne e (const? 0)) (const? 0) ⊑
    icmp IntPredicate.ugt e (const? 42) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem and_or3_thm (e : IntW 1) (e_1 e_2 : IntW 32) (e_3 : IntW 1) :
  select (LLVM.and e_3 (icmp IntPredicate.eq e_2 e_1)) e e_3 ⊑
    select e_3 (select (icmp IntPredicate.ne e_2 e_1) (const? 1) e) (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem and_or3_commuted_thm (e e_1 : IntW 1) (e_2 e_3 : IntW 32) :
  select (LLVM.and (icmp IntPredicate.eq e_3 e_2) e_1) e e_1 ⊑
    select e_1 (select (icmp IntPredicate.ne e_3 e_2) (const? 1) e) (const? 0) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem or_and3_thm (e : IntW 1) (e_1 e_2 : IntW 32) (e_3 : IntW 1) :
  select (LLVM.or e_3 (icmp IntPredicate.eq e_2 e_1)) e_3 e ⊑
    select e_3 (const? 1) (select (icmp IntPredicate.ne e_2 e_1) e (const? 0)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem or_and3_commuted_thm (e e_1 : IntW 1) (e_2 e_3 : IntW 32) :
  select (LLVM.or (icmp IntPredicate.eq e_3 e_2) e_1) e_1 e ⊑
    select e_1 (const? 1) (select (icmp IntPredicate.ne e_3 e_2) e (const? 0)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test_logical_or_eq_a_b_thm (e e_1 : IntW 8) (e_2 : IntW 1) :
  select (select e_2 (const? 1) (icmp IntPredicate.eq e_1 e)) e_1 e ⊑ select e_2 e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem test_logical_and_ne_a_b_thm (e e_1 : IntW 8) (e_2 : IntW 1) :
  select (select e_2 (icmp IntPredicate.ne e_1 e) (const? 0)) e_1 e ⊑ select e_2 e_1 e := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
