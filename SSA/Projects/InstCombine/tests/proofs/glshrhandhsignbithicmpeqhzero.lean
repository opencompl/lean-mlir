import SSA.Projects.InstCombine.tests.proofs.glshrhandhsignbithicmpeqhzero_proof
...
section glshrhandhsignbithicmpeqhzero_statements
...
theorem scalar_i8_lshr_and_signbit_eq_proof : scalar_i8_lshr_and_signbit_eq_before ⊑ scalar_i8_lshr_and_signbit_eq_after := by
  unfold scalar_i8_lshr_and_signbit_eq_before scalar_i8_lshr_and_signbit_eq_after
  simp_alive_peephole
  intros
  ---BEGIN scalar_i8_lshr_and_signbit_eq
  apply scalar_i8_lshr_and_signbit_eq_thm
  ---END scalar_i8_lshr_and_signbit_eq
...
set_option debug.skipKernelTC true in
theorem scalar_i16_lshr_and_signbit_eq_proof : scalar_i16_lshr_and_signbit_eq_before ⊑ scalar_i16_lshr_and_signbit_eq_after := by
  unfold scalar_i16_lshr_and_signbit_eq_before scalar_i16_lshr_and_signbit_eq_after
  simp_alive_peephole
  intros
  ---BEGIN scalar_i16_lshr_and_signbit_eq
  apply scalar_i16_lshr_and_signbit_eq_thm
  ---END scalar_i16_lshr_and_signbit_eq
...
def scalar_i32_lshr_and_signbit_eq_after := [llvm|
{
^0(%arg31 : i32, %arg32 : i32):
...
set_option debug.skipKernelTC true in
theorem scalar_i32_lshr_and_signbit_eq_proof : scalar_i32_lshr_and_signbit_eq_before ⊑ scalar_i32_lshr_and_signbit_eq_after := by
  unfold scalar_i32_lshr_and_signbit_eq_before scalar_i32_lshr_and_signbit_eq_after
  simp_alive_peephole
  intros
  ---BEGIN scalar_i32_lshr_and_signbit_eq
  apply scalar_i32_lshr_and_signbit_eq_thm
  ---END scalar_i32_lshr_and_signbit_eq
...
set_option debug.skipKernelTC true in
theorem scalar_i64_lshr_and_signbit_eq_proof : scalar_i64_lshr_and_signbit_eq_before ⊑ scalar_i64_lshr_and_signbit_eq_after := by
  unfold scalar_i64_lshr_and_signbit_eq_before scalar_i64_lshr_and_signbit_eq_after
  simp_alive_peephole
  intros
  ---BEGIN scalar_i64_lshr_and_signbit_eq
  apply scalar_i64_lshr_and_signbit_eq_thm
  ---END scalar_i64_lshr_and_signbit_eq



def scalar_i32_lshr_and_signbit_ne_before := [llvm|
{
^0(%arg27 : i32, %arg28 : i32):
  %0 = llvm.mlir.constant(-2147483648 : i32) : i32
  %1 = llvm.mlir.constant(0 : i32) : i32
  %2 = llvm.lshr %arg27, %arg28 : i32
  %3 = llvm.and %2, %0 : i32
...
set_option debug.skipKernelTC true in
theorem scalar_i32_lshr_and_signbit_ne_proof : scalar_i32_lshr_and_signbit_ne_before ⊑ scalar_i32_lshr_and_signbit_ne_after := by
  unfold scalar_i32_lshr_and_signbit_ne_before scalar_i32_lshr_and_signbit_ne_after
  simp_alive_peephole
  intros
  ---BEGIN scalar_i32_lshr_and_signbit_ne
  apply scalar_i32_lshr_and_signbit_ne_thm
  ---END scalar_i32_lshr_and_signbit_ne
...
set_option debug.skipKernelTC true in
theorem scalar_i32_lshr_and_signbit_eq_X_is_constant1_proof : scalar_i32_lshr_and_signbit_eq_X_is_constant1_before ⊑ scalar_i32_lshr_and_signbit_eq_X_is_constant1_after := by
  unfold scalar_i32_lshr_and_signbit_eq_X_is_constant1_before scalar_i32_lshr_and_signbit_eq_X_is_constant1_after
  simp_alive_peephole
  intros
  ---BEGIN scalar_i32_lshr_and_signbit_eq_X_is_constant1
  apply scalar_i32_lshr_and_signbit_eq_X_is_constant1_thm
  ---END scalar_i32_lshr_and_signbit_eq_X_is_constant1
