...
theorem trunc_shl_shl_infloop_thm (e : IntW 64) : trunc 32 (shl (shl e (const? 1)) (const? 2)) ⊑ shl (trunc 32 e) (const? 3) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_lshr_var_thm (e e_1 : IntW 64) :
  trunc 32 (shl (lshr e_1 e) (const? 2)) ⊑ shl (trunc 32 (lshr e_1 e)) (const? 2) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_ashr_var_thm (e e_1 : IntW 64) :
  trunc 32 (shl (ashr e_1 e) (const? 2)) ⊑ shl (trunc 32 (ashr e_1 e)) (const? 2) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem trunc_shl_shl_var_thm (e e_1 : IntW 64) :
  trunc 32 (shl (shl e_1 e) (const? 2)) ⊑ shl (trunc 32 (shl e_1 e)) (const? 2) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
