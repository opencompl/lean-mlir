...
theorem or_and_shifts1_thm (e : IntW 32) :
  LLVM.or (LLVM.and (shl e (const? 32 3)) (const? 32 15)) (LLVM.and (shl e (const? 32 5)) (const? 32 60)) ⊑
    LLVM.or (LLVM.and (shl e (const? 32 3)) (const? 32 8)) (LLVM.and (shl e (const? 32 5)) (const? 32 32)) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem multiuse1_thm (e : IntW 32) :
  LLVM.or
    ...
    LLVM.or (LLVM.or (LLVM.and (lshr e (const? 32 1)) (const? 32 1)) (LLVM.and (lshr e (const? 32 1)) (const? 32 2)))
      (LLVM.and (shl e (const? 32 6)) (const? 32 384)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
  ...
  LLVM.or
    ...
    LLVM.or (LLVM.and (shl e (const? 32 8)) (const? 32 32256))
      (LLVM.or (LLVM.and (shl e (const? 32 1)) (const? 32 12))
        (LLVM.or (LLVM.and (shl e (const? 32 1)) (const? 32 192))
          (LLVM.and (shl e (const? 32 1)) (const? 32 48)))) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem multiuse3_thm (e : IntW 32) :
  LLVM.or
    ...
    LLVM.or (LLVM.or (LLVM.and (lshr e (const? 32 1)) (const? 32 48)) (LLVM.and (lshr e (const? 32 1)) (const? 32 15)))
      (LLVM.and (shl e (const? 32 6)) (const? 32 8064)) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
...
theorem shl_mask_weird_type_thm (e : IntW 37) :
  LLVM.or (LLVM.and e (const? 37 255)) (shl (LLVM.and e (const? 37 255)) (const? 37 8)) ⊑
    LLVM.or (LLVM.and e (const? 37 255))
      (shl (LLVM.and e (const? 37 255)) (const? 37 8) { «nsw» := true, «nuw» := true }) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    simp_alive_split
