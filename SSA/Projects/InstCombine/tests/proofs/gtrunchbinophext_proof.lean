...
theorem narrow_sext_and_thm (x : BitVec 32) (x_1 : BitVec 16) :
  setWidth 16 (signExtend 32 x_1) &&& setWidth 16 x = x_1 &&& setWidth 16 x := by bv_compare'
...
theorem narrow_sext_add_thm (x : BitVec 32) (x_1 : BitVec 16) :
  setWidth 16 (signExtend 32 x_1 + x) = x_1 + setWidth 16 x := by bv_compare'

theorem narrow_zext_add_thm (x : BitVec 32) (x_1 : BitVec 16) : setWidth 16 (setWidth 32 x_1 + x) = x_1 + setWidth 16 x := by bv_compare'

theorem narrow_sext_sub_thm (x : BitVec 32) (x_1 : BitVec 16) :
  setWidth 16 (signExtend 32 x_1 - x) = x_1 - setWidth 16 x := by bv_compare'

theorem narrow_zext_sub_thm (x : BitVec 32) (x_1 : BitVec 16) : setWidth 16 (setWidth 32 x_1 - x) = x_1 - setWidth 16 x := by bv_compare'

theorem narrow_sext_mul_thm (x : BitVec 32) (x_1 : BitVec 16) :
  setWidth 16 (signExtend 32 x_1 * x) = x_1 * setWidth 16 x := by bv_compare'

theorem narrow_zext_mul_thm (x : BitVec 32) (x_1 : BitVec 16) : setWidth 16 (setWidth 32 x_1 * x) = x_1 * setWidth 16 x := by bv_compare'
...
theorem narrow_zext_ashr_keep_trunc_thm (x x_1 : BitVec 8) :
  ((if x_1.msb = x.msb ∧ ¬(signExtend 32 x_1 + signExtend 32 x).msb = x_1.msb then none
    ...
    (if x_1.msb = x.msb ∧ ¬(signExtend 16 x_1 + signExtend 16 x).msb = x_1.msb then none
      ...
      fun x => some (setWidth 8 (x >>> 1)) := by bv_compare'
...
theorem narrow_zext_ashr_keep_trunc3_thm (x x_1 : BitVec 8) :
  ((if x_1.msb = x.msb ∧ ¬(signExtend 64 x_1 + signExtend 64 x).msb = x_1.msb then none
    ...
    (if
      ...
      fun x => some (setWidth 7 (x >>> 1)) := by bv_compare'
