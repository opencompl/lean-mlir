...
theorem narrow_sext_and_thm :
  ∀ (e : IntW 32) (e_1 : IntW 16), trunc 16 (LLVM.and (sext 32 e_1) e) ⊑ LLVM.and e_1 (trunc 16 e) := by 
    simp_alive_undef
    simp_alive_ops
...
theorem narrow_zext_and_thm :
  ∀ (e : IntW 32) (e_1 : IntW 16), trunc 16 (LLVM.and (zext 32 e_1) e) ⊑ LLVM.and e_1 (trunc 16 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem narrow_sext_or_thm :
  ∀ (e : IntW 32) (e_1 : IntW 16), trunc 16 (LLVM.or (sext 32 e_1) e) ⊑ LLVM.or e_1 (trunc 16 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem narrow_zext_or_thm :
  ∀ (e : IntW 32) (e_1 : IntW 16), trunc 16 (LLVM.or (zext 32 e_1) e) ⊑ LLVM.or e_1 (trunc 16 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem narrow_sext_xor_thm :
  ∀ (e : IntW 32) (e_1 : IntW 16), trunc 16 (LLVM.xor (sext 32 e_1) e) ⊑ LLVM.xor e_1 (trunc 16 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem narrow_zext_xor_thm :
  ∀ (e : IntW 32) (e_1 : IntW 16), trunc 16 (LLVM.xor (zext 32 e_1) e) ⊑ LLVM.xor e_1 (trunc 16 e) := by 
    simp_alive_undef
    simp_alive_ops
    simp_alive_case_bash
    try alive_auto
...
theorem narrow_zext_ashr_keep_trunc_thm :
  ∀ (e e_1 : IntW 8),
...
theorem narrow_zext_ashr_keep_trunc2_thm :
  ∀ (e e_1 : IntW 9),
...
theorem narrow_zext_ashr_keep_trunc3_thm :
  ∀ (e e_1 : IntW 8),
...
theorem dont_narrow_zext_ashr_keep_trunc_thm :
  ∀ (e e_1 : IntW 8),
