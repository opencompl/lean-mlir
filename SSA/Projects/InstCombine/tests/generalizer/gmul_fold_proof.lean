...
theorem mul8_low_A0_B0_proof.mul8_low_A0_B0_thm_1 (e e_1 : IntW 8) :
...
theorem mul8_low_proof.mul8_low_thm_1 (e e_1 : IntW 8) :
  add
      (shl
...
theorem mul16_low_proof.mul16_low_thm_1 (e e_1 : IntW 16) :
  add
      (shl
...
theorem mul32_low_proof.mul32_low_thm_1 (e e_1 : IntW 32) :
  add
      (shl
...
theorem mul64_low_proof.mul64_low_thm_1 (e e_1 : IntW 64) :
  add
      (shl
...
theorem mul128_low_proof.mul128_low_thm_1 (e e_1 : IntW 128) :
  add
      (shl
...
theorem mul130_low_proof.mul130_low_thm_1 (e e_1 : IntW 130) :
  add
      (shl
...
theorem mul9_low_proof.mul9_low_thm_1 (e e_1 : IntW 9) :
  add
      (shl
    ...
    add
      (shl
        (add (mul (lshr e_1 (const? 9 4)) (LLVM.and e (const? 9 15)) { «nuw» := true })
          (mul (LLVM.and e_1 (const? 9 15)) (lshr e (const? 9 4)) { «nuw» := true }))
        (const? 9 4))
...
theorem mul16_low_miss_shift_amount_proof.mul16_low_miss_shift_amount_thm_1 (e e_1 : IntW 16) :
  add
      (shl
...
theorem mul8_low_miss_half_width_proof.mul8_low_miss_half_width_thm_1 (e e_1 : IntW 8) :
  add
      (shl
    ...
    add
      (shl
        (add (mul (lshr e_1 (const? 8 3)) (LLVM.and e (const? 8 15)))
          (mul (LLVM.and e_1 (const? 8 15)) (lshr e (const? 8 3))))
        (const? 8 3))
      (mul (LLVM.and e_1 (const? 8 15)) (LLVM.and e (const? 8 15)) { «nuw» := true }) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
