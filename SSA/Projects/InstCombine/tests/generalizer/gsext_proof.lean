...
theorem test13_proof.test13_thm_1 (e : IntW 32) :
  sext 32 (icmp IntPred.eq (LLVM.and e (const? 32 8)) (const? 32 0)) ⊑
    add (LLVM.and (lshr e (const? 32 3)) (const? 32 1)) (const? 32 (-1)) { «nsw» := true } := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem test14_proof.test14_thm_1 (e : IntW 16) :
  sext 32 (icmp IntPred.ne (LLVM.and e (const? 16 16)) (const? 16 16)) ⊑
    sext 32 (add (LLVM.and (lshr e (const? 16 4)) (const? 16 1)) (const? 16 (-1)) { «nsw» := true }) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem test16_proof.test16_thm_1 (e : IntW 16) :
...
theorem test17_proof.test17_thm_1 (e : IntW 1) : sub (const? 32 0) (sext 32 e) ⊑ zext 32 e := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem test19_proof.test19_thm_1 (e : IntW 10) :
  sext 10 (ashr (shl (trunc 3 e) (const? 3 2)) (const? 3 2)) ⊑
    sext 10 (sub (const? 3 0) (LLVM.and (trunc 3 e) (const? 3 1)) { «nsw» := true }) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem smear_set_bit_proof.smear_set_bit_thm_1 (e : IntW 32) :
...
theorem smear_set_bit_different_dest_type_proof.smear_set_bit_different_dest_type_thm_1 (e : IntW 32) :
  sext 16 (ashr (trunc 8 e) (const? 8 7)) ⊑
    trunc 16 (ashr (shl e (const? 32 24)) (const? 32 31)) { «nsw» := true } := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem smear_set_bit_different_dest_type_wider_dst_proof.smear_set_bit_different_dest_type_wider_dst_thm_1 (e : IntW 32) :
