...
theorem src_proof.src_thm_1 (e e_1 : IntW 32) :
...
theorem src2_proof.src2_thm_1 (e e_1 : IntW 32) :
...
theorem src3_proof.src3_thm_1 (e e_1 : IntW 32) :
...
theorem src4_proof.src4_thm_1 (e e_1 : IntW 32) :
  add (LLVM.and e e_1) (LLVM.xor (LLVM.or e_1 e) (const? 32 (-1))) ⊑ LLVM.xor (LLVM.xor e e_1) (const? 32 (-1)) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem src5_proof.src5_thm_1 (e e_1 : IntW 32) :
