...
theorem shl_or_proof.shl_or_thm_1 (e : IntW 8) :
...
theorem lshr_or_proof.lshr_or_thm_1 (e : IntW 8) :
...
theorem ashr_or_proof.ashr_or_thm_1 (e : IntW 8) :
...
theorem shl_xor_proof.shl_xor_thm_1 (e : IntW 8) :
...
theorem lshr_xor_proof.lshr_xor_thm_1 (e : IntW 8) :
...
theorem ashr_xor_proof.ashr_xor_thm_1 (e : IntW 8) :
...
theorem shl_and_proof.shl_and_thm_1 (e : IntW 8) :
...
theorem lshr_and_proof.lshr_and_thm_1 (e : IntW 8) :
...
theorem ashr_and_proof.ashr_and_thm_1 (e : IntW 8) :
...
theorem shl_add_proof.shl_add_thm_1 (e : IntW 8) :
...
theorem lshr_add_fail_proof.lshr_add_fail_thm_1 (e : IntW 8) :
...
theorem ashr_add_fail_proof.ashr_add_fail_thm_1 (e : IntW 8) :
...
theorem shl_or_commuted_proof.shl_or_commuted_thm_1 (e : IntW 8) :
...
theorem mismatched_shifts_proof.mismatched_shifts_thm_1 (e : IntW 8) :
...
theorem shl_or_with_or_disjoint_instead_of_add_proof.shl_or_with_or_disjoint_instead_of_add_thm_1 (e : IntW 8) :
