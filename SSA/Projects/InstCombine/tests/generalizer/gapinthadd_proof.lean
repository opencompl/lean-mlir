...
theorem test1_proof.test1_thm_1 (e : IntW 1) : add (LLVM.xor e (const? 1 1)) (const? 1 1) ⊑ e := by
        simp_alive_undef
        simp_alive_ops
...
theorem test2_proof.test2_thm_1 (e : IntW 47) :
...
theorem test3_proof.test3_thm_1 (e : IntW 15) :
  add (LLVM.xor e (const? 15 (-16384))) (const? 15 (-16384)) ⊑ e := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem test4_proof.test4_thm_1 (e : IntW 49) :
  add (LLVM.and e (const? 49 (-2))) (const? 49 1) ⊑ LLVM.or e (const? 49 1) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem sext_proof.sext_thm_1 (e : IntW 4) :
  add (zext 7 (LLVM.xor e (const? 4 (-8)))) (const? 7 (-8)) { «nsw» := true } ⊑ sext 7 e := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem sext_multiuse_proof.sext_multiuse_thm_1 (e : IntW 4) :
  LLVM.sdiv
      (trunc 4
        (LLVM.sdiv (zext 7 (LLVM.xor e (const? 4 (-8))))
          (add (zext 7 (LLVM.xor e (const? 4 (-8)))) (const? 7 (-8)) { «nsw» := true })))
...
theorem test5_proof.test5_thm_1 (e : IntW 111) :
...
theorem test6_proof.test6_thm_1 (e : IntW 65) :
...
theorem test7_proof.test7_thm_1 (e : IntW 1024) :
...
theorem test8_proof.test8_thm_1 (e : IntW 128) :
...
theorem test9_proof.test9_thm_1 (e : IntW 77) :
