...
theorem test1_proof.test1_thm_1 (e e_1 : IntW 32) :
  icmp IntPred.eq (LLVM.udiv e e_1) (const? 32 0) ⊑ icmp IntPred.ugt e_1 e := by
        simp_alive_undef
        simp_alive_ops
...
theorem test3_proof.test3_thm_1 (e e_1 : IntW 32) :
  icmp IntPred.ne (LLVM.udiv e e_1) (const? 32 0) ⊑ icmp IntPred.ule e_1 e := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem test14_proof.test14_thm_1 (e : IntW 32) :
