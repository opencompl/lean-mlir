...
theorem or_basic_proof.or_basic_thm_1 (e : IntW 16) :
...
theorem or_basic_commuted_proof.or_basic_commuted_thm_1 (e : IntW 16) :
...
theorem or_nontrivial_mask1_proof.or_nontrivial_mask1_thm_1 (e : IntW 16) :
  LLVM.or (icmp IntPred.ne (trunc 8 e) (const? 8 127))
...
theorem or_nontrivial_mask2_proof.or_nontrivial_mask2_thm_1 (e : IntW 16) :
  LLVM.or (icmp IntPred.ne (trunc 8 e) (const? 8 127))
...
theorem or_wrong_const1_proof.or_wrong_const1_thm_1 (e : IntW 16) :
  LLVM.or (icmp IntPred.ne (trunc 8 e) (const? 8 127))
