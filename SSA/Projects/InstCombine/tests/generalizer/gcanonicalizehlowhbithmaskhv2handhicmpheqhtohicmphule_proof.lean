...
theorem n0_proof.n0_thm_1 (e e_1 e_2 : IntW 8) :
  icmp IntPred.eq (LLVM.and (LLVM.xor (shl (const? 8 (-1)) e_1) (const? 8 (-1))) e) e_2 ⊑
    icmp IntPred.eq (LLVM.and e (LLVM.xor (shl (const? 8 (-1)) e_1 { «nsw» := true }) (const? 8 (-1)))) e_2 := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem n1_proof.n1_thm_1 (e e_1 : IntW 8) :
  icmp IntPred.eq (LLVM.and (LLVM.xor (shl (const? 8 1) e_1) (const? 8 (-1))) e) e ⊑
    icmp IntPred.eq (LLVM.and e (shl (const? 8 1) e_1 { «nuw» := true })) (const? 8 0) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem n2_proof.n2_thm_1 (e e_1 : IntW 8) :
  icmp IntPred.eq (LLVM.and (LLVM.xor (shl (const? 8 (-1)) e_1) (const? 8 1)) e) e ⊑
    icmp IntPred.eq (LLVM.and e (LLVM.xor (shl (const? 8 (-1)) e_1 { «nsw» := true }) (const? 8 (-2))))
      (const? 8 0) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
