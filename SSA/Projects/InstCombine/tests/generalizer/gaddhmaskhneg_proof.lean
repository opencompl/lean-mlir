...
theorem dec_mask_neg_i32_proof.dec_mask_neg_i32_thm_1 (e : IntW 32) :
...
theorem dec_mask_commute_neg_i32_proof.dec_mask_commute_neg_i32_thm_1 (e : IntW 32) :
  add (LLVM.and (LLVM.sdiv (const? 32 42) e) (sub (const? 32 0) (LLVM.sdiv (const? 32 42) e))) (const? 32 (-1)) ⊑
    LLVM.and (add (LLVM.sdiv (const? 32 42) e) (const? 32 (-1)) { «nsw» := true })
...
theorem dec_commute_mask_neg_i32_proof.dec_commute_mask_neg_i32_thm_1 (e : IntW 32) :
