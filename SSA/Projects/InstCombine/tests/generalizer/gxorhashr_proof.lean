...
theorem testi8i8_proof.testi8i8_thm_1 (e : IntW 8) :
...
theorem testi128i128_proof.testi128i128_thm_1 (e : IntW 128) :
...
theorem wrongimm_proof.wrongimm_thm_1 (e : IntW 16) :
  LLVM.xor (trunc 8 (ashr e (const? 16 14))) (const? 8 27) ⊑
    LLVM.xor (trunc 8 (ashr e (const? 16 14)) { «nsw» := true }) (const? 8 27) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
