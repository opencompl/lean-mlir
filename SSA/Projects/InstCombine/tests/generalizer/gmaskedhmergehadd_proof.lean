...
theorem p_proof.p_thm_1 (e e_1 e_2 : IntW 32) :
  add (LLVM.and e e_2) (LLVM.and (LLVM.xor e_2 (const? 32 (-1))) e_1) ⊑
...
theorem p_constmask_proof.p_constmask_thm_1 (e e_1 : IntW 32) :
  add (LLVM.and e (const? 32 65280)) (LLVM.and e_1 (const? 32 (-65281))) ⊑
...
theorem p_constmask2_proof.p_constmask2_thm_1 (e e_1 : IntW 32) :
  add (LLVM.and e (const? 32 61440)) (LLVM.and e_1 (const? 32 (-65281))) ⊑
...
theorem p_commutative0_proof.p_commutative0_thm_1 (e e_1 e_2 : IntW 32) :
  add (LLVM.and e_2 e) (LLVM.and (LLVM.xor e_2 (const? 32 (-1))) e_1) ⊑
...
theorem n2_badmask_proof.n2_badmask_thm_1 (e e_1 e_2 e_3 : IntW 32) :
  add (LLVM.and e_2 e) (LLVM.and (LLVM.xor e_3 (const? 32 (-1))) e_1) ⊑
    add (LLVM.and e_2 e) (LLVM.and e_1 (LLVM.xor e_3 (const? 32 (-1)))) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem n3_constmask_samemask_proof.n3_constmask_samemask_thm_1 (e e_1 : IntW 32) :
  add (LLVM.and e (const? 32 65280)) (LLVM.and e_1 (const? 32 65280)) ⊑
    add (LLVM.and e (const? 32 65280)) (LLVM.and e_1 (const? 32 65280)) { «nsw» := true, «nuw» := true } := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
