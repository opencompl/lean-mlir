...
theorem select_icmp_eq_pow2_proof.select_icmp_eq_pow2_thm_1 (e : IntW 8) :
...
theorem select_icmp_eq_pow2_flipped_proof.select_icmp_eq_pow2_flipped_thm_1 (e : IntW 8) :
...
theorem select_icmp_ne_pow2_proof.select_icmp_ne_pow2_thm_1 (e : IntW 8) :
...
theorem select_icmp_ne_pow2_flipped_proof.select_icmp_ne_pow2_flipped_thm_1 (e : IntW 8) :
...
theorem select_icmp_ne_not_pow2_proof.select_icmp_ne_not_pow2_thm_1 (e : IntW 8) :
...
theorem select_icmp_slt_zero_smin_proof.select_icmp_slt_zero_smin_thm_1 (e : IntW 8) :
...
theorem select_icmp_slt_zero_smin_flipped_proof.select_icmp_slt_zero_smin_flipped_thm_1 (e : IntW 8) :
...
theorem select_icmp_sgt_allones_smin_proof.select_icmp_sgt_allones_smin_thm_1 (e : IntW 8) :
...
theorem select_icmp_sgt_allones_smin_flipped_proof.select_icmp_sgt_allones_smin_flipped_thm_1 (e : IntW 8) :
  select (icmp IntPred.sgt e (const? 8 (-1))) (LLVM.xor e (const? 8 (-128))) e ⊑ LLVM.or e (const? 8 (-128)) := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
...
theorem select_icmp_sgt_not_smin_proof.select_icmp_sgt_not_smin_thm_1 (e : IntW 8) :
