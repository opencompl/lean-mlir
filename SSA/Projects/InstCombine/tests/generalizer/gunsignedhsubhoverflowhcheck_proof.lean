...
theorem t0_basic_proof.t0_basic_thm_1 (e e_1 : IntW 8) : icmp IntPred.ugt (sub e e_1) e ⊑ icmp IntPred.ugt e_1 e := by
        simp_alive_undef
        simp_alive_ops
...
theorem t2_commutative_proof.t2_commutative_thm_1 (e e_1 : IntW 8) :
  icmp IntPred.ult e (sub e e_1) ⊑ icmp IntPred.ult e e_1 := by
        simp_alive_undef
        simp_alive_ops
        simp_alive_case_bash
        simp_alive_split
