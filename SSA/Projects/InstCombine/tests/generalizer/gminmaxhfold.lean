import SSA.Projects.InstCombine.tests.proofs.gminmaxhfold_proof
...
theorem add_umin_constant_limit_proof : add_umin_constant_limit_before ⊑ add_umin_constant_limit_after := by
  ...
  apply add_umin_constant_limit_thm
