...
^bb0(%a : _, %b : _, %d : _):
  %v1 = llvm.and %a, %b : _
  %v2 = llvm.and %a, %d : _
  %v3 = llvm.icmp.eq %v1, %b : _
  %v4 = llvm.icmp.eq %v2, %d : _
...
^bb0(%a : _, %b : _, %d : _):
  ...
  %v3 = llvm.and %a, %b : _
  %v4 = llvm.and %a, %d : _
  %v5 = llvm.icmp.eq %v3, %b : _
  %v6 = llvm.icmp.eq %v4, %d : _
  %v7 = llvm.icmp.eq %v2, %v1 : _
  llvm.return %v7 : i1
}]
...
^bb0(%a : _, %b : _, %d : _):
  %v1 = llvm.and %a, %b : _
  %v2 = llvm.and %a, %d : _
  %v3 = llvm.icmp.eq %v1, %a : _
  %v4 = llvm.icmp.eq %v2, %a : _
  %v5 = llvm.and %v3, %v4 : i1
  llvm.return %v5 : i1
}]
...
^bb0(%a : _, %b : _, %d : _):
  ...
  %v3 = llvm.and %a, %b : _
  %v4 = llvm.and %a, %d : _
  %v5 = llvm.icmp.eq %v3, %a : _
  %v6 = llvm.icmp.eq %v4, %a : _
  %v7 = llvm.icmp.eq %v2, %a : _
  llvm.return %v7 : i1
}]
...
[alive_icom ( w )| {
^bb0(%a : _, %b : _):
  %v1 = llvm.icmp.sgt %a, %b : _
  %v2 = llvm.icmp.ne %a, %b : _
...
^bb0(%a : _, %b : _):
  %v1 = llvm.or %a, %b : _
  %v2 = llvm.mlir.constant 0 : _
  %v3 = llvm.icmp.eq %a, %v2 : _
  %v4 = llvm.mlir.constant 0 : _
  %v5 = llvm.icmp.eq %b, %v4 : _
  %v6 = llvm.mlir.constant 0 : _
  %v7 = llvm.icmp.eq %v1, %v6 : _
  llvm.return %v7 : i1
}]
...
[alive_icom ( w )| {
^bb0(%a : _, %C1 : _):
  %v1 = llvm.icmp.eq %a, %C1 : _
  %v2 = llvm.icmp.ne %a, %C1 : _
  %v3 = llvm.and %v1, %v2 : i1
  llvm.return %v3 : i1
}]
...
[alive_icom ( w )| {
^bb0(%a : _, %b : _):
  %v1 = llvm.icmp.ugt %a, %b : _
  %v2 = llvm.icmp.eq %a, %b : _
  %v3 = llvm.or %v1, %v2 : i1
  llvm.return %v3 : i1
}]
...
^bb0(%A : _, %B : _):
  ...
  %v3 = llvm.mlir.constant 0 : _
  %v4 = llvm.icmp.eq %B, %v3 : _
  %v5 = llvm.icmp.ult %A, %B : _
  %v6 = llvm.icmp.uge %v2, %A : _
  llvm.return %v6 : i1
}]
