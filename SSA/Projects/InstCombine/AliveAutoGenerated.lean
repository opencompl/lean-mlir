...
^bb0(%Z : _, %C1 : _, %RHS : _):
  %v1 = llvm.and %Z, %C1 : _
  %v2 = llvm.xor %v1, %C1 : _
  %v3 = llvm.mlir.constant 1 : _
  %v4 = llvm.add %v2, %v3 : _
  %v5 = llvm.add %v4, %RHS : _
  llvm.return %v5 : _
}]
...
^bb0(%Z : _, %C1 : _, %RHS : _):
  ...
  %v3 = llvm.and %Z, %C1 : _
  %v4 = llvm.xor %v3, %C1 : _
  %v5 = llvm.mlir.constant 1 : _
  %v6 = llvm.add %v4, %v5 : _
  %v7 = llvm.sub %RHS, %v2 : _
  llvm.return %v7 : _
}]
...
^bb0(%a : _, %b : _, %d : _):
  %v1 = llvm.and %a, %b : i1
  %v2 = llvm.and %a, %d : i1
  %v3 = llvm.icmp.eq %v1, %b : i1
  %v4 = llvm.icmp.eq %v2, %d : i1
...
^bb0(%a : _, %b : _, %d : _):
  ...
  %v3 = llvm.and %a, %b : _
  %v4 = llvm.and %a, %d : _
  %v5 = llvm.icmp.eq %v3, %b : i1
  %v6 = llvm.icmp.eq %v4, %d : i1
  %v7 = llvm.icmp.eq %v2, %v1 : i1
  llvm.return %v7 : i1
}]
...
^bb0(%a : _, %b : _, %d : _):
  %v1 = llvm.and %a, %b : i1
  %v2 = llvm.and %a, %d : i1
  %v3 = llvm.icmp.eq %v1, %a : i1
  %v4 = llvm.icmp.eq %v2, %a : i1
  %v5 = llvm.and %v3, %v4 : i1
  llvm.return %v5 : i1
}]
...
^bb0(%a : _, %b : _, %d : _):
  ...
  %v3 = llvm.and %a, %b : _
  %v4 = llvm.and %a, %d : _
  %v5 = llvm.icmp.eq %v3, %a : i1
  %v6 = llvm.icmp.eq %v4, %a : i1
  %v7 = llvm.icmp.eq %v2, %a : i1
  llvm.return %v7 : i1
}]
...
[alive_icom ()| {
^bb0(%a : _, %b : _):
  %v1 = llvm.icmp.sgt %a, %b : i1
  %v2 = llvm.icmp.ne %a, %b : i1
...
^bb0(%a : _, %b : _):
  %v1 = llvm.mlir.constant 0 : _
  %v2 = llvm.icmp.eq %a, %v1 : i1
  %v3 = llvm.mlir.constant 0 : _
  %v4 = llvm.icmp.eq %b, %v3 : i1
...
^bb0(%a : _, %b : _):
  %v1 = llvm.or %a, %b : i1
  %v2 = llvm.mlir.constant 0 : _
  %v3 = llvm.icmp.eq %a, %v2 : i1
  %v4 = llvm.mlir.constant 0 : _
  %v5 = llvm.icmp.eq %b, %v4 : i1
  %v6 = llvm.mlir.constant 0 : _
  %v7 = llvm.icmp.eq %v1, %v6 : i1
  llvm.return %v7 : i1
}]
...
[alive_icom ()| {
^bb0(%a : _, %C1 : _):
  %v1 = llvm.icmp.eq %a, %C1 : i1
  %v2 = llvm.icmp.ne %a, %C1 : i1
  %v3 = llvm.and %v1, %v2 : i1
  llvm.return %v3 : i1
}]
...
^bb0(%notOp0 : _, %notOp1 : _):
  %v1 = llvm.mlir.constant -1 : _
  %v2 = llvm.xor %notOp0, %v1 : _
  %v3 = llvm.mlir.constant -1 : _
  %v4 = llvm.xor %notOp1, %v3 : _
  %v5 = llvm.and %v2, %v4 : _
  llvm.return %v5 : _
}]
...
[alive_icom ( w )| {
^bb0(%notOp0 : _, %notOp1 : _):
  %v1 = llvm.or %notOp0, %notOp1 : _
  %v2 = llvm.mlir.constant -1 : _
  %v3 = llvm.xor %notOp0, %v2 : _
  %v4 = llvm.mlir.constant -1 : _
  %v5 = llvm.xor %notOp1, %v4 : _
  %v6 = llvm.mlir.constant -1 : _
  %v7 = llvm.xor %v1, %v6 : _
  llvm.return %v7 : _
}]
...
[alive_icom ()| {
^bb0(%a : _, %b : _):
  %v1 = llvm.icmp.ugt %a, %b : i1
  %v2 = llvm.icmp.eq %a, %b : i1
  %v3 = llvm.or %v1, %v2 : i1
  llvm.return %v3 : i1
}]
...
^bb0(%B : _, %A : _):
  %v1 = llvm.mlir.constant 0 : _
  %v2 = llvm.icmp.eq %B, %v1 : i1
  %v3 = llvm.icmp.ult %A, %B : i1
  %v4 = llvm.or %v2, %v3 : i1
  llvm.return %v4 : i1
}]
...
^bb0(%B : _, %A : _):
  ...
  %v3 = llvm.mlir.constant 0 : _
  %v4 = llvm.icmp.eq %B, %v3 : i1
  %v5 = llvm.icmp.ult %A, %B : i1
  %v6 = llvm.icmp.uge %v2, %A : i1
  llvm.return %v6 : i1
}]
...
^bb0(%A : _, %B : _):
  %v1 = llvm.mlir.constant 0 : _
  %v2 = llvm.icmp.ne %A, %v1 : i1
  %v3 = llvm.mlir.constant 0 : _
  %v4 = llvm.icmp.ne %B, %v3 : i1
  %v5 = llvm.or %v2, %v4 : i1
  llvm.return %v5 : i1
}]
...
^bb0(%A : _, %B : _):
  %v1 = llvm.or %A, %B : i1
  %v2 = llvm.mlir.constant 0 : _
  %v3 = llvm.icmp.ne %A, %v2 : i1
  %v4 = llvm.mlir.constant 0 : _
  %v5 = llvm.icmp.ne %B, %v4 : i1
  %v6 = llvm.mlir.constant 0 : _
  %v7 = llvm.icmp.ne %v1, %v6 : i1
  llvm.return %v7 : i1
}]
