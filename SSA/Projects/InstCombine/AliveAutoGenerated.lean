...
^bb0(%A : _, %B : _):
  %v1 = "llvm.icmp.uge" (%A,%B) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (i1)
  %v3 = "llvm.icmp.uge" (%v2,%B) : (_, _) -> (i1)
  %v4 = "llvm.select" (%v3,%v2,%B) : (i1, _, _) -> (i1)
  "llvm.return" (%v4) : (i1) -> ()
}]
...
^bb0(%A : _, %B : _):
  ...
  %v3 = "llvm.icmp.uge" (%v2,%B) : (_, _) -> (i1)
  %v4 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (i1)
  "llvm.return" (%v4) : (i1) -> ()
}]
...
[mlir_icom ( w )| {
^bb0(%A : _, %B : _, %C : i1):
  %v4 = "llvm.select" (%C, %A, %B) : (i1, _, _) -> (i1)
  "llvm.return" (%v4) : (i1) -> ()
}]
...
^bb0(%A : _, %B : _):
  ...
  %v4 = "llvm.select" (%v3,%v2,%A) : (i1, _, _) -> (i1)
  "llvm.return" (%v4) : (i1) -> ()
}]
...
^bb0(%A : _):
  ...
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
  %v10 = "llvm.select" (%v2,%A,%v4) : (i1, _, _) -> (i1)
  "llvm.return" (%v10) : (i1) -> ()
}]
...
^bb0(%A : _):
  ...
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
  %v10 = "llvm.select" (%v7,%v9,%v5) : (i1, _, _) -> (i1)
  "llvm.return" (%v10) : (i1) -> ()
}]
...
^bb0(%A : _):
  ...
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
  %v10 = "llvm.select" (%v2,%v4,%A) : (i1, _, _) -> (i1)
  "llvm.return" (%v10) : (i1) -> ()
}]
