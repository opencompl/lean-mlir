...
^bb0(%y : _, %x : _):
  ...
  %v2 = "llvm.mlir.constant" () { value = -1 : i1 } :() -> (_)
...
^bb0(%Y : i5, %X : i5):
  %v1 = "llvm.sdiv" (%X,%Y) : (i5, i5) -> (i5)
  %v2 = "llvm.mlir.constant" () { value = 0 : i5 } :() -> (_)
...
^bb0(%Y : i5, %X : i5):
  %v1 = "llvm.srem" (%X,%Y) : (i5, i5) -> (i5)
  %v2 = "llvm.sdiv" (%X,%Y) : (i5, i5) -> (i5)
  %v3 = "llvm.mlir.constant" () { value = 0 : i5 } :() -> (_)
...
^bb0(%X : _):
  %v1 = "llvm.mlir.constant" () { value = 1 : _ } :() -> (_)
  %v2 = "llvm.add" (%X,%v1) : (_, _) -> (i1)
  %v3 = "llvm.mlir.constant" () { value = 3 : _ } :() -> (_)
  %v4 = "llvm.icmp.ult" (%v2,%v3) : (_, _) -> (i1)
  %v5 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v6 = "llvm.select" (%v4,%X,%v5) : (i1, _, _) -> (_)
  "llvm.return" (%v6) : (_) -> ()
}]
...
^bb0(%Y : _, %X : _, %C : _):
  %v1 = "llvm.icmp.eq" (%X,%C) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%C,%Y) : (i1, _, _) -> (_)
  "llvm.return" (%v2) : (_) -> ()
}]
theorem alive_Select_637  (w : Nat)   : alive_Select_637_src w  ⊑ alive_Select_637_tgt w  := by
  ...
  simp_alive_peephole <;> sorry
  -- simp[HVector.toTriple, HVector.toTuple]
...
[mlir_icom ( w )| {
^bb0(%Y : _, %X : _, %C : _):
  %v1 = "llvm.icmp.ne" (%X,%C) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%Y,%X) : (i1, _, _) -> (_)
  "llvm.return" (%v2) : (_) -> ()
}]
...
^bb0(%Y : _, %X : _, %C : _):
  %v1 = "llvm.icmp.ne" (%X,%C) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%Y,%C) : (i1, _, _) -> (_)
  "llvm.return" (%v2) : (_) -> ()
}]
...
^bb0(%A : _, %B : _):
  %v1 = "llvm.icmp.uge" (%A,%B) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (_)
  %v3 = "llvm.icmp.uge" (%v2,%B) : (_, _) -> (i1)
  %v4 = "llvm.select" (%v3,%v2,%B) : (i1, _, _) -> (_)
  "llvm.return" (%v4) : (_) -> ()
}]
...
^bb0(%A : _, %B : _):
  ...
  %v2 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (_)
  %v3 = "llvm.icmp.uge" (%v2,%B) : (_, _) -> (i1)
  %v4 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (_)
  "llvm.return" (%v4) : (_) -> ()
}]
...
[mlir_icom ( w )| {
^bb0(%A : _, %B : _):
  %v1 = "llvm.icmp.slt" (%A,%B) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (_)
  %v3 = "llvm.icmp.slt" (%v2,%B) : (_, _) -> (i1)
  %v4 = "llvm.select" (%v3,%v2,%B) : (i1, _, _) -> (_)
  "llvm.return" (%v4) : (_) -> ()
}]
...
^bb0(%A : _, %B : _):
  %v1 = "llvm.icmp.slt" (%A,%B) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (_)
  %v3 = "llvm.icmp.sge" (%v2,%A) : (_, _) -> (i1)
  %v4 = "llvm.select" (%v3,%v2,%A) : (i1, _, _) -> (_)
  "llvm.return" (%v4) : (_) -> ()
}]
...
[mlir_icom ( w )| {
^bb0(%A : _, %B : _):
  %v1 = "llvm.icmp.sge" (%A,%B) : (_, _) -> (i1)
  %v2 = "llvm.select" (%v1,%A,%B) : (i1, _, _) -> (_)
  %v3 = "llvm.icmp.slt" (%v2,%A) : (_, _) -> (i1)
  %v4 = "llvm.select" (%v3,%v2,%A) : (i1, _, _) -> (_)
  "llvm.return" (%v4) : (_) -> ()
}]
...
^bb0(%A : _):
  %v1 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v2 = "llvm.icmp.sgt" (%A,%v1) : (_, _) -> (i1)
  %v3 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v4 = "llvm.sub" (%v3,%A) : (_, _) -> (i1)
  %v5 = "llvm.select" (%v2,%A,%v4) : (i1, _, _) -> (_)
  %v6 = "llvm.mlir.constant" () { value = -1 : _ } :() -> (_)
  %v7 = "llvm.icmp.sgt" (%v5,%v6) : (_, _) -> (i1)
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
  %v10 = "llvm.select" (%v7,%v5,%v9) : (i1, _, _) -> (_)
  "llvm.return" (%v10) : (_) -> ()
}]
...
^bb0(%A : _):
  ...
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
  %v10 = "llvm.select" (%v2,%A,%v4) : (i1, _, _) -> (_)
  "llvm.return" (%v10) : (_) -> ()
}]
...
^bb0(%A : _):
  ...
  %v3 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v4 = "llvm.sub" (%v3,%A) : (_, _) -> (i1)
  %v5 = "llvm.select" (%v2,%v4,%A) : (i1, _, _) -> (i1)
  %v6 = "llvm.mlir.constant" () { value = -1 : _ } :() -> (_)
  %v7 = "llvm.icmp.sgt" (%v5,%v6) : (_, _) -> (i1)
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
  %v10 = "llvm.select" (%v7,%v9,%v5) : (i1, _, _) -> (_)
  "llvm.return" (%v10) : (_) -> ()
}]
...
^bb0(%A : _):
  ...
  %v3 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v4 = "llvm.sub" (%v3,%A) : (_, _) -> (i1)
  %v5 = "llvm.select" (%v2,%v4,%A) : (i1, _, _) -> (_)
  %v6 = "llvm.mlir.constant" () { value = -1 : _ } :() -> (_)
  %v7 = "llvm.icmp.sgt" (%v5,%v6) : (_, _) -> (i1)
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
  %v10 = "llvm.select" (%v2,%v4,%A) : (i1, _, _) -> (_)
  "llvm.return" (%v10) : (_) -> ()
}]
theorem alive_Select_741  (w : Nat)   : alive_Select_741_src w  ⊑ alive_Select_741_tgt w  := by
...
^bb0(%A : _):
  %v1 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v2 = "llvm.sub" (%v1,%A) : (_, _) -> (i1)
  %v3 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v4 = "llvm.icmp.sgt" (%A,%v3) : (_, _) -> (i1)
  %v5 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v6 = "llvm.icmp.slt" (%A,%v5) : (_, _) -> (i1)
  %v7 = "llvm.select" (%v6,%A,%v2) : (i1, _, _) -> (_)
  %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v9 = "llvm.icmp.sgt" (%v7,%v8) : (_, _) -> (i1)
  %v10 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
  %v11 = "llvm.sub" (%v10,%v7) : (_, _) -> (_)
  %v12 = "llvm.select" (%v4,%A,%v2) : (i1, _, _) -> (_)
  "llvm.return" (%v12) : (_) -> ()
}]
...
--   %v3 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
--   %v4 = "llvm.sub" (%v3,%A) : (_, _) -> (i1)
--   %v5 = "llvm.select" (%v2,%A,%v4) : (i1, _, _) -> (i1)
--   %v6 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
--   %v7 = "llvm.icmp.slt" (%v5,%v6) : (_, _) -> (i1)
--   %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
--   %v9 = "llvm.sub" (%v8,%v5) : (_, _) -> (_)
--   %v10 = "llvm.select" (%v7,%v5,%v9) : (i1, _, _) -> (i1)
--   "llvm.return" (%v10) : (i1) -> ()
-- }]
...
--   %v2 = "llvm.sub" (%v1,%A) : (_, _) -> (i1)
--   %v3 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
--   %v4 = "llvm.icmp.slt" (%A,%v3) : (_, _) -> (i1)
--   %v5 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
--   %v6 = "llvm.icmp.sgt" (%A,%v5) : (_, _) -> (i1)
--   %v7 = "llvm.select" (%v6,%A,%v2) : (i1, _, _) -> (_)
--   %v8 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
--   %v9 = "llvm.icmp.slt" (%v7,%v8) : (_, _) -> (i1)
--   %v10 = "llvm.mlir.constant" () { value = 0 : _ } :() -> (_)
--   %v11 = "llvm.sub" (%v10,%v7) : (_, _) -> (_)
--   %v12 = "llvm.select" (%v4,%A,%v2) : (i1, _, _) -> (i1)
--   "llvm.return" (%v12) : (i1) -> ()
-- }]
...
--   %v2 = "llvm.xor" (%val,%v1) : (_, i1) -> (i1)
--   %v3 = "llvm.select" (%v2,%X,%Y) : (i1, _, _) -> (_)
--   "llvm.return" (%v3) : (_) -> ()
-- }]
