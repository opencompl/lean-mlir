...
#check HVector TyDenote.toType [toRISCV.Ty.bv]
#check HVector -- returns a function from List α to lub type universe of both types.

def lh : HVector TyDenote.toType [toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 1) .nil
...
def lh4 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 2) <| HVector.cons (BitVec.ofNat 64 2) .nil --checking edge cases
...
def RISCVEg5 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.srlw" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh5 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 32) <| HVector.cons (BitVec.ofNat 64 1) .nil --checking edge cases
...
def RISCVEg6 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.sraw" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh6 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 (16)) <| HVector.cons (BitVec.ofNat 64 2) .nil --checking edge cases
...
def lh7 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 1) <| HVector.cons (BitVec.ofNat 64 19) .nil
...
def RISCVEg8 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.slt" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]

--testing the sign behavior edge cases , but this test should be true in the unisgned case
def lh8 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 0) <| HVector.cons (BitVec.ofNat 64 (1)) .nil--checking edge cases
...
def RISCVEg9 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.sltu" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh9 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 9223372036854775808) <| HVector.cons (BitVec.ofNat 64 (18446744073709551615)) .nil --18444 <= 92-- yields tue
...
--bitwise and
def lh10 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 7) <| HVector.cons (BitVec.ofNat 64 (7)) .nil --18444 <= 92-- yields tue
--def lh9 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 10) <| HVector.cons (BitVec.ofNat 64 12) .nil --checking edge cases
...
def RISCVEg11 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.or" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh11 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 1) <| HVector.cons (BitVec.ofNat 64 (2)) .nil --18444 <= 92-- yields tue
--def lh9 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 10) <| HVector.cons (BitVec.ofNat 64 12) .nil --checking edge cases
...
def RISCVEg12 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.xor" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh12 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 1) <| HVector.cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg13 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.sll" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh13 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 1) <| HVector.cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg14 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.srl" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh14 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 1) <| HVector.cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg16 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.addiw" (%0) { imm = 19 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh16 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg17 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.lui" (%0) { imm = 19 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh17 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg18 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.auipc" (%0) { imm = 19 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh18 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
...
def lh19 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
def test_slliw : BitVec 64 := RISCVEg19.denote  (Ctxt.Valuation.ofHVector lh18)
#eval test_slliw

def RISCVEg20 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.srliw" (%0) { shamt = 19 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh20 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
def test_srliw : BitVec 64 := RISCVEg20.denote  (Ctxt.Valuation.ofHVector lh20)
#eval test_srliw

def RISCVEg21 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.sraiw" (%0) { shamt = 19 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh21 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg22 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.slli" (%0) { shamt = 19 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh22 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg23 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.srli" (%0) { shamt = 0 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh23 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg26 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.mulw" (%0, %1)  : ( !i64, !i64 ) -> (!i64)
    "return" (%2) : ( !i64, !i64 ) -> ()
}]
def lh26 : HVector TyDenote.toType [toRISCV.Ty.bv, toRISCV.Ty.bv] := HVector.cons (BitVec.ofNat 64 7) <| HVector.cons (BitVec.ofNat 64 8) .nil
...
def RISCVEg29 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.addi" (%0)  { imm = 10 : !i64 } : ( !i64 ) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh29 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 8) .nil
...
def RISCVEg30 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.slti" (%0)  { imm = 10 : !i64 } : ( !i64 ) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh30 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 1) .nil
...
def RISCVEg31 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.sltiu" (%0)  { imm = 10 : !i64 } : ( !i64 ) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh31 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 8) .nil
...
def RISCVEg32 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.andi" (%0)  { imm = 15 : !i64 } : ( !i64 ) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh32 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 16) .nil
...
def RISCVEg33 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.ori" (%0)  { imm = 10 : !i64 } : ( !i64 ) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh33 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 8) .nil
...
def RISCVEg34 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.xori" (%0)  { imm = 7 : !i64 } : ( !i64 ) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh34 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 2) .nil
...
def RISCVEg36 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64 ):
    %2 = "RV64.czero.nez" (%0, %1) : (!i64, !i64) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh36 : HVector TyDenote.toType [toRISCV.Ty.bv ,toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 19) <| HVector.cons (BitVec.ofNat 64 0) .nil
...
def RISCVEg37 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.sext.b" (%0) : ( !i64) -> (!i64)
    "return" (%2) : (!i64 ) -> ()
}]
def lh37 : HVector TyDenote.toType [toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 0) .nil
...
def RISCVEg38 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.sext.h" (%0) : ( !i64) -> (!i64)
    "return" (%2) : (!i64 ) -> ()
}]
def lh38 : HVector TyDenote.toType [toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 (1)) .nil
...
def RISCVEg39 := [RV64_com| {
  ^entry (%0: !i64):
    %2 = "RV64.zext.h" (%0) : ( !i64) -> (!i64)
    "return" (%2) : (!i64 ) -> ()
}]
def lh39 : HVector TyDenote.toType [toRISCV.Ty.bv] :=  HVector.cons (BitVec.ofNat 64 5) .nil
...
def RISCVEg40 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64):
    %2 = "RV64.bclr" (%0, %1) : ( !i64,!i64 ) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh40 : HVector TyDenote.toType [toRISCV.Ty.bv, toRISCV.Ty.bv ] := HVector.cons (BitVec.ofNat 64 8) <| HVector.cons (BitVec.ofNat 64 3) .nil
...
def RISCVEg41 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64):
    %2 = "RV64.bext" (%0, %1) : ( !i64,!i64 ) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh41 : HVector TyDenote.toType [toRISCV.Ty.bv, toRISCV.Ty.bv ] := HVector.cons (BitVec.ofNat 64 3) <| HVector.cons (BitVec.ofNat 64 2) .nil
...
def RISCVEg42 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64):
    %2 = "RV64.binv" (%0, %1) : ( !i64, !i64 ) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh42 : HVector TyDenote.toType [toRISCV.Ty.bv, toRISCV.Ty.bv ] := HVector.cons (BitVec.ofNat 64 0) <| HVector.cons (BitVec.ofNat 64 0) .nil
...
def RISCVEg43 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64):
    %2 = "RV64.bset" (%0, %1) : ( !i64, !i64 ) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh43 : HVector TyDenote.toType [toRISCV.Ty.bv, toRISCV.Ty.bv ] := HVector.cons (BitVec.ofNat 64 1) <| HVector.cons (BitVec.ofNat 64 0) .nil
...
def RISCVEg44 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64):
    %2 = "RV64.rolw" (%0, %1) : ( !i64, !i64 ) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh44 : HVector TyDenote.toType [toRISCV.Ty.bv, toRISCV.Ty.bv ] := HVector.cons (BitVec.ofNat 64 64) <| HVector.cons (BitVec.ofNat 64 4) .nil
...
def RISCVEg45 := [RV64_com| {
  ^entry (%0: !i64, %1: !i64):
    %2 = "RV64.rorw" (%0, %1) : ( !i64, !i64 ) -> (!i64)
    "return" (%2) : (!i64, !i64 ) -> ()
}]
def lh45 : HVector TyDenote.toType [toRISCV.Ty.bv, toRISCV.Ty.bv ] := HVector.cons (BitVec.ofNat 64 64) <| HVector.cons (BitVec.ofNat 64 4) .nil
...
def RISCVEg46 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.bclri" (%0) { imm = 1 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh46 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 7) .nil
...
def RISCVEg47 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.bexti" (%0) { imm = 63 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh47 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 7) .nil
...
def RISCVEg48 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.binvi" (%0) { imm = 2 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh48 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 0) .nil
...
def RISCVEg49 := [RV64_com| {
  ^entry (%0 : !i64 ):
    %2 = "RV64.bseti" (%0) { imm = 63 : !i64 } : ( !i64) -> (!i64)
    "return" (%2) : ( !i64 ) -> ()
}]
def lh49 : HVector TyDenote.toType [toRISCV.Ty.bv] := .cons (BitVec.ofNat 64 0) .nil
