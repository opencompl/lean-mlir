...
def attributesToPrint: RISCV64.Op → String
  ...
  | .srliw (_shamt : BitVec 5) => s!"\{immediate = { _shamt.toInt} : i5 }"
  | .sraiw (_shamt : BitVec 5) => s!"\{immediate = { _shamt.toInt} :i5 }"
  | .slli (_shamt : BitVec 6) => s!"\{immediate = { _shamt.toInt} : i6 }"
  | .srli (_shamt : BitVec 6) => s!"\{immediate = { _shamt.toInt} : i6 }"
  | .srai (_shamt : BitVec 6) => s!"\{immediate = { _shamt.toInt} : i6 }"
  ...
  | .bexti (_shamt : BitVec 6) =>s!"\{imm = { _shamt.toInt} : i6 }"
  | .binvi (_shamt : BitVec 6) => s!"\{imm = { _shamt.toInt} : i6 }"
  | .bseti (_shamt : BitVec 6) => s!"\{imm = { _shamt.toInt} : i6 }"
  | RISCV64.Op.slli.uw (_shamt : BitVec 6) => s!"\{imm = { _shamt.toInt} : i6 }"
  | .rori (_shamt : BitVec 5) => s!"\{imm = { _shamt.toInt} : i5 }"
  | .roriw (_shamt : BitVec 5) => s!"\{imm = { _shamt.toInt} : i5 }"
  | _ => ""
