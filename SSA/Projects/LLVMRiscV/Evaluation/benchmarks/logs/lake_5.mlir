...
info: SSA/Projects/LLVMRiscV/Pipeline/sext.lean:188:2: final right-hand-side of equality is: Γv
    (Ctxt.Var.last (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16))])
      (Ty.riscv RISCV64.Ty.bv))::ₕriscvArgsFromHybrid HVector.nil
✖ [1094/1107] Building SSA.Projects.LLVMRiscV.Pipeline.and (240ms)
...
✖ [1096/1108] Building SSA.Projects.LLVMRiscV.Pipeline.mul (282ms)
...
error: Lean exited with code 1
ℹ [1097/1137] Replayed SSA.Projects.LLVMRiscV.Pipeline.urem
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
ℹ [1098/1137] Replayed SSA.Projects.LLVMRiscV.Pipeline.xor
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
✔ [2220/2256] Built SSA.Projects.LLVMRiscV.Pipeline.ReconcileCast (9.4s)
...
ℹ [2224/2256] Built SSA.Projects.LLVMRiscV.Pipeline.srl (15s)
...
⚠ [2228/2256] Built SSA.Projects.LLVMRiscV.Pipeline.udiv (16s)
...
ℹ [2230/2256] Built SSA.Projects.LLVMRiscV.Pipeline.zext (18s)
...
info: SSA/Projects/LLVMRiscV/Pipeline/zext.lean:178:2: final right-hand-side of equality is: Γv
    (Ctxt.Var.last (↑[Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16))])
      (Ty.riscv RISCV64.Ty.bv))::ₕriscvArgsFromHybrid HVector.nil
✖ [2231/2256] Building SSA.Projects.LLVMRiscV.Pipeline.zext:c.o (313ms)
...
0  libLLVM.so.19.1      0x00007e5b38bae468 llvm::sys::PrintStackTrace(llvm::raw_ostream&, int) + 40
1  libLLVM.so.19.1      0x00007e5b38bac0de llvm::sys::RunSignalHandlers() + 238
2  libLLVM.so.19.1      0x00007e5b38bad8ef llvm::sys::CleanupOnSignal(unsigned long) + 255
3  libLLVM.so.19.1      0x00007e5b38afa8f9
4  libc.so.6            0x00007e5b37c45330
5  libclang-cpp.so.19.1 0x00007e5b3d2d3088 clang::Lexer::LexTokenInternal(clang::Token&, bool) + 104
6  libclang-cpp.so.19.1 0x00007e5b3d33ff0d clang::Preprocessor::Lex(clang::Token&) + 45
7  libclang-cpp.so.19.1 0x00007e5b3d34fc19
8  libclang-cpp.so.19.1 0x00007e5b3d369c00 clang::Parser::ParseDeclarationSpecifiers(clang::DeclSpec&, clang::Parser::ParsedTemplateInfo&, clang::AccessSpecifier, clang::Parser::DeclSpecContext, clang::Parser::LateParsedAttrList*, clang::ImplicitTypenameContext) + 16976
9  libclang-cpp.so.19.1 0x00007e5b3d4355ad clang::Parser::ParseDeclOrFunctionDefInternal(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec&, clang::AccessSpecifier) + 173
10 libclang-cpp.so.19.1 0x00007e5b3d435300 clang::Parser::ParseDeclarationOrFunctionDefinition(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*, clang::AccessSpecifier) + 576
11 libclang-cpp.so.19.1 0x00007e5b3d4344ed clang::Parser::ParseExternalDeclaration(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*) + 1997
12 libclang-cpp.so.19.1 0x00007e5b3d4326b3 clang::Parser::ParseTopLevelDecl(clang::OpaquePtr<clang::DeclGroupRef>&, clang::Sema::ModuleImportState&) + 1459
13 libclang-cpp.so.19.1 0x00007e5b3d34846e clang::ParseAST(clang::Sema&, bool, bool) + 830
14 libclang-cpp.so.19.1 0x00007e5b3f6b9b96 clang::FrontendAction::Execute() + 86
15 libclang-cpp.so.19.1 0x00007e5b3f630614 clang::CompilerInstance::ExecuteAction(clang::FrontendAction&) + 996
16 libclang-cpp.so.19.1 0x00007e5b3f7358fe clang::ExecuteCompilerInvocation(clang::CompilerInstance*) + 894
17 clang                0x00005d3d118d51ef cc1_main(llvm::ArrayRef<char const*>, char const*, void*) + 5759
18 clang                0x00005d3d118d2080
19 libclang-cpp.so.19.1 0x00007e5b3f29afd9
20 libLLVM.so.19.1      0x00007e5b38afa6d8 llvm::CrashRecoveryContext::RunSafely(llvm::function_ref<void ()>) + 136
21 libclang-cpp.so.19.1 0x00007e5b3f29a855 clang::driver::CC1Command::Execute(llvm::ArrayRef<std::__1::optional<llvm::StringRef>>, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>*, bool*) const + 325
22 libclang-cpp.so.19.1 0x00007e5b3f25ee98 clang::driver::Compilation::ExecuteCommand(clang::driver::Command const&, clang::driver::Command const*&, bool) const + 1000
23 libclang-cpp.so.19.1 0x00007e5b3f25f11e clang::driver::Compilation::ExecuteJobs(clang::driver::JobList const&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&, bool) const + 126
24 libclang-cpp.so.19.1 0x00007e5b3f27c78c clang::driver::Driver::ExecuteCompilation(clang::driver::Compilation&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&) + 348
25 clang                0x00005d3d118d1623 clang_main(int, char**, llvm::ToolContext const&) + 5971
26 clang                0x00005d3d118dea77 main + 87
27 libc.so.6            0x00007e5b37c2a1ca
28 libc.so.6            0x00007e5b37c2a28b __libc_start_main + 139
29 clang                0x00005d3d118cfb9e _start + 46
...
clang: note: diagnostic msg: /tmp/zext-4351c0.c
clang: note: diagnostic msg: /tmp/zext-4351c0.sh
clang: note: diagnostic msg: 
...
ℹ [2232/2256] Built SSA.Projects.LLVMRiscV.Pipeline.or (22s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
✔ [2235/2256] Built SSA.Projects.LLVMRiscV.Pipeline.ashr:c.o (1.1s)
ℹ [2236/2256] Built SSA.Projects.LLVMRiscV.Pipeline.select (28s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv,
              ...
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 1))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
ℹ [2238/2256] Built SSA.Projects.LLVMRiscV.Pipeline.sub (29s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
✖ [2240/2256] Building SSA.Projects.LLVMRiscV.Pipeline.add (30s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
✖ [2243/2256] Building SSA.Projects.LLVMRiscV.Pipeline.shl:c.o (57ms)
...
Stack dump without symbol names (ensure you have llvm-symbolizer in your PATH or set the environment var `LLVM_SYMBOLIZER_PATH` to point to it):
0  libLLVM.so.19.1      0x0000715fcdbae468 llvm::sys::PrintStackTrace(llvm::raw_ostream&, int) + 40
1  libLLVM.so.19.1      0x0000715fcdbac0de llvm::sys::RunSignalHandlers() + 238
2  libLLVM.so.19.1      0x0000715fcdbad8ef llvm::sys::CleanupOnSignal(unsigned long) + 255
3  libLLVM.so.19.1      0x0000715fcdafa8f9
4  libc.so.6            0x0000715fccc45330
5  libclang-cpp.so.19.1 0x0000715fd22d3088 clang::Lexer::LexTokenInternal(clang::Token&, bool) + 104
6  libclang-cpp.so.19.1 0x0000715fd233ff0d clang::Preprocessor::Lex(clang::Token&) + 45
7  libclang-cpp.so.19.1 0x0000715fd2362fbf
8  libclang-cpp.so.19.1 0x0000715fd2348e38
9  libclang-cpp.so.19.1 0x0000715fd241a310 clang::Parser::ParseCompoundStatementBody(bool) + 2992
10 libclang-cpp.so.19.1 0x0000715fd241af87 clang::Parser::ParseFunctionStatementBody(clang::Decl*, clang::Parser::ParseScope&) + 167
11 libclang-cpp.so.19.1 0x0000715fd2436a8e clang::Parser::ParseFunctionDefinition(clang::ParsingDeclarator&, clang::Parser::ParsedTemplateInfo const&, clang::Parser::LateParsedAttrList*) + 4030
12 libclang-cpp.so.19.1 0x0000715fd23629fc clang::Parser::ParseDeclGroup(clang::ParsingDeclSpec&, clang::DeclaratorContext, clang::ParsedAttributes&, clang::Parser::ParsedTemplateInfo&, clang::SourceLocation*, clang::Parser::ForRangeInit*) + 6764
13 libclang-cpp.so.19.1 0x0000715fd24358d7 clang::Parser::ParseDeclOrFunctionDefInternal(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec&, clang::AccessSpecifier) + 983
14 libclang-cpp.so.19.1 0x0000715fd2435300 clang::Parser::ParseDeclarationOrFunctionDefinition(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*, clang::AccessSpecifier) + 576
15 libclang-cpp.so.19.1 0x0000715fd24344ed clang::Parser::ParseExternalDeclaration(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*) + 1997
16 libclang-cpp.so.19.1 0x0000715fd24326b3 clang::Parser::ParseTopLevelDecl(clang::OpaquePtr<clang::DeclGroupRef>&, clang::Sema::ModuleImportState&) + 1459
17 libclang-cpp.so.19.1 0x0000715fd234846e clang::ParseAST(clang::Sema&, bool, bool) + 830
18 libclang-cpp.so.19.1 0x0000715fd46b9b96 clang::FrontendAction::Execute() + 86
19 libclang-cpp.so.19.1 0x0000715fd4630614 clang::CompilerInstance::ExecuteAction(clang::FrontendAction&) + 996
20 libclang-cpp.so.19.1 0x0000715fd47358fe clang::ExecuteCompilerInvocation(clang::CompilerInstance*) + 894
21 clang                0x0000584bcc6d91ef cc1_main(llvm::ArrayRef<char const*>, char const*, void*) + 5759
22 clang                0x0000584bcc6d6080
23 libclang-cpp.so.19.1 0x0000715fd429afd9
24 libLLVM.so.19.1      0x0000715fcdafa6d8 llvm::CrashRecoveryContext::RunSafely(llvm::function_ref<void ()>) + 136
25 libclang-cpp.so.19.1 0x0000715fd429a855 clang::driver::CC1Command::Execute(llvm::ArrayRef<std::__1::optional<llvm::StringRef>>, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>*, bool*) const + 325
26 libclang-cpp.so.19.1 0x0000715fd425ee98 clang::driver::Compilation::ExecuteCommand(clang::driver::Command const&, clang::driver::Command const*&, bool) const + 1000
27 libclang-cpp.so.19.1 0x0000715fd425f11e clang::driver::Compilation::ExecuteJobs(clang::driver::JobList const&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&, bool) const + 126
28 libclang-cpp.so.19.1 0x0000715fd427c78c clang::driver::Driver::ExecuteCompilation(clang::driver::Compilation&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&) + 348
29 clang                0x0000584bcc6d5623 clang_main(int, char**, llvm::ToolContext const&) + 5971
30 clang                0x0000584bcc6e2a77 main + 87
31 libc.so.6            0x0000715fccc2a1ca
32 libc.so.6            0x0000715fccc2a28b __libc_start_main + 139
33 clang                0x0000584bcc6d3b9e _start + 46
clang: error: clang frontend command failed with exit code 135 (use -v to see invocation)
clang version 19.1.2 (https://github.com/llvm/llvm-project 7ba7d8e2f7b6445b60679da826210cdde29eaf8b)
Target: x86_64-unknown-linux-gnu
Thread model: posix
...
PLEASE ATTACH THE FOLLOWING FILES TO THE BUG REPORT:
Preprocessed source(s) and associated run script(s) are located at:
clang: note: diagnostic msg: /tmp/shl-ca06d8.c
clang: note: diagnostic msg: /tmp/shl-ca06d8.sh
clang: note: diagnostic msg: 
...
info: SSA/Projects/LLVMRiscV/Pipeline/icmp.lean:458:2: final right-hand-side of equality is: Γv
    (Ctxt.Var.last
      (↑[Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv,
          ...
          Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 32))])
      (Ty.riscv RISCV64.Ty.bv))::ₕriscvArgsFromHybrid (Γv ⟨1, icmp_ugt_riscv_i64._proof_3⟩::ₕHVector.nil)
✖ [2245/2256] Building SSA.Projects.LLVMRiscV.Pipeline.icmp:c.o (81ms)
...
1.	<unknown> parser at unknown location
Stack dump without symbol names (ensure you have llvm-symbolizer in your PATH or set the environment var `LLVM_SYMBOLIZER_PATH` to point to it):
0  libLLVM.so.19.1      0x00007edbab9ae468 llvm::sys::PrintStackTrace(llvm::raw_ostream&, int) + 40
1  libLLVM.so.19.1      0x00007edbab9ac0de llvm::sys::RunSignalHandlers() + 238
2  libLLVM.so.19.1      0x00007edbab9ad8ef llvm::sys::CleanupOnSignal(unsigned long) + 255
3  libLLVM.so.19.1      0x00007edbab8fa8f9
4  libc.so.6            0x00007edbaaa45330
5  libclang-cpp.so.19.1 0x00007edbb00d3088 clang::Lexer::LexTokenInternal(clang::Token&, bool) + 104
6  libclang-cpp.so.19.1 0x00007edbb013ff0d clang::Preprocessor::Lex(clang::Token&) + 45
7  libclang-cpp.so.19.1 0x00007edbb01662af clang::Parser::ParseDeclarationSpecifiers(clang::DeclSpec&, clang::Parser::ParsedTemplateInfo&, clang::AccessSpecifier, clang::Parser::DeclSpecContext, clang::Parser::LateParsedAttrList*, clang::ImplicitTypenameContext) + 2303
8  libclang-cpp.so.19.1 0x00007edbb02355ad clang::Parser::ParseDeclOrFunctionDefInternal(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec&, clang::AccessSpecifier) + 173
9  libclang-cpp.so.19.1 0x00007edbb0235300 clang::Parser::ParseDeclarationOrFunctionDefinition(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*, clang::AccessSpecifier) + 576
10 libclang-cpp.so.19.1 0x00007edbb02344ed clang::Parser::ParseExternalDeclaration(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*) + 1997
11 libclang-cpp.so.19.1 0x00007edbb02326b3 clang::Parser::ParseTopLevelDecl(clang::OpaquePtr<clang::DeclGroupRef>&, clang::Sema::ModuleImportState&) + 1459
12 libclang-cpp.so.19.1 0x00007edbb014846e clang::ParseAST(clang::Sema&, bool, bool) + 830
13 libclang-cpp.so.19.1 0x00007edbb24b9b96 clang::FrontendAction::Execute() + 86
14 libclang-cpp.so.19.1 0x00007edbb2430614 clang::CompilerInstance::ExecuteAction(clang::FrontendAction&) + 996
15 libclang-cpp.so.19.1 0x00007edbb25358fe clang::ExecuteCompilerInvocation(clang::CompilerInstance*) + 894
16 clang                0x00005eea811f01ef cc1_main(llvm::ArrayRef<char const*>, char const*, void*) + 5759
17 clang                0x00005eea811ed080
18 libclang-cpp.so.19.1 0x00007edbb209afd9
19 libLLVM.so.19.1      0x00007edbab8fa6d8 llvm::CrashRecoveryContext::RunSafely(llvm::function_ref<void ()>) + 136
20 libclang-cpp.so.19.1 0x00007edbb209a855 clang::driver::CC1Command::Execute(llvm::ArrayRef<std::__1::optional<llvm::StringRef>>, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>*, bool*) const + 325
21 libclang-cpp.so.19.1 0x00007edbb205ee98 clang::driver::Compilation::ExecuteCommand(clang::driver::Command const&, clang::driver::Command const*&, bool) const + 1000
22 libclang-cpp.so.19.1 0x00007edbb205f11e clang::driver::Compilation::ExecuteJobs(clang::driver::JobList const&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&, bool) const + 126
23 libclang-cpp.so.19.1 0x00007edbb207c78c clang::driver::Driver::ExecuteCompilation(clang::driver::Compilation&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&) + 348
24 clang                0x00005eea811ec623 clang_main(int, char**, llvm::ToolContext const&) + 5971
25 clang                0x00005eea811f9a77 main + 87
26 libc.so.6            0x00007edbaaa2a1ca
27 libc.so.6            0x00007edbaaa2a28b __libc_start_main + 139
28 clang                0x00005eea811eab9e _start + 46
clang: error: clang frontend command failed with exit code 135 (use -v to see invocation)
clang version 19.1.2 (https://github.com/llvm/llvm-project 7ba7d8e2f7b6445b60679da826210cdde29eaf8b)
Target: x86_64-unknown-linux-gnu
Thread model: posix
...
PLEASE ATTACH THE FOLLOWING FILES TO THE BUG REPORT:
Preprocessed source(s) and associated run script(s) are located at:
clang: note: diagnostic msg: /tmp/icmp-807c7e.c
clang: note: diagnostic msg: /tmp/icmp-807c7e.sh
clang: note: diagnostic msg: 

********************
error: external command '/home/lc985/.elan/toolchains/leanprover--lean4-nightly---nightly-2025-08-06/bin/clang' exited with code 1
✖ [2246/2256] Building SSA.Projects.LLVMRiscV.Pipeline.pseudo (1.5s)
