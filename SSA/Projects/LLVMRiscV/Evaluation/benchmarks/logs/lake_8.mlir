⚠ [1090/1103] Replayed SSA.Projects.LLVMRiscV.PeepholeRefine
warning: SSA/Projects/LLVMRiscV/PeepholeRefine.lean:57:4: declaration uses 'sorry'
✖ [1093/1110] Building SSA.Projects.LLVMRiscV.Pipeline.ReconcileCast (255ms)
...
✖ [1094/1110] Building SSA.Projects.LLVMRiscV.Pipeline.or (233ms)
...
error: Lean exited with code 1
ℹ [1095/1110] Replayed SSA.Projects.LLVMRiscV.Pipeline.sext
...
info: SSA/Projects/LLVMRiscV/Pipeline/sext.lean:188:2: final right-hand-side of equality is: Γv
    (Ctxt.Var.last (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16))])
      (Ty.riscv RISCV64.Ty.bv))::ₕriscvArgsFromHybrid HVector.nil
ℹ [1097/1110] Replayed SSA.Projects.LLVMRiscV.Pipeline.urem
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
ℹ [1098/1110] Replayed SSA.Projects.LLVMRiscV.Pipeline.xor
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 64))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
✔ [2221/2256] Built SSA.Projects.LLVMRiscV.Pipeline.rem:c.o (1.3s)
ℹ [2222/2256] Built SSA.Projects.LLVMRiscV.Pipeline.srl (12s)
...
✔ [2225/2256] Built SSA.Projects.LLVMRiscV.Pipeline.sdiv:c.o (663ms)
⚠ [2226/2256] Built SSA.Projects.LLVMRiscV.Pipeline.udiv (16s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 32)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 32))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
ℹ [2230/2256] Built SSA.Projects.LLVMRiscV.Pipeline.zext (19s)
...
info: SSA/Projects/LLVMRiscV/Pipeline/zext.lean:178:2: final right-hand-side of equality is: Γv
    (Ctxt.Var.last (↑[Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16))])
      (Ty.riscv RISCV64.Ty.bv))::ₕriscvArgsFromHybrid HVector.nil
ℹ [2232/2256] Built SSA.Projects.LLVMRiscV.Pipeline.ashr (24s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
✔ [2233/2256] Built SSA.Projects.LLVMRiscV.Pipeline.ashr:c.o (60ms)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv, Ty.riscv RISCV64.Ty.bv,
              ...
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 1))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
ℹ [2236/2256] Built SSA.Projects.LLVMRiscV.Pipeline.sub (28s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 16))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
ℹ [2238/2256] Built SSA.Projects.LLVMRiscV.Pipeline.mul (30s)
    ...
    (Γv
        (Ctxt.Var.last
          (↑[Ty.riscv RISCV64.Ty.bv, Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8)),
              Ty.llvm (InstCombine.MTy.bitvec (ConcreteOrMVar.concrete 8))])
          (Ty.riscv RISCV64.Ty.bv))::ₕHVector.nil)
✖ [2244/2256] Building SSA.Projects.LLVMRiscV.Pipeline.icmp:c.o (94ms)
...
0  libLLVM.so.19.1      0x000076bcd0bae468 llvm::sys::PrintStackTrace(llvm::raw_ostream&, int) + 40
1  libLLVM.so.19.1      0x000076bcd0bac0de llvm::sys::RunSignalHandlers() + 238
2  libLLVM.so.19.1      0x000076bcd0bad8ef llvm::sys::CleanupOnSignal(unsigned long) + 255
3  libLLVM.so.19.1      0x000076bcd0afa8f9
4  libc.so.6            0x000076bccfc45330
5  libclang-cpp.so.19.1 0x000076bcd52d3088 clang::Lexer::LexTokenInternal(clang::Token&, bool) + 104
6  libclang-cpp.so.19.1 0x000076bcd533ff0d clang::Preprocessor::Lex(clang::Token&) + 45
7  libclang-cpp.so.19.1 0x000076bcd5362fbf
8  libclang-cpp.so.19.1 0x000076bcd5348e38
9  libclang-cpp.so.19.1 0x000076bcd541a310 clang::Parser::ParseCompoundStatementBody(bool) + 2992
10 libclang-cpp.so.19.1 0x000076bcd541af87 clang::Parser::ParseFunctionStatementBody(clang::Decl*, clang::Parser::ParseScope&) + 167
11 libclang-cpp.so.19.1 0x000076bcd5436a8e clang::Parser::ParseFunctionDefinition(clang::ParsingDeclarator&, clang::Parser::ParsedTemplateInfo const&, clang::Parser::LateParsedAttrList*) + 4030
12 libclang-cpp.so.19.1 0x000076bcd53629fc clang::Parser::ParseDeclGroup(clang::ParsingDeclSpec&, clang::DeclaratorContext, clang::ParsedAttributes&, clang::Parser::ParsedTemplateInfo&, clang::SourceLocation*, clang::Parser::ForRangeInit*) + 6764
13 libclang-cpp.so.19.1 0x000076bcd54358d7 clang::Parser::ParseDeclOrFunctionDefInternal(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec&, clang::AccessSpecifier) + 983
14 libclang-cpp.so.19.1 0x000076bcd5435300 clang::Parser::ParseDeclarationOrFunctionDefinition(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*, clang::AccessSpecifier) + 576
15 libclang-cpp.so.19.1 0x000076bcd54344ed clang::Parser::ParseExternalDeclaration(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*) + 1997
16 libclang-cpp.so.19.1 0x000076bcd54326b3 clang::Parser::ParseTopLevelDecl(clang::OpaquePtr<clang::DeclGroupRef>&, clang::Sema::ModuleImportState&) + 1459
17 libclang-cpp.so.19.1 0x000076bcd534846e clang::ParseAST(clang::Sema&, bool, bool) + 830
18 libclang-cpp.so.19.1 0x000076bcd76b9b96 clang::FrontendAction::Execute() + 86
19 libclang-cpp.so.19.1 0x000076bcd7630614 clang::CompilerInstance::ExecuteAction(clang::FrontendAction&) + 996
20 libclang-cpp.so.19.1 0x000076bcd77358fe clang::ExecuteCompilerInvocation(clang::CompilerInstance*) + 894
21 clang                0x00005a5d63c521ef cc1_main(llvm::ArrayRef<char const*>, char const*, void*) + 5759
22 clang                0x00005a5d63c4f080
23 libclang-cpp.so.19.1 0x000076bcd729afd9
24 libLLVM.so.19.1      0x000076bcd0afa6d8 llvm::CrashRecoveryContext::RunSafely(llvm::function_ref<void ()>) + 136
25 libclang-cpp.so.19.1 0x000076bcd729a855 clang::driver::CC1Command::Execute(llvm::ArrayRef<std::__1::optional<llvm::StringRef>>, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>*, bool*) const + 325
26 libclang-cpp.so.19.1 0x000076bcd725ee98 clang::driver::Compilation::ExecuteCommand(clang::driver::Command const&, clang::driver::Command const*&, bool) const + 1000
27 libclang-cpp.so.19.1 0x000076bcd725f11e clang::driver::Compilation::ExecuteJobs(clang::driver::JobList const&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&, bool) const + 126
28 libclang-cpp.so.19.1 0x000076bcd727c78c clang::driver::Driver::ExecuteCompilation(clang::driver::Compilation&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&) + 348
29 clang                0x00005a5d63c4e623 clang_main(int, char**, llvm::ToolContext const&) + 5971
30 clang                0x00005a5d63c5ba77 main + 87
31 libc.so.6            0x000076bccfc2a1ca
32 libc.so.6            0x000076bccfc2a28b __libc_start_main + 139
33 clang                0x00005a5d63c4cb9e _start + 46
...
clang: note: diagnostic msg: /tmp/icmp-8f2313.c
clang: note: diagnostic msg: /tmp/icmp-8f2313.sh
clang: note: diagnostic msg: 
...
✖ [2245/2256] Building SSA.Projects.LLVMRiscV.Pipeline.shl:c.o (96ms)
...
3.	/home/lc985/.elan/toolchains/leanprover--lean4-nightly---nightly-2025-08-06/include/lean/lean.h:3129:69: in compound statement ('{}')
Stack dump without symbol names (ensure you have llvm-symbolizer in your PATH or set the environment var `LLVM_SYMBOLIZER_PATH` to point to it):
0  libLLVM.so.19.1      0x00007d7fd25ae468 llvm::sys::PrintStackTrace(llvm::raw_ostream&, int) + 40
1  libLLVM.so.19.1      0x00007d7fd25ac0de llvm::sys::RunSignalHandlers() + 238
2  libLLVM.so.19.1      0x00007d7fd25ad8ef llvm::sys::CleanupOnSignal(unsigned long) + 255
3  libLLVM.so.19.1      0x00007d7fd24fa8f9
4  libc.so.6            0x00007d7fd1645330
5  libclang-cpp.so.19.1 0x00007d7fd6cd3088 clang::Lexer::LexTokenInternal(clang::Token&, bool) + 104
6  libclang-cpp.so.19.1 0x00007d7fd6d3ff0d clang::Preprocessor::Lex(clang::Token&) + 45
7  libclang-cpp.so.19.1 0x00007d7fd6d62fbf
8  libclang-cpp.so.19.1 0x00007d7fd6d48e38
9  libclang-cpp.so.19.1 0x00007d7fd6e1a310 clang::Parser::ParseCompoundStatementBody(bool) + 2992
10 libclang-cpp.so.19.1 0x00007d7fd6e1af87 clang::Parser::ParseFunctionStatementBody(clang::Decl*, clang::Parser::ParseScope&) + 167
11 libclang-cpp.so.19.1 0x00007d7fd6e36a8e clang::Parser::ParseFunctionDefinition(clang::ParsingDeclarator&, clang::Parser::ParsedTemplateInfo const&, clang::Parser::LateParsedAttrList*) + 4030
12 libclang-cpp.so.19.1 0x00007d7fd6d629fc clang::Parser::ParseDeclGroup(clang::ParsingDeclSpec&, clang::DeclaratorContext, clang::ParsedAttributes&, clang::Parser::ParsedTemplateInfo&, clang::SourceLocation*, clang::Parser::ForRangeInit*) + 6764
13 libclang-cpp.so.19.1 0x00007d7fd6e358d7 clang::Parser::ParseDeclOrFunctionDefInternal(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec&, clang::AccessSpecifier) + 983
14 libclang-cpp.so.19.1 0x00007d7fd6e35300 clang::Parser::ParseDeclarationOrFunctionDefinition(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*, clang::AccessSpecifier) + 576
15 libclang-cpp.so.19.1 0x00007d7fd6e344ed clang::Parser::ParseExternalDeclaration(clang::ParsedAttributes&, clang::ParsedAttributes&, clang::ParsingDeclSpec*) + 1997
16 libclang-cpp.so.19.1 0x00007d7fd6e326b3 clang::Parser::ParseTopLevelDecl(clang::OpaquePtr<clang::DeclGroupRef>&, clang::Sema::ModuleImportState&) + 1459
17 libclang-cpp.so.19.1 0x00007d7fd6d4846e clang::ParseAST(clang::Sema&, bool, bool) + 830
18 libclang-cpp.so.19.1 0x00007d7fd90b9b96 clang::FrontendAction::Execute() + 86
19 libclang-cpp.so.19.1 0x00007d7fd9030614 clang::CompilerInstance::ExecuteAction(clang::FrontendAction&) + 996
20 libclang-cpp.so.19.1 0x00007d7fd91358fe clang::ExecuteCompilerInvocation(clang::CompilerInstance*) + 894
21 clang                0x00005d29fd68a1ef cc1_main(llvm::ArrayRef<char const*>, char const*, void*) + 5759
22 clang                0x00005d29fd687080
23 libclang-cpp.so.19.1 0x00007d7fd8c9afd9
24 libLLVM.so.19.1      0x00007d7fd24fa6d8 llvm::CrashRecoveryContext::RunSafely(llvm::function_ref<void ()>) + 136
25 libclang-cpp.so.19.1 0x00007d7fd8c9a855 clang::driver::CC1Command::Execute(llvm::ArrayRef<std::__1::optional<llvm::StringRef>>, std::__1::basic_string<char, std::__1::char_traits<char>, std::__1::allocator<char>>*, bool*) const + 325
26 libclang-cpp.so.19.1 0x00007d7fd8c5ee98 clang::driver::Compilation::ExecuteCommand(clang::driver::Command const&, clang::driver::Command const*&, bool) const + 1000
27 libclang-cpp.so.19.1 0x00007d7fd8c5f11e clang::driver::Compilation::ExecuteJobs(clang::driver::JobList const&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&, bool) const + 126
28 libclang-cpp.so.19.1 0x00007d7fd8c7c78c clang::driver::Driver::ExecuteCompilation(clang::driver::Compilation&, llvm::SmallVectorImpl<std::__1::pair<int, clang::driver::Command const*>>&) + 348
29 clang                0x00005d29fd686623 clang_main(int, char**, llvm::ToolContext const&) + 5971
30 clang                0x00005d29fd693a77 main + 87
31 libc.so.6            0x00007d7fd162a1ca
32 libc.so.6            0x00007d7fd162a28b __libc_start_main + 139
33 clang                0x00005d29fd684b9e _start + 46
clang: error: clang frontend command failed with exit code 135 (use -v to see invocation)
clang version 19.1.2 (https://github.com/llvm/llvm-project 7ba7d8e2f7b6445b60679da826210cdde29eaf8b)
Target: x86_64-unknown-linux-gnu
Thread model: posix
...
PLEASE ATTACH THE FOLLOWING FILES TO THE BUG REPORT:
Preprocessed source(s) and associated run script(s) are located at:
clang: note: diagnostic msg: /tmp/shl-a2b2c9.c
clang: note: diagnostic msg: /tmp/shl-a2b2c9.sh
clang: note: diagnostic msg: 

********************
error: external command '/home/lc985/.elan/toolchains/leanprover--lean4-nightly---nightly-2025-08-06/bin/clang' exited with code 1
✖ [2246/2256] Building SSA.Projects.LLVMRiscV.Pipeline.pseudo (1.8s)
