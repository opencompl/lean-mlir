...
module {
  func.func @main(%arg0: i64) -> i1 {
    ...
    %0 = llvm.trunc %arg0 : i64 to i1
    %1 = llvm.select %0, %c-25_i64, %arg0 : i1, i64
...
module {
  func.func @main(%arg0: i64) -> i32 {
    ...
    %c-39_i64 = arith.constant -39 : i64
    %0 = llvm.trunc %c-39_i64 : i64 to i1
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i1 {
    ...
    %1 = llvm.udiv %arg0, %0 : i64
    %2 = llvm.icmp "sge" %1, %c-47_i64 : i64
    return %2 : i1
  }
}
// -----
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i32 {
    ...
    %c-46_i64 = arith.constant -46 : i64
    %0 = llvm.icmp "ult" %c7_i64, %c-46_i64 : i64
    %1 = llvm.select %0, %arg0, %arg1 : i1, i64
    %2 = llvm.trunc %1 : i64 to i32
    return %2 : i32
  }
...
module {
  func.func @main(%arg0: i64) -> i1 {
    ...
    %c-39_i64 = arith.constant -39 : i64
    %0 = llvm.udiv %c-37_i64, %c-39_i64 : i64
...
module {
  func.func @main(%arg0: i64) -> i32 {
    ...
    %0 = llvm.select %false, %arg0, %c-38_i64 : i1, i64
