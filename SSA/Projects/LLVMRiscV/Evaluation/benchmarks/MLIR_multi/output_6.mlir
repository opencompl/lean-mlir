module {
  func.func @main(%arg0: i64) -> i1 {
    ...
    %2 = llvm.xor %1, %1 : i64
    %3 = llvm.select %0, %c-27_i64, %2 : i1, i64
    %4 = llvm.srem %3, %2 : i64
...
module {
  func.func @main(%arg0: i64) -> i32 {
    ...
    %2 = llvm.xor %c30_i64, %c-9_i64 : i64
    %3 = llvm.or %1, %2 : i64
    %4 = llvm.or %3, %0 : i64
    %5 = llvm.trunc %4 : i64 to i32
    return %5 : i32
...
module {
  func.func @main(%arg0: i64, %arg1: i32) -> i1 {
    ...
    %0 = llvm.srem %c-50_i64, %c32_i64 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i32 {
    ...
    %1 = llvm.lshr %c15_i64, %c-5_i64 : i64
    %2 = llvm.select %0, %c-43_i64, %1 : i1, i64
...
module {
  func.func @main(%arg0: i64, %arg1: i1) -> i32 {
    ...
    %1 = llvm.sext %c-12_i32 : i32 to i64
    %2 = llvm.sdiv %0, %1 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i32 {
    %c-9_i64 = arith.constant -9 : i64
    %0 = llvm.trunc %c-9_i64 : i64 to i32
    %1 = llvm.sext %0 : i32 to i64
...
module {
  func.func @main(%arg0: i64) -> i64 {
    ...
    %2 = llvm.select %false, %0, %c-8_i64 : i1, i64
    %3 = llvm.srem %2, %1 : i64
    %4 = llvm.srem %c-15_i64, %3 : i64
    %5 = llvm.srem %1, %4 : i64
    return %5 : i64
  }
}
...
module {
  func.func @main(%arg0: i1) -> i32 {
    ...
    %3 = llvm.sext %c-36_i32 : i32 to i64
    %4 = llvm.ashr %2, %3 : i64
    %5 = llvm.trunc %4 : i64 to i32
    return %5 : i32
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %c-26_i64 = arith.constant -26 : i64
    %c27_i64 = arith.constant 27 : i64
    %0 = llvm.sdiv %c-26_i64, %c27_i64 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i1) -> i32 {
    ...
    %0 = llvm.sdiv %c-32_i64, %c10_i64 : i64
    %1 = llvm.urem %0, %arg0 : i64
    %2 = llvm.icmp "ule" %0, %1 : i64
    %3 = llvm.select %arg1, %arg0, %c-15_i64 : i1, i64
...
module {
  func.func @main(%arg0: i1, %arg1: i64) -> i64 {
    ...
    %0 = llvm.and %c50_i64, %c-24_i64 : i64
...
module {
  func.func @main(%arg0: i32, %arg1: i64) -> i1 {
    %c-3_i64 = arith.constant -3 : i64
    %c-26_i64 = arith.constant -26 : i64
    %0 = llvm.urem %c-3_i64, %c-26_i64 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i32 {
    ...
    %1 = llvm.srem %c-46_i64, %arg1 : i64
    %2 = llvm.urem %0, %1 : i64
    %3 = llvm.xor %arg2, %c-20_i64 : i64
    %4 = llvm.lshr %2, %3 : i64
    %5 = llvm.trunc %4 : i64 to i32
    return %5 : i32
  }
...
module {
  func.func @main(%arg0: i1) -> i32 {
    ...
    %2 = llvm.icmp "ule" %1, %c-21_i64 : i64
    %3 = llvm.zext %2 : i1 to i64
    %4 = llvm.urem %0, %3 : i64
    %5 = llvm.trunc %4 : i64 to i32
    return %5 : i32
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i32 {
    ...
    %1 = llvm.select %0, %arg1, %c-32_i64 : i1, i64
    %2 = llvm.xor %arg0, %1 : i64
    %3 = llvm.ashr %c2_i64, %2 : i64
    %4 = llvm.lshr %c-1_i64, %3 : i64
    %5 = llvm.trunc %4 : i64 to i32
    return %5 : i32
  }
}
...
module {
  func.func @main(%arg0: i64) -> i64 {
    ...
    %0 = llvm.ashr %arg0, %arg0 : i64
    %1 = llvm.and %0, %arg0 : i64
    %2 = llvm.urem %c-5_i64, %c-37_i64 : i64
    %3 = llvm.ashr %2, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i64 {
    ...
    %1 = llvm.icmp "ule" %c-36_i64, %arg2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64) -> i64 {
    ...
    %1 = llvm.srem %arg0, %c-13_i64 : i64
    %2 = llvm.ashr %c-14_i64, %c-37_i64 : i64
    %3 = llvm.urem %1, %2 : i64
...
module {
  func.func @main(%arg0: i64) -> i1 {
    ...
    %4 = llvm.select %2, %c-17_i64, %3 : i1, i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i1 {
    ...
    %1 = llvm.ashr %arg0, %0 : i64
    %2 = llvm.xor %c-50_i64, %arg2 : i64
    %3 = llvm.urem %c-25_i64, %0 : i64
    %4 = llvm.or %2, %3 : i64
    %5 = llvm.icmp "ugt" %1, %4 : i64
    return %5 : i1
  }
...
module {
  func.func @main(%arg0: i64, %arg1: i1, %arg2: i64) -> i1 {
    ...
    %0 = llvm.select %arg1, %c-12_i64, %arg0 : i1, i64
...
module {
  func.func @main(%arg0: i1, %arg1: i64, %arg2: i64) -> i32 {
    ...
    %c-37_i64 = arith.constant -37 : i64
    %0 = llvm.select %arg0, %arg1, %arg2 : i1, i64
    %1 = llvm.select %arg0, %c-37_i64, %c-21_i64 : i1, i64
    %2 = llvm.xor %0, %1 : i64
    %3 = llvm.sdiv %2, %0 : i64
    %4 = llvm.lshr %3, %c-27_i64 : i64
    %5 = llvm.trunc %4 : i64 to i32
    return %5 : i32
  }
}
...
module {
  func.func @main(%arg0: i64) -> i32 {
    ...
    %0 = llvm.sext %c-34_i32 : i32 to i64
    %1 = llvm.trunc %0 : i64 to i32
    %2 = llvm.zext %1 : i32 to i64
    %3 = llvm.trunc %2 : i64 to i1
