...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64, %arg3: i1) -> i32 {
    ...
    %2 = llvm.select %arg3, %arg2, %0 : i1, i64
...
// -----
module {
  func.func @main(%arg0: i64, %arg1: i1, %arg2: i64, %arg3: i32) -> i32 {
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i1) -> i32 {
    ...
    %2 = llvm.select %arg2, %arg1, %arg0 : i1, i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64, %arg3: i1) -> i32 {
    ...
    %1 = llvm.select %arg3, %arg0, %arg1 : i1, i64
    %2 = llvm.udiv %0, %1 : i64
    %3 = llvm.udiv %0, %2 : i64
    %4 = llvm.xor %3, %2 : i64
...
module {
  func.func @main(%arg0: i64, %arg1: i64, %arg2: i64) -> i1 {
    ...
    %4 = llvm.sdiv %arg2, %arg1 : i64
    %5 = llvm.select %3, %4, %arg2 : i1, i64
    %6 = llvm.select %2, %0, %5 : i1, i64
