...
LLVMIR_DIR = (
    f"{ROOT_DIR}/SSA/Projects/LLVMRiscV/EvaluationRefactored/benchmarks/LLVMIR/"
)
MLIR_bb0_DIR = (
    f"{ROOT_DIR}/SSA/Projects/LLVMRiscV/EvaluationRefactored/benchmarks/MLIR_bb0/"
)
MLIR_single_DIR = (
    f"{ROOT_DIR}/SSA/Projects/LLVMRiscV/EvaluationRefactored/benchmarks/MLIR_single/"
)
MLIR_multi_DIR = (
    f"{ROOT_DIR}/SSA/Projects/LLVMRiscV/EvaluationRefactored/benchmarks/MLIR_multi/"
)
LLC_ASM_DIR = (
    f"{ROOT_DIR}/SSA/Projects/LLVMRiscV/EvaluationRefactored/benchmarks/LLC_ASM/"
)
LEANMLIR_ASM_DIR = (
    f"{ROOT_DIR}/SSA/Projects/LLVMRiscV/EvaluationRefactored/benchmarks/LEANMLIR_ASM/"
)
