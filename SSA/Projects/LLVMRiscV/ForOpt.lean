...
transformations in the hybrid dialect will be modeled
as function calls from Opt.lean to functions defined in this
file. This file can be seen as an extension of the Opt tool,
specific to the LLVMAndRiscV dialect.
-/

/-- `regionTransform_LLVMRiscV` attempts to transform
...
parsing infrastructure provided by the framework, which is
