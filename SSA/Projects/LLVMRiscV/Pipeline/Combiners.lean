...
-/
def select_of_const_1_0 : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1)] where
  lhs := [LV| {
    ^entry (%c: i1):
...
-/
def select_of_const_neg1_0 : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1)] where
  lhs := [LV| {
    ^entry (%c: i1):
      %t = llvm.mlir.constant (-1) : i64
      %f = llvm.mlir.constant (0) : i64
...
-/
def select_of_const_0_1 : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1)] where
  lhs := [LV| {
    ^entry (%c: i1):
...
-/
def select_of_const_0_neg1 : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1)] where
  lhs := [LV| {
    ^entry (%c: i1):
      %t = llvm.mlir.constant (0) : i64
      %f = llvm.mlir.constant (-1) : i64
...
-/
def select_cond_cond_f : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 64), Ty.llvm (.bitvec 1)] where
  lhs := [LV| {
    ^entry (%c: i1, %f : i64):
      %0 = llvm.zext %c: i1 to i64
...
-/
def select_1_f : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1), Ty.llvm (.bitvec 64)] where
  lhs := [LV| {
    ^entry (%c: i1, %f: i64):
      %one = llvm.mlir.constant (1) : i64
      %0 = llvm.select %c, %one, %f : i64
      llvm.return %0 : i64
  }]
  rhs := [LV| {
    ^entry (%c: i1, %f: i64):
      %cext = llvm.zext %c: i1 to i64
      %ffreeze = llvm.freeze %f : i64
      %0 = llvm.or %cext, %ffreeze : i64
      llvm.return %0 : i64
  }]
...
-/
def select_t_cond : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1), Ty.llvm (.bitvec 64)] where
  lhs := [LV| {
    ^entry (%c: i1, %t: i64):
      %cext = llvm.zext %c: i1 to i64
      %0 = llvm.select %c, %t, %cext : i64
      llvm.return %0 : i64
  }]
  rhs := [LV| {
    ^entry (%c: i1, %t: i64):
...
-/
def select_t_0 : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1), Ty.llvm (.bitvec 64)] where
  lhs := [LV| {
    ^entry (%c: i1, %t: i64):
      %zero = llvm.mlir.constant (0) : i64
      %0 = llvm.select %c, %t, %zero : i64
      llvm.return %0 : i64
  }]
  rhs := [LV| {
    ^entry (%c: i1, %t: i64):
...
-/
def select_t_1 : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1), Ty.llvm (.bitvec 64)] where
  lhs := [LV| {
    ^entry (%c: i1, %t: i64):
      %one = llvm.mlir.constant (1) : i64
      %0 = llvm.select %c, %t, %one : i64
      llvm.return %0 : i64
  }]
  rhs := [LV| {
    ^entry (%c: i1, %t: i64):
      %c1 = llvm.mlir.constant (1) : i1
      %not = llvm.xor %c, %c1 : i1
      %ext = llvm.zext %not: i1 to i64
      %tfreeze = llvm.freeze %t : i64
      %0 = llvm.or %ext, %tfreeze : i64
      llvm.return %0 : i64
  }]
...
-/
def select_0_f : LLVMPeepholeRewriteRefine 64 [Ty.llvm (.bitvec 1), Ty.llvm (.bitvec 64)] where
  lhs := [LV| {
    ^entry (%c: i1, %f: i64):
      %zero = llvm.mlir.constant (0) : i64
