...
def Predicate.quote (p : _root_.Predicate) : Expr :=
  ...
  | .binary .eq a b => mkApp2 (mkConstBin ``BinaryPredicate.eq) (_root_.Term.quote a) (_root_.Term.quote b)
  | .binary .neq a b => mkApp2 (mkConstBin ``BinaryPredicate.neq) (_root_.Term.quote a) (_root_.Term.quote b)
  | .binary .ult a b => mkApp2 (mkConstBin ``BinaryPredicate.ult) (_root_.Term.quote a) (_root_.Term.quote b)
  | .binary .ule a b => mkApp2 (mkConstBin ``BinaryPredicate.ule) (_root_.Term.quote a) (_root_.Term.quote b)
  | .binary .slt a b => mkApp2 (mkConstBin ``BinaryPredicate.slt) (_root_.Term.quote a) (_root_.Term.quote b)
...
structure Config where
  ...
  -/
  backend : CircuitBackend := .lean .fast
