/-
Blasewuzla CLI: Parametric bitvector SMT2 solver using k-induction.
...
unsafe def blasewuzlaCmd : Cli.Cmd := `[Cli|
  ...
  "Run Blase's multi-width k-induction solver on a parametric bitvector SMT2 file."

  FLAGS:
    v, verbose;                "Print verbose output."
    parseOnly;                 "Only parse the file and print the parsed term."
    niter : Nat;               "Maximum number of k-induction iterations."
