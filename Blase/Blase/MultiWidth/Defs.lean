...
def SingleWidthTerm.toDirectExpr {wcard tcard : Nat}
  ...
  | .propimp a b => do
    mkArrow (← a.toDirectExpr w wvars tvars) (← b.toDirectExpr w wvars tvars)
...
-/
def SingleWidthTerm.toQFBVExpr {wcard tcard : Nat}
