"module"() ( {
  ...
  ^bb0(%arg0: !llvm.ptr<i32>):  // no predecessors
    ...
    %14 = "llvm.call"(%10, %12, %2) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %15 = "llvm.getelementptr"(%arg0, %8) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%14, %15) : (i32, !llvm.ptr<i32>) -> ()
    %16 = "llvm.call"(%12, %10, %2) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %17 = "llvm.getelementptr"(%arg0, %1) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%16, %17) : (i32, !llvm.ptr<i32>) -> ()
    %18 = "llvm.call"(%11, %13, %1) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %19 = "llvm.getelementptr"(%arg0, %2) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%18, %19) : (i32, !llvm.ptr<i32>) -> ()
    %20 = "llvm.call"(%13, %11, %1) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %21 = "llvm.getelementptr"(%arg0, %0) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%20, %21) : (i32, !llvm.ptr<i32>) -> ()
    "llvm.return"() : () -> ()
  }) {linkage = 10 : i64, sym_name = "fold_memcmp_cst_cst", type = !llvm.func<void (ptr<i32>)>} : () -> ()
  "llvm.func"() ( {
  ^bb0(%arg0: !llvm.ptr<i32>, %arg1: i64):  // no predecessors
    ...
    %13 = "llvm.call"(%9, %11, %arg1) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %14 = "llvm.getelementptr"(%arg0, %7) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%13, %14) : (i32, !llvm.ptr<i32>) -> ()
    %15 = "llvm.call"(%11, %9, %arg1) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %16 = "llvm.getelementptr"(%arg0, %2) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%15, %16) : (i32, !llvm.ptr<i32>) -> ()
    %17 = "llvm.call"(%10, %12, %arg1) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %18 = "llvm.getelementptr"(%arg0, %1) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%17, %18) : (i32, !llvm.ptr<i32>) -> ()
    %19 = "llvm.call"(%12, %10, %arg1) {callee = @memcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i64) -> i32
    %20 = "llvm.getelementptr"(%arg0, %0) : (!llvm.ptr<i32>, i64) -> !llvm.ptr<i32>
    "llvm.store"(%19, %20) : (i32, !llvm.ptr<i32>) -> ()
    "llvm.return"() : () -> ()
  }) {linkage = 10 : i64, sym_name = "fold_memcmp_cst_var", type = !llvm.func<void (ptr<i32>, i64)>} : () -> ()
  "module_terminator"() : () -> ()
}) : () -> ()
