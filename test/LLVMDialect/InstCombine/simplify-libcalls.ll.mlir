module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f80, dense<128> : vector<2xi64>>, #dlti.dl_entry<f64, dense<64> : vector<2xi64>>, #dlti.dl_entry<f16, dense<16> : vector<2xi64>>, #dlti.dl_entry<f32, dense<32> : vector<2xi64>>, #dlti.dl_entry<f128, dense<128> : vector<2xi64>>, #dlti.dl_entry<i64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<i16, dense<16> : vector<2xi64>>, #dlti.dl_entry<i8, dense<8> : vector<2xi64>>, #dlti.dl_entry<i1, dense<8> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<32> : vector<4xi64>>, #dlti.dl_entry<"dlti.stack_alignment", 32 : i64>, #dlti.dl_entry<"dlti.endianness", "little">>} {
  ...
  llvm.func @test1() -> !llvm.ptr {
    ...
    %5 = llvm.mlir.constant(103 : i32) : i32
    %6 = llvm.call @strchr(%4, %5) : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  llvm.func @test2() -> !llvm.ptr {
    ...
    %5 = llvm.call @strchr(%4, %1) : (!llvm.ptr, i32) -> !llvm.ptr
  ...
  llvm.func @test3() -> !llvm.ptr {
    ...
    %4 = llvm.getelementptr inbounds %3[%1, %0] : (!llvm.ptr, i32, i32) -> !llvm.ptr, !llvm.array<5 x i8>
    %5 = llvm.mlir.constant(80 : i32) : i32
    %6 = llvm.call @strchr(%4, %5) : (!llvm.ptr, i32) -> !llvm.ptr
    llvm.return %6 : !llvm.ptr
  }
  llvm.func @memcmp(!llvm.ptr, !llvm.ptr, i32) -> i32 attributes {memory = #llvm.memory_effects<other = read, argMem = read, inaccessibleMem = read>, passthrough = ["nounwind"]}
  ...
  llvm.func @PR4284() -> i32 attributes {passthrough = ["nounwind"]} {
    %0 = llvm.mlir.constant(1 : i32) : i32
    ...
    %5 = llvm.call @memcmp(%3, %4, %0) : (!llvm.ptr, !llvm.ptr, i32) -> i32
    llvm.return %5 : i32
  }
  ...
  llvm.func @MemCpy() -> i32 {
    ...
    "llvm.intr.memcpy"(%11, %2, %3) <{isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i32) -> ()
    "llvm.intr.memcpy"(%11, %5, %6) <{isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i32) -> ()
    "llvm.intr.memcpy"(%11, %8, %9) <{isVolatile = false}> : (!llvm.ptr, !llvm.ptr, i32) -> ()
    llvm.return %10 : i32
  }
  llvm.func @strcmp(!llvm.ptr, !llvm.ptr) -> i32 attributes {passthrough = ["nobuiltin"]}
  ...
  llvm.func @snprintf(!llvm.ptr, f64, !llvm.ptr) -> i32
  llvm.func @fake_snprintf(%arg0: i32, %arg1: f64, %arg2: !llvm.ptr, %arg3: !llvm.ptr) -> i32 {
    %0 = llvm.call @snprintf(%arg3, %arg1, %arg2) : (!llvm.ptr, f64, !llvm.ptr) -> i32
    llvm.return %0 : i32
  }
