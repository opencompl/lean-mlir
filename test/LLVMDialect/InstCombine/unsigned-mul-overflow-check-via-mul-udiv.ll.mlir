"module"() ( {
  ...
  ^bb0(%arg0: i8, %arg1: i8):  // no predecessors
    ...
    %2 = "llvm.icmp"(%1, %arg1) {predicate = 1 : i64} : (i8, i8) -> i1
    "llvm.return"(%2) : (i1) -> ()
  ...
  ^bb0(%arg0: vector<2xi8>, %arg1: vector<2xi8>):  // no predecessors
    ...
    %1 = "llvm.udiv"(%0, %arg0) : (vector<2xi8>, vector<2xi8>) -> vector<2xi8>
    %2 = "llvm.icmp"(%1, %arg1) {predicate = 1 : i64} : (vector<2xi8>, vector<2xi8>) -> i1
    "llvm.return"(%2) : (i1) -> ()
  ...
  ^bb0(%arg0: i8):  // no predecessors
    ...
    %1 = "llvm.mul"(%0, %arg0) : (i8, i8) -> i8
    %2 = "llvm.udiv"(%1, %arg0) : (i8, i8) -> i8
    %3 = "llvm.icmp"(%0, %2) {predicate = 1 : i64} : (i8, i8) -> i1
    "llvm.return"(%3) : (i1) -> ()
  ...
  ^bb0(%arg0: i8, %arg1: i8, %arg2: i8):  // no predecessors
    ...
    %1 = "llvm.udiv"(%0, %arg1) : (i8, i8) -> i8
    %2 = "llvm.icmp"(%1, %arg2) {predicate = 1 : i64} : (i8, i8) -> i1
    "llvm.return"(%2) : (i1) -> ()
  ...
  ^bb0(%arg0: i8, %arg1: i8):  // no predecessors
    %0 = "llvm.mul"(%arg0, %arg1) : (i8, i8) -> i8
    %1 = "llvm.udiv"(%0, %arg0) : (i8, i8) -> i8
    %2 = "llvm.icmp"(%1, %arg1) {predicate = 8 : i64} : (i8, i8) -> i1
    "llvm.return"(%2) : (i1) -> ()
