module  {
  llvm.mlir.global external constant @a(dense<[1633837924, 1701209960, 1768581996, 1835954032, 1633837924]> : tensor<5xi32>) : !llvm.array<5 x i32>
  llvm.func @memrchr(!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
  llvm.func @fold_memrchr_a_16(%arg0: !llvm.ptr<i64>) {
    ...
    %16 = llvm.mlir.addressof @a : !llvm.ptr<array<5 x i32>>
    %17 = llvm.mlir.constant(0 : i64) : i64
    %18 = llvm.mlir.addressof @a : !llvm.ptr<array<5 x i32>>
    %19 = llvm.getelementptr %18[%17, %17] : (!llvm.ptr<array<5 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %20 = llvm.bitcast %19 : !llvm.ptr<i32> to !llvm.ptr<i8>
    %21 = llvm.ptrtoint %16 : !llvm.ptr<array<5 x i32>> to i64
    %22 = llvm.call @memrchr(%20, %15, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %26 = llvm.call @memrchr(%20, %13, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %30 = llvm.call @memrchr(%20, %11, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %34 = llvm.call @memrchr(%20, %9, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %38 = llvm.call @memrchr(%20, %7, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %42 = llvm.call @memrchr(%20, %5, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %46 = llvm.call @memrchr(%20, %3, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %50 = llvm.call @memrchr(%20, %1, %14) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
  ...
  llvm.func @fold_memrchr_a_p1_16(%arg0: !llvm.ptr<i64>) {
    ...
    %13 = llvm.mlir.addressof @a : !llvm.ptr<array<5 x i32>>
    ...
    %17 = llvm.call @memrchr(%15, %10, %9) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %21 = llvm.call @memrchr(%15, %8, %9) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %25 = llvm.call @memrchr(%15, %7, %9) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %29 = llvm.call @memrchr(%15, %5, %9) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %33 = llvm.call @memrchr(%15, %3, %9) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %36 = llvm.call @memrchr(%15, %1, %9) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
  ...
  llvm.func @fold_memrchr_a_20(%arg0: !llvm.ptr<i64>) {
    %0 = llvm.mlir.constant(4 : i64) : i64
    %1 = llvm.mlir.constant(101 : i32) : i32
    %2 = llvm.mlir.constant(3 : i64) : i64
    %3 = llvm.mlir.constant(100 : i32) : i32
    %4 = llvm.mlir.constant(2 : i64) : i64
    %5 = llvm.mlir.constant(99 : i32) : i32
    %6 = llvm.mlir.constant(1 : i64) : i64
    %7 = llvm.mlir.constant(98 : i32) : i32
    %8 = llvm.mlir.constant(20 : i64) : i64
    %9 = llvm.mlir.constant(97 : i32) : i32
    %10 = llvm.mlir.constant(0 : i64) : i64
    %11 = llvm.mlir.addressof @a : !llvm.ptr<array<5 x i32>>
    %12 = llvm.getelementptr %11[%10, %10] : (!llvm.ptr<array<5 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %13 = llvm.bitcast %12 : !llvm.ptr<i32> to !llvm.ptr<i8>
    %14 = llvm.ptrtoint %13 : !llvm.ptr<i8> to i64
    %15 = llvm.call @memrchr(%13, %9, %8) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    %16 = llvm.ptrtoint %15 : !llvm.ptr<i8> to i64
    %17 = llvm.sub %16, %14  : i64
    %18 = llvm.getelementptr %arg0[%10] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    llvm.store %17, %18 : !llvm.ptr<i64>
    %19 = llvm.call @memrchr(%13, %7, %8) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    %20 = llvm.ptrtoint %19 : !llvm.ptr<i8> to i64
    %21 = llvm.sub %20, %14  : i64
    %22 = llvm.getelementptr %arg0[%6] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    llvm.store %21, %22 : !llvm.ptr<i64>
    %23 = llvm.call @memrchr(%13, %5, %8) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    %24 = llvm.ptrtoint %23 : !llvm.ptr<i8> to i64
    %25 = llvm.sub %24, %14  : i64
    %26 = llvm.getelementptr %arg0[%4] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    llvm.store %25, %26 : !llvm.ptr<i64>
    %27 = llvm.call @memrchr(%13, %3, %8) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    %28 = llvm.ptrtoint %27 : !llvm.ptr<i8> to i64
    %29 = llvm.sub %28, %14  : i64
    %30 = llvm.getelementptr %arg0[%2] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    llvm.store %29, %30 : !llvm.ptr<i64>
    %31 = llvm.call @memrchr(%13, %1, %8) : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    %32 = llvm.ptrtoint %31 : !llvm.ptr<i8> to i64
    %33 = llvm.sub %32, %14  : i64
    %34 = llvm.getelementptr %arg0[%0] : (!llvm.ptr<i64>, i64) -> !llvm.ptr<i64>
    llvm.store %33, %34 : !llvm.ptr<i64>
    llvm.return
  }
}
