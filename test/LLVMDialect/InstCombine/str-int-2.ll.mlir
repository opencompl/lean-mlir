"module"() ( {
  ...
  "llvm.func"() ( {
    ...
    %5 = "llvm.call"(%4, %1, %0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%5) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_dec", type = !llvm.func<i64 ()>} : () -> ()
  "llvm.func"() ( {
    ...
    %4 = "llvm.call"(%3, %0, %1) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%4) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_base_zero", type = !llvm.func<i64 ()>} : () -> ()
  "llvm.func"() ( {
    ...
    %5 = "llvm.call"(%4, %1, %0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%5) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_hex", type = !llvm.func<i64 ()>} : () -> ()
  "llvm.func"() ( {
  ^bb0(%arg0: !llvm.ptr<ptr<i8>>):  // no predecessors
    ...
    %2 = "llvm.mlir.addressof"() {global_name = @".str"} : () -> !llvm.ptr<array<3 x i8>>
    %3 = "llvm.getelementptr"(%2, %1, %1) : (!llvm.ptr<array<3 x i8>>, i32, i32) -> !llvm.ptr<i8>
    %4 = "llvm.call"(%3, %arg0, %0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%4) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_endptr_not_null", type = !llvm.func<i64 (ptr<ptr<i8>>)>} : () -> ()
  "llvm.func"() ( {
  ^bb0(%arg0: !llvm.ptr<ptr<i8>>):  // no predecessors
    %0 = "llvm.mlir.constant"() {value = 10 : i32} : () -> i32
    %1 = "llvm.mlir.constant"() {value = 0 : i32} : () -> i32
    ...
    %4 = "llvm.call"(%3, %arg0, %0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%4) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_endptr_maybe_null", type = !llvm.func<i64 (ptr<ptr<i8>>)>} : () -> ()
  "llvm.func"() ( {
  ...
  ^bb0(%arg0: !llvm.ptr<i8>):  // no predecessors
    %0 = "llvm.mlir.constant"() {value = 10 : i32} : () -> i32
    %1 = "llvm.mlir.null"() : () -> !llvm.ptr<ptr<i8>>
    %2 = "llvm.call"(%arg0, %1, %0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%2) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_not_const_str", type = !llvm.func<i64 (ptr<i8>)>} : () -> ()
  "llvm.func"() ( {
  ^bb0(%arg0: !llvm.ptr<i8>):  // no predecessors
  ...
  ^bb0(%arg0: i32):  // no predecessors
    ...
    %2 = "llvm.mlir.addressof"() {global_name = @".str"} : () -> !llvm.ptr<array<3 x i8>>
    %3 = "llvm.getelementptr"(%2, %1, %1) : (!llvm.ptr<array<3 x i8>>, i32, i32) -> !llvm.ptr<i8>
    %4 = "llvm.call"(%3, %0, %arg0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%4) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_not_const_base", type = !llvm.func<i64 (i32)>} : () -> ()
  "llvm.func"() ( {
    %0 = "llvm.mlir.constant"() {value = 10 : i32} : () -> i32
    %1 = "llvm.mlir.null"() : () -> !llvm.ptr<ptr<i8>>
    %2 = "llvm.mlir.constant"() {value = 0 : i32} : () -> i32
    ...
    %5 = "llvm.call"(%4, %1, %0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%5) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_long_int", type = !llvm.func<i64 ()>} : () -> ()
  "llvm.func"() ( {
    %0 = "llvm.mlir.constant"() {value = 10 : i32} : () -> i32
    %1 = "llvm.mlir.null"() : () -> !llvm.ptr<ptr<i8>>
    ...
    %5 = "llvm.call"(%4, %1, %0) {callee = @strtol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i64
    "llvm.return"(%5) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "strtol_big_overflow", type = !llvm.func<i64 ()>} : () -> ()
  "llvm.func"() ( {
    %0 = "llvm.mlir.constant"() {value = 0 : i32} : () -> i32
    ...
    %3 = "llvm.call"(%2) {callee = @atol, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>) -> i64
    "llvm.return"(%3) : (i64) -> ()
  }) {linkage = 10 : i64, sym_name = "atol_test", type = !llvm.func<i64 ()>} : () -> ()
  "llvm.func"() ( {
    %0 = "llvm.mlir.constant"() {value = 0 : i32} : () -> i32
