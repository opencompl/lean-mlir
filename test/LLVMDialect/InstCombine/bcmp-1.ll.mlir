"module"() ( {
  ...
  ^bb0(%arg0: !llvm.ptr<i8>, %arg1: i32):  // no predecessors
    %0 = "llvm.call"(%arg0, %arg0, %arg1) {callee = @bcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
    "llvm.return"(%0) : (i32) -> ()
  ...
  ^bb0(%arg0: !llvm.ptr<i8>, %arg1: !llvm.ptr<i8>):  // no predecessors
    ...
    %1 = "llvm.call"(%arg0, %arg1, %0) {callee = @bcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
    "llvm.return"(%1) : (i32) -> ()
  ...
  "llvm.func"() ( {
    ...
    %6 = "llvm.call"(%4, %5, %0) {callee = @bcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
    "llvm.return"(%6) : (i32) -> ()
  ...
  ^bb0(%arg0: i64, %arg1: i64):  // no predecessors
    ...
    %7 = "llvm.call"(%5, %6, %1) {callee = @bcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
  ...
  ^bb0(%arg0: !llvm.ptr<i8>, %arg1: !llvm.ptr<i8>, %arg2: i32):  // no predecessors
    %0 = "llvm.mlir.constant"() {value = 0 : i32} : () -> i32
    %1 = "llvm.call"(%arg0, %arg1, %arg2) {callee = @bcmp, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
