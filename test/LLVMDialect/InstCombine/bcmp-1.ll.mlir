module  {
  ...
  llvm.func @test_simplify1(%arg0: !llvm.ptr<i8>, %arg1: i32) -> i32 {
    %0 = llvm.call @bcmp(%arg0, %arg0, %arg1) : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
    llvm.return %0 : i32
  }
  llvm.func @test_simplify2(%arg0: !llvm.ptr<i8>, %arg1: !llvm.ptr<i8>) -> i32 {
    %0 = llvm.mlir.constant(0 : i32) : i32
    %1 = llvm.call @bcmp(%arg0, %arg1, %0) : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
    llvm.return %1 : i32
  }
  ...
  llvm.func @test_simplify4() -> i32 {
    ...
    %6 = llvm.call @bcmp(%4, %5, %0) : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
    llvm.return %6 : i32
  }
  ...
  llvm.func @test_simplify7(%arg0: i64, %arg1: i64) -> i1 {
    ...
    %7 = llvm.call @bcmp(%5, %6, %1) : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
  ...
  llvm.func @test_simplify10(%arg0: !llvm.ptr<i8>, %arg1: !llvm.ptr<i8>, %arg2: i32) -> i1 {
    %0 = llvm.mlir.constant(0 : i32) : i32
    %1 = llvm.call @bcmp(%arg0, %arg1, %arg2) : (!llvm.ptr<i8>, !llvm.ptr<i8>, i32) -> i32
