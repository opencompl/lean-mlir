module  {
  llvm.func @lshrugt_01_00(%arg0: i4) -> i1 {
    ...
    %2 = llvm.lshr %arg0, %1  : i4
    %3 = llvm.icmp "ugt" %2, %0 : i4
    llvm.return %3 : i1
  }
  ...
  llvm.func @ashrsgt_01_00(%arg0: i4) -> i1 {
    %0 = llvm.mlir.constant(0 : i4) : i4
    %1 = llvm.mlir.constant(1 : i4) : i4
    %2 = llvm.ashr %arg0, %1  : i4
    %3 = llvm.icmp "sgt" %2, %0 : i4
    llvm.return %3 : i1
  }
  ...
  llvm.func @ashr_00_00_ashr_extra_use(%arg0: i8, %arg1: !llvm.ptr<i8>) -> i1 {
    %0 = llvm.mlir.constant(10 : i8) : i8
    %1 = llvm.mlir.constant(3 : i8) : i8
    %2 = llvm.ashr %arg0, %1  : i8
    %3 = llvm.icmp "ule" %2, %0 : i8
    llvm.store %2, %arg1 : !llvm.ptr<i8>
    llvm.return %3 : i1
  }
  llvm.func @ashr_00_00_vec(%arg0: vector<4xi8>) -> vector<4xi1> {
    ...
    %2 = llvm.ashr %arg0, %1  : vector<4xi8>
    %3 = llvm.icmp "ule" %2, %0 : vector<4xi8>
    llvm.return %3 : i1
  }
