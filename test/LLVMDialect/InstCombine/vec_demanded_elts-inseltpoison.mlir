module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i64, dense<64> : vector<2xi64>>, #dlti.dl_entry<f80, dense<128> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi64>>, #dlti.dl_entry<i8, dense<8> : vector<2xi64>>, #dlti.dl_entry<i16, dense<16> : vector<2xi64>>, #dlti.dl_entry<i1, dense<8> : vector<2xi64>>, #dlti.dl_entry<f64, dense<64> : vector<2xi64>>, #dlti.dl_entry<f128, dense<128> : vector<2xi64>>, #dlti.dl_entry<f16, dense<16> : vector<2xi64>>, #dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<"dlti.stack_alignment", 128 : i64>>} {
  ...
  llvm.func @test_fpext(%arg0: f32) -> vector<2xf64> {
    ...
    %4 = llvm.mlir.constant(2 : i32) : i32
    %5 = llvm.mlir.constant(3 : i32) : i32
    %6 = llvm.mlir.poison : vector<4xf64>
  ...
  llvm.func @inselt_shuf_no_demand_commute(%arg0: f32, %arg1: f32, %arg2: f32) -> vector<4xf32> {
    ...
    %7 = llvm.insertelement %arg2, %6[%3 : i32] : vector<4xf32>
    %8 = llvm.shufflevector %4, %7 [4, -1, -1, -1] : vector<4xf32> 
  ...
  llvm.func @ins_of_ext_undef_elts_propagation2(%arg0: vector<8xi4>, %arg1: vector<8xi4>, %arg2: i4) -> vector<8xi4> {
    %0 = llvm.mlir.constant(0 : i32) : i32
    %1 = llvm.mlir.poison : vector<8xi4>
    %2 = llvm.mlir.constant(1 : i32) : i32
    %3 = llvm.mlir.constant(2 : i32) : i32
