"module"() ( {
  "llvm.mlir.global"() ( {
  }) {constant, linkage = 10 : i64, sym_name = "a", type = !llvm.array<4 x i32>, value = dense<[1633837924, 1701209960, 1768581996, 1835954032]> : tensor<4xi32>} : () -> ()
  "llvm.func"() ( {
  ...
  ^bb0(%arg0: !llvm.ptr<i64>):  // no predecessors
    ...
    %16 = "llvm.mlir.addressof"() {global_name = @a} : () -> !llvm.ptr<array<4 x i32>>
    %17 = "llvm.mlir.constant"() {value = 0 : i64} : () -> i64
    %18 = "llvm.mlir.addressof"() {global_name = @a} : () -> !llvm.ptr<array<4 x i32>>
    %19 = "llvm.getelementptr"(%18, %17, %17) : (!llvm.ptr<array<4 x i32>>, i64, i64) -> !llvm.ptr<i32>
    %20 = "llvm.bitcast"(%19) : (!llvm.ptr<i32>) -> !llvm.ptr<i8>
    %21 = "llvm.ptrtoint"(%16) : (!llvm.ptr<array<4 x i32>>) -> i64
    %22 = "llvm.call"(%20, %15, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %26 = "llvm.call"(%20, %13, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %30 = "llvm.call"(%20, %11, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %34 = "llvm.call"(%20, %9, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %38 = "llvm.call"(%20, %7, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %42 = "llvm.call"(%20, %5, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %46 = "llvm.call"(%20, %3, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %50 = "llvm.call"(%20, %1, %14) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    "llvm.return"() : () -> ()
  }) {linkage = 10 : i64, sym_name = "fold_memchr_a", type = !llvm.func<void (ptr<i64>)>} : () -> ()
  "llvm.func"() ( {
  ^bb0(%arg0: !llvm.ptr<i64>):  // no predecessors
    ...
    %13 = "llvm.mlir.addressof"() {global_name = @a} : () -> !llvm.ptr<array<4 x i32>>
    ...
    %17 = "llvm.call"(%15, %10, %9) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %21 = "llvm.call"(%15, %8, %9) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %25 = "llvm.call"(%15, %7, %9) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %29 = "llvm.call"(%15, %5, %9) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %33 = "llvm.call"(%15, %3, %9) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    %36 = "llvm.call"(%15, %1, %9) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    ...
    "llvm.return"() : () -> ()
  }) {linkage = 10 : i64, sym_name = "fold_memchr_a_p1", type = !llvm.func<void (ptr<i64>)>} : () -> ()
  "module_terminator"() : () -> ()
}) : () -> ()
