"module"() ( {
  ...
  }) {linkage = 10 : i64, sym_name = "call_memchr_ax_2_uimax_p1", type = !llvm.func<ptr<i8> ()>} : () -> ()
  "llvm.func"() ( {
    %0 = "llvm.mlir.constant"() {value = 4294967296 : i64} : () -> i64
    %1 = "llvm.mlir.constant"() {value = 1 : i32} : () -> i32
    %2 = "llvm.mlir.constant"() {value = 0 : i32} : () -> i32
    ...
    %5 = "llvm.call"(%4, %1, %0) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    "llvm.return"(%5) : (!llvm.ptr<i8>) -> ()
  }) {linkage = 10 : i64, sym_name = "call_memchr_ax_2_uimax_p2", type = !llvm.func<ptr<i8> ()>} : () -> ()
  "llvm.func"() ( {
    ...
    %5 = "llvm.call"(%4, %1, %0) {callee = @memchr, fastmathFlags = #llvm.fastmath<>} : (!llvm.ptr<i8>, i32, i64) -> !llvm.ptr<i8>
    "llvm.return"(%5) : (!llvm.ptr<i8>) -> ()
  }) {linkage = 10 : i64, sym_name = "fold_memchr_a12345_3_uimax_p2", type = !llvm.func<ptr<i8> ()>} : () -> ()
  "llvm.func"() ( {
  ...
  }) {linkage = 10 : i64, sym_name = "fold_memchr_a12345_c_uimax_p2", type = !llvm.func<ptr<i8> (i32)>} : () -> ()
  "module_terminator"() : () -> ()
}) : () -> ()
