module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<f128, dense<128> : vector<2xi64>>, #dlti.dl_entry<f16, dense<16> : vector<2xi64>>, #dlti.dl_entry<f64, dense<64> : vector<2xi64>>, #dlti.dl_entry<i64, dense<[32, 64]> : vector<2xi64>>, #dlti.dl_entry<i16, dense<16> : vector<2xi64>>, #dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<i1, dense<8> : vector<2xi64>>, #dlti.dl_entry<i8, dense<8> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<64> : vector<4xi64>>, #dlti.dl_entry<"dlti.endianness", "little">>} {
  ...
  llvm.func @gather_lane2(%arg0: !llvm.ptr, %arg1: f64) -> vector<4xf64> {
    %0 = llvm.mlir.constant(dense<[0, 1, 2, 3]> : vector<4xi64>) : vector<4xi64>
    %1 = llvm.mlir.undef : vector<4xf64>
  ...
  llvm.func @gather_lane0_maybe(%arg0: !llvm.ptr, %arg1: f64, %arg2: vector<2xi1>) -> vector<2xf64> {
    ...
    %1 = llvm.mlir.undef : vector<2xf64>
    %2 = llvm.mlir.constant(0 : i64) : i64
  ...
  llvm.func @scatter_v4i16_uniform_vals_uniform_ptrs_no_all_active_mask(%arg0: !llvm.ptr, %arg1: i16) {
    %0 = llvm.mlir.poison : !llvm.vec<4 x ptr>
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.poison : vector<4xi16>
    %3 = llvm.mlir.constant(true) : i1
    %4 = llvm.mlir.constant(false) : i1
    %5 = llvm.mlir.constant(dense<[false, false, true, true]> : vector<4xi1>) : vector<4xi1>
    %6 = llvm.mlir.constant(2 : i32) : i32
    %7 = llvm.insertelement %arg0, %0[%1 : i32] : !llvm.vec<4 x ptr>
    %8 = llvm.shufflevector %7, %0 [0, 0, 0, 0] : !llvm.vec<4 x ptr> 
    %9 = llvm.insertelement %arg1, %2[%1 : i32] : vector<4xi16>
    %10 = llvm.shufflevector %9, %2 [0, 0, 0, 0] : vector<4xi16> 
    llvm.intr.masked.scatter %10, %8, %5 {alignment = 2 : i32} : vector<4xi16>, vector<4xi1> into !llvm.vec<4 x ptr>
    llvm.return
  }
  llvm.func @scatter_nxv4i16_uniform_vals_uniform_ptrs_all_active_mask(%arg0: !llvm.ptr, %arg1: i16) {
    %0 = llvm.mlir.poison : !llvm.vec<? x 4 x  ptr>
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.poison : !llvm.vec<? x 4 x  i16>
    %3 = llvm.mlir.poison : !llvm.vec<? x 4 x  i1>
    %4 = llvm.mlir.constant(0 : i64) : i64
    %5 = llvm.mlir.constant(true) : i1
    %6 = llvm.insertelement %5, %3[%4 : i64] : !llvm.vec<? x 4 x  i1>
    %7 = llvm.shufflevector %6, %3 [0, 0, 0, 0] : !llvm.vec<? x 4 x  i1> 
    %8 = llvm.mlir.constant(2 : i32) : i32
    %9 = llvm.insertelement %arg0, %0[%1 : i32] : !llvm.vec<? x 4 x  ptr>
    %10 = llvm.shufflevector %9, %0 [0, 0, 0, 0] : !llvm.vec<? x 4 x  ptr> 
    %11 = llvm.insertelement %arg1, %2[%1 : i32] : !llvm.vec<? x 4 x  i16>
    %12 = llvm.shufflevector %11, %2 [0, 0, 0, 0] : !llvm.vec<? x 4 x  i16> 
    llvm.intr.masked.scatter %12, %10, %7 {alignment = 2 : i32} : vector<[4]xi16>, vector<[4]xi1> into !llvm.vec<? x 4 x  ptr>
    llvm.return
  }
  llvm.func @scatter_v4i16_no_uniform_vals_uniform_ptrs_all_active_mask(%arg0: !llvm.ptr, %arg1: !llvm.ptr) {
    %0 = llvm.mlir.poison : !llvm.vec<4 x ptr>
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.constant(true) : i1
    %3 = llvm.mlir.constant(dense<true> : vector<4xi1>) : vector<4xi1>
    %4 = llvm.mlir.constant(2 : i32) : i32
    %5 = llvm.insertelement %arg0, %0[%1 : i32] : !llvm.vec<4 x ptr>
    %6 = llvm.shufflevector %5, %0 [0, 0, 0, 0] : !llvm.vec<4 x ptr> 
    %7 = llvm.load %arg1 {alignment = 2 : i64} : !llvm.ptr -> vector<4xi16>
    llvm.intr.masked.scatter %7, %6, %3 {alignment = 2 : i32} : vector<4xi16>, vector<4xi1> into !llvm.vec<4 x ptr>
    llvm.return
  }
  llvm.func @scatter_nxv4i16_no_uniform_vals_uniform_ptrs_all_active_mask(%arg0: !llvm.ptr, %arg1: !llvm.ptr) {
    %0 = llvm.mlir.poison : !llvm.vec<? x 4 x  ptr>
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.poison : !llvm.vec<? x 4 x  i1>
    %3 = llvm.mlir.constant(0 : i64) : i64
    %4 = llvm.mlir.constant(true) : i1
    %5 = llvm.insertelement %4, %2[%3 : i64] : !llvm.vec<? x 4 x  i1>
    %6 = llvm.shufflevector %5, %2 [0, 0, 0, 0] : !llvm.vec<? x 4 x  i1> 
    %7 = llvm.mlir.constant(2 : i32) : i32
    %8 = llvm.insertelement %arg0, %0[%1 : i32] : !llvm.vec<? x 4 x  ptr>
    %9 = llvm.shufflevector %8, %0 [0, 0, 0, 0] : !llvm.vec<? x 4 x  ptr> 
    %10 = llvm.load %arg1 {alignment = 2 : i64} : !llvm.ptr -> !llvm.vec<? x 4 x  i16>
    llvm.intr.masked.scatter %10, %9, %6 {alignment = 2 : i32} : !llvm.vec<? x 4 x  i16>, vector<[4]xi1> into !llvm.vec<? x 4 x  ptr>
    llvm.return
  }
  llvm.func @negative_scatter_v4i16_no_uniform_vals_uniform_ptrs_all_inactive_mask(%arg0: !llvm.ptr, %arg1: !llvm.ptr) {
    %0 = llvm.mlir.poison : !llvm.vec<4 x ptr>
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.constant(true) : i1
    %3 = llvm.mlir.constant(false) : i1
    %4 = llvm.mlir.constant(dense<[false, false, true, true]> : vector<4xi1>) : vector<4xi1>
    %5 = llvm.mlir.constant(2 : i32) : i32
    %6 = llvm.insertelement %arg0, %0[%1 : i32] : !llvm.vec<4 x ptr>
    %7 = llvm.shufflevector %6, %0 [0, 0, 0, 0] : !llvm.vec<4 x ptr> 
    %8 = llvm.load %arg1 {alignment = 2 : i64} : !llvm.ptr -> vector<4xi16>
    llvm.intr.masked.scatter %8, %7, %4 {alignment = 2 : i32} : vector<4xi16>, vector<4xi1> into !llvm.vec<4 x ptr>
    llvm.return
  }
  llvm.func @negative_scatter_v4i16_no_uniform_vals_no_uniform_ptrs_all_active_mask(%arg0: !llvm.vec<4 x ptr>, %arg1: !llvm.ptr) {
    %0 = llvm.mlir.poison : !llvm.vec<4 x ptr>
    %1 = llvm.mlir.constant(true) : i1
    %2 = llvm.mlir.constant(dense<true> : vector<4xi1>) : vector<4xi1>
    %3 = llvm.mlir.constant(2 : i32) : i32
    %4 = llvm.shufflevector %arg0, %0 [0, 0, 0, 0] : !llvm.vec<4 x ptr> 
    %5 = llvm.load %arg1 {alignment = 2 : i64} : !llvm.ptr -> vector<4xi16>
    llvm.intr.masked.scatter %5, %4, %2 {alignment = 2 : i32} : vector<4xi16>, vector<4xi1> into !llvm.vec<4 x ptr>
    llvm.return
  }
  llvm.func @gather_nxv2i64_uniform_ptrs_all_active_mask(%arg0: !llvm.ptr) -> !llvm.vec<? x 2 x  i64> {
    %0 = llvm.mlir.poison : !llvm.vec<? x 2 x  ptr>
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.poison : !llvm.vec<? x 2 x  i1>
    %3 = llvm.mlir.constant(0 : i64) : i64
    %4 = llvm.mlir.constant(true) : i1
    %5 = llvm.insertelement %4, %2[%3 : i64] : !llvm.vec<? x 2 x  i1>
    %6 = llvm.shufflevector %5, %2 [0, 0] : !llvm.vec<? x 2 x  i1> 
    %7 = llvm.mlir.undef : !llvm.vec<? x 2 x  i64>
    %8 = llvm.mlir.constant(8 : i32) : i32
    %9 = llvm.insertelement %arg0, %0[%1 : i32] : !llvm.vec<? x 2 x  ptr>
    %10 = llvm.shufflevector %9, %0 [0, 0] : !llvm.vec<? x 2 x  ptr> 
    %11 = llvm.intr.masked.gather %10, %6, %7 {alignment = 8 : i32} : (!llvm.vec<? x 2 x  ptr>, vector<[2]xi1>, !llvm.vec<? x 2 x  i64>) -> !llvm.vec<? x 2 x  i64>
    llvm.return %11 : !llvm.vec<? x 2 x  i64>
  }
  llvm.func @gather_v2i64_uniform_ptrs_all_active_mask(%arg0: !llvm.ptr) -> vector<2xi64> {
    ...
    %6 = llvm.insertelement %arg0, %0[%1 : i32] : !llvm.vec<2 x ptr>
    %7 = llvm.shufflevector %6, %0 [0, 0] : !llvm.vec<2 x ptr> 
    %8 = llvm.intr.masked.gather %7, %3, %4 {alignment = 8 : i32} : (!llvm.vec<2 x ptr>, vector<2xi1>, vector<2xi64>) -> vector<2xi64>
    llvm.return %8 : vector<2xi64>
  }
  llvm.func @negative_gather_v2i64_non_uniform_ptrs_all_active_mask(%arg0: !llvm.vec<2 x ptr>, %arg1: !llvm.ptr) -> vector<2xi64> {
    ...
    %5 = llvm.insertelement %arg1, %arg0[%0 : i32] : !llvm.vec<2 x ptr>
    %6 = llvm.intr.masked.gather %5, %2, %3 {alignment = 8 : i32} : (!llvm.vec<2 x ptr>, vector<2xi1>, vector<2xi64>) -> vector<2xi64>
    llvm.return %6 : vector<2xi64>
  }
  llvm.func @negative_gather_v2i64_uniform_ptrs_no_all_active_mask(%arg0: !llvm.ptr, %arg1: vector<2xi1>) -> vector<2xi64> {
    %0 = llvm.mlir.poison : !llvm.vec<2 x ptr>
    %1 = llvm.mlir.constant(0 : i32) : i32
    ...
    %6 = llvm.intr.masked.gather %5, %arg1, %2 {alignment = 8 : i32} : (!llvm.vec<2 x ptr>, vector<2xi1>, vector<2xi64>) -> vector<2xi64>
    llvm.return %6 : vector<2xi64>
  }
}
