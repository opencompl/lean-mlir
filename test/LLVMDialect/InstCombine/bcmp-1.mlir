module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<i32, dense<32> : vector<2xi64>>, #dlti.dl_entry<i16, dense<16> : vector<2xi64>>, #dlti.dl_entry<i8, dense<8> : vector<2xi64>>, #dlti.dl_entry<i1, dense<8> : vector<2xi64>>, #dlti.dl_entry<f64, dense<[32, 64]> : vector<2xi64>>, #dlti.dl_entry<f32, dense<32> : vector<2xi64>>, #dlti.dl_entry<i64, dense<[32, 64]> : vector<2xi64>>, #dlti.dl_entry<f80, dense<128> : vector<2xi64>>, #dlti.dl_entry<!llvm.ptr, dense<32> : vector<4xi64>>, #dlti.dl_entry<f16, dense<16> : vector<2xi64>>, #dlti.dl_entry<f128, dense<128> : vector<2xi64>>, #dlti.dl_entry<"dlti.endianness", "little">>} {
  ...
  llvm.func @test_simplify1(%arg0: !llvm.ptr, %arg1: i32) -> i32 {
    %0 = llvm.call @bcmp(%arg0, %arg0, %arg1) : (!llvm.ptr, !llvm.ptr, i32) -> i32
    llvm.return %0 : i32
  }
  llvm.func @test_simplify2(%arg0: !llvm.ptr, %arg1: !llvm.ptr) -> i32 {
    %0 = llvm.mlir.constant(0 : i32) : i32
    %1 = llvm.call @bcmp(%arg0, %arg1, %0) : (!llvm.ptr, !llvm.ptr, i32) -> i32
    llvm.return %1 : i32
  }
  ...
  llvm.func @test_simplify4() -> i32 {
    ...
    %5 = llvm.call @bcmp(%1, %3, %4) : (!llvm.ptr, !llvm.ptr, i32) -> i32
    llvm.return %5 : i32
  }
  ...
  llvm.func @test_simplify7(%arg0: i64, %arg1: i64) -> i1 {
    ...
    %5 = llvm.call @bcmp(%3, %4, %1) : (!llvm.ptr, !llvm.ptr, i32) -> i32
  ...
  llvm.func @test_simplify10(%arg0: !llvm.ptr, %arg1: !llvm.ptr, %arg2: i32) -> i1 {
    %0 = llvm.mlir.constant(0 : i32) : i32
    %1 = llvm.call @bcmp(%arg0, %arg1, %arg2) : (!llvm.ptr, !llvm.ptr, i32) -> i32
