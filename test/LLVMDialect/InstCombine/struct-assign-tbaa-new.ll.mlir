module  {
  ...
  llvm.func @test1(%arg0: !llvm.ptr<struct<"A", (f32)>>, %arg1: !llvm.ptr<struct<"A", (f32)>>) {
    %0 = llvm.mlir.constant(false) : i1
    %1 = llvm.mlir.constant(4 : i64) : i64
    %2 = llvm.bitcast %arg0 : !llvm.ptr<struct<"A", (f32)>> to !llvm.ptr<i8>
    %3 = llvm.bitcast %arg1 : !llvm.ptr<struct<"A", (f32)>> to !llvm.ptr<i8>
  ...
  llvm.func @test2() -> !llvm.ptr<ptr<ptr<func<i32 (ptr<i8>, ptr<i32>, ptr<f64>)>>>> {
    ...
    %5 = llvm.alloca %4 x !llvm.struct<"B", (ptr<ptr<func<i32 (ptr<i8>, ptr<i32>, ptr<f64>)>>>)> : (i32) -> !llvm.ptr<struct<"B", (ptr<ptr<func<i32 (ptr<i8>, ptr<i32>, ptr<f64>)>>>)>>
    %6 = llvm.bitcast %5 : !llvm.ptr<struct<"B", (ptr<ptr<func<i32 (ptr<i8>, ptr<i32>, ptr<f64>)>>>)>> to !llvm.ptr<i8>
