module  {
  ...
  llvm.func @atol(!llvm.ptr<i8>) -> i32
  ...
  llvm.func @strtol_dec() -> i32 {
    ...
    %5 = llvm.call @strtol(%4, %1, %0) : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i32
    llvm.return %5 : i32
  }
  llvm.func @strtol_base_zero() -> i32 {
    ...
    %4 = llvm.call @strtol(%3, %0, %1) : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i32
    llvm.return %4 : i32
  }
  ...
  llvm.func @strtol_endptr_not_null(%arg0: !llvm.ptr<ptr<i8>>) -> i32 {
    %0 = llvm.mlir.constant(10 : i32) : i32
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.addressof @".str" : !llvm.ptr<array<3 x i8>>
    %3 = llvm.getelementptr %2[%1, %1] : (!llvm.ptr<array<3 x i8>>, i32, i32) -> !llvm.ptr<i8>
    ...
    %6 = llvm.call @strtol(%3, %5, %0) : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i32
    llvm.return %6 : i32
  }
  llvm.func @strtol_endptr_maybe_null(%arg0: !llvm.ptr<ptr<i8>>) -> i32 {
    %0 = llvm.mlir.constant(10 : i32) : i32
    %1 = llvm.mlir.constant(0 : i32) : i32
    %2 = llvm.mlir.addressof @".str.1" : !llvm.ptr<array<2 x i8>>
    %3 = llvm.getelementptr %2[%1, %1] : (!llvm.ptr<array<2 x i8>>, i32, i32) -> !llvm.ptr<i8>
    %4 = llvm.call @strtol(%3, %arg0, %0) : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i32
    llvm.return %4 : i32
  }
  ...
  llvm.func @strtol_not_const_str(%arg0: !llvm.ptr<i8>) -> i32 {
    %0 = llvm.mlir.constant(10 : i32) : i32
    %1 = llvm.mlir.null : !llvm.ptr<ptr<i8>>
  ...
  llvm.func @strtol_not_const_base(%arg0: i32) -> i32 {
    ...
    %2 = llvm.mlir.addressof @".str" : !llvm.ptr<array<3 x i8>>
    %3 = llvm.getelementptr %2[%1, %1] : (!llvm.ptr<array<3 x i8>>, i32, i32) -> !llvm.ptr<i8>
    %4 = llvm.call @strtol(%3, %0, %arg0) : (!llvm.ptr<i8>, !llvm.ptr<ptr<i8>>, i32) -> i32
    llvm.return %4 : i32
  }
  ...
  llvm.func @atol_test() -> i32 {
    ...
    %3 = llvm.call @atol(%2) : (!llvm.ptr<i8>) -> i32
    llvm.return %3 : i32
  }
