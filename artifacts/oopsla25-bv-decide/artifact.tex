...
Acesss the image from \texttt{DockerHub} via the url \url{https://hub.docker.com/r/abdoo8080/oopsla25-bv-decide-base/}.
Please use the following steps to load the docker image:

\begin{script}
# Pull the docker image
$ docker pull abdoo8080/oopsla25-bv-decide-base:v1
# Run the docker image
$ docker run --name oopsla25-bv-decide -it abdoo8080/oopsla25-bv-decide-base:v1
...
A long-term archive of the docker image will be available at \url{https://doi.org/10.5281/zenodo.15755236}.
