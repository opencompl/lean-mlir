...
\item We use lean-MLIR (https://github.com/opencompl/lean-mlir) at commit 73200fedf24db052cb7eac755d32d7e17c30cc4a
...
$ docker pull abdoo8080/oopsla25-bv-decide:v2
# Run the docker image
$ docker run --name oopsla25-bv-decide -it abdoo8080/oopsla25-bv-decide:v2
# Build the framework.
$ lake build
