...
\begin{itemize}
  ...
  \item {\bf How much disk space required (approximately)?: } 40GB
...
All of our infrastructure is based on Lean version \texttt{2025-06-27}. 
\begin{itemize}
...
\item we evaluate the coverge of our BitVec API at commit \texttt{}
\end{itemize}
