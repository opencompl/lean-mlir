...
\newcommand{\MBAKInductionVerifiedNumSolved}{1537} # should be > 1500
\newcommand{\MBAMBANumSolved}{2500} # can solve all 2500
\newcommand{\MBAPresburgerNumSolved}{2500} # can solve all 2500
\newcommand{\MBABvDecideNumSolved}{2500} # can solve all 2500
...
\newcommand{\MBAKInductionVerifiedGeoMean}{3.68s} # should be similar order of magnitude.
\newcommand{\MBAMBAGeoMean}{57.8ms} # should be similar order of magnitude.
\newcommand{\MBAPresburgerGeoMean}{3.74s} # should be similar order of magnitude.
\newcommand{\MBABvDecideGeoMean}{11s} # should be similar order of magnitude.
\end{script}
